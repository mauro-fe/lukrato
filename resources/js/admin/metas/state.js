/**
 * Metas – State, Config & Utility helpers
 */
...
export const Utils = {
    ...
    getPrioridadeTag(prioridade) {
        const map = {
            baixa: '<span class="met-prio baixa">🟢 Baixa</span>',
            media: '<span class="met-prio media">🟡 Média</span>',
            alta: '<span class="met-prio alta">🔴 Alta</span>'
        };
