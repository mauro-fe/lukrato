/**
 * Financas Manager – State, Config & Utility helpers
...
export const Utils = {
    ...
    /**
     * Formatar número sem R$ (para inputs)
     */
    formatNumber(value) {
    ...
    /**
     * Formatar dinheiro em input (event handler)
     */
