        ...
        <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div class="text-center lg:text-left space-y-8" data-aos="fade-right">
                ...
                <div class="inline-flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full shadow-md">
                    ...
                    <span class="text-sm font-medium text-gray-700">Mais de 1.000 usu├írios organizando suas finan├ºas</span>
                </div>

                <!-- T├¡tulo -->
                <h1 class="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold text-gray-900 leading-tight">
                    Organize suas finan├ºas de forma 
                ...
                <p class="text-xl sm:text-2xl text-gray-600 leading-relaxed max-w-2xl mx-auto lg:mx-0">
                    Controle suas entradas, sa├¡das e agendamentos em um s├│ lugar. 
                    Sem complica├º├úo, sem surpresas.
                </p>
                ...
                <div class="flex flex-col sm:flex-row items-center gap-6 pt-8">
                    ...
                    <div class="text-center sm:text-left">
                        ...
                        <p class="text-sm text-gray-600">
                            <strong class="text-gray-900">4.9/5</strong> baseado em mais de 200 avalia├º├╡es
                        </p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 gap-4 pt-4">
                    <div class="flex items-center gap-2 text-gray-700">
                        ...
                        <span class="text-sm font-medium">Gr├ítis para come├ºar</span>
                    </div>
                    <div class="flex items-center gap-2 text-gray-700">
                        <i class="fa-solid fa-check-circle text-green-500"></i>
                        <span class="text-sm font-medium">Sem cart├úo</span>
                    </div>
                    <div class="flex items-center gap-2 text-gray-700">
                        <i class="fa-solid fa-check-circle text-green-500"></i>
                        <span class="text-sm font-medium">F├ícil de usar</span>
                    </div>
                </div>
            </div>
        ...
        <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div class="order-2 lg:order-1 space-y-8" data-aos="fade-right">
                ...
                <ul class="space-y-4">
                    <li class="flex items-start gap-4 group">
                        ...
                        <div class="flex-1 pt-1">
                            <h3 class="font-semibold text-lg text-gray-900 mb-1">Vis├úo clara do m├¬s</h3>
                            <p class="text-gray-600">Saldo consolidado e leitura r├ípida do que importa.</p>
                        </div>
                    </li>
                    ...
                    <li class="flex items-start gap-4 group">
                        ...
                        <div class="flex-1 pt-1">
                            <h3 class="font-semibold text-lg text-gray-900 mb-1">Relat├│rios e gr├íficos</h3>
                            <p class="text-gray-600">Entenda seus h├íbitos com visual limpo e objetivo.</p>
                        </div>
                    </li>
                </ul>
                ...
                <div class="flex items-center gap-3 pt-4">
                    ...
                    <p class="text-sm text-gray-600">
                        Painel pensado para ser r├ípido, bonito e f├ícil de usar.
                    </p>
                </div>
            </div>
                ...
                <div class="relative">
                    ...
                    <div class="relative bg-gradient-to-br from-white via-orange-50/30 to-white rounded-3xl shadow-2xl p-8 sm:p-10 border-2 border-orange-100">
                        ...
                        <div class="relative">
                            ...
                            <!-- Descri├º├úo principal -->
                            <div class="space-y-4 mb-8">
                                <p class="text-lg text-gray-700 leading-relaxed">
                                    <strong class="text-primary font-bold">Lukrato</strong> vem do verbo 
                                    <strong class="text-gray-900">"lucrar"</strong> ΓÇô e n├úo ├⌐ por acaso! 
                                </p>
                                
                                <p class="text-lg text-gray-600 leading-relaxed">
                                    Para come├ºar a ter lucros de verdade, voc├¬ precisa primeiro se organizar financeiramente. 
                                    ├ë assim que voc├¬ consegue guardar sua grana e fazer seu dinheiro trabalhar para voc├¬.
                                </p>
                            </div>
                            ...
                            <div class="grid sm:grid-cols-2 gap-4">
                                <div class="flex items-start gap-3 p-4 bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-600">Controle total das suas finan├ºas</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-3 p-4 bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-600">Fa├ºa seu dinheiro crescer</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-8 p-6 bg-gradient-to-r from-primary/10 to-orange-600/10 border-l-4 border-primary rounded-r-xl">
                                <p class="text-gray-800 italic font-medium">
                                    "Organiza├º├úo financeira ├⌐ o primeiro passo para conquistar seus objetivos e ter tranquilidade no futuro."
                                </p>
                            </div>
                        </div>
                    </div>
...
<div id="galleryModal" 
     x-data="{ 
        ...
        currentSlide: 0, 
        slides: [
            { src: '<?= BASE_URL ?>assets/img/mockups/dashboard.png', title: 'Dashboard', desc: 'Vis├úo geral r├ípida: saldo, receitas e despesas do m├¬s.' },
            ...
            { src: '<?= BASE_URL ?>assets/img/mockups/relatorios.png', title: 'Relat├│rios', desc: 'Gr├íficos e insights para entender seus gastos e evolu├º├úo.' },
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="max-w-3xl mx-auto text-center mb-16" data-aos="fade-up">
            <h2 class="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
                Benef├¡cios pensados para facilitar sua 
                <span class="bg-gradient-to-r from-primary to-orange-600 bg-clip-text text-transparent">
                    vida financeira
                </span>
            </h2>
            <p class="text-lg sm:text-xl text-gray-600 leading-relaxed">
                O Lukrato n├úo ├⌐ apenas um sistema. Ele foi criado para ajudar voc├¬ a
                organizar seu dinheiro, evitar preocupa├º├╡es e tomar decis├╡es melhores
                no dia a dia, sem complica├º├úo.
            </p>
        </div>
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mb-16">
            ...
            <div class="group bg-white rounded-2xl p-8 shadow-md hover:shadow-2xl transition-all duration-300 hover:-translate-y-2" data-aos="fade-up" data-aos-delay="100">
                ...
                <p class="text-gray-600 leading-relaxed">
                    ...
                    Nada de confus├úo, anota├º├╡es soltas ou planilhas dif├¡ceis de entender.
                </p>
            </div>
            ...
            <div class="group bg-white rounded-2xl p-8 shadow-md hover:shadow-2xl transition-all duration-300 hover:-translate-y-2" data-aos="fade-up" data-aos-delay="300">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-3">Evite atrasos e juros desnecess├írios</h3>
                <p class="text-gray-600 leading-relaxed">
                    Com agendamentos e lembretes, voc├¬ n├úo esquece mais contas importantes
            ...
            <div class="group bg-white rounded-2xl p-8 shadow-md hover:shadow-2xl transition-all duration-300 hover:-translate-y-2" data-aos="fade-up" data-aos-delay="400">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-3">Decis├╡es melhores com dados visuais</h3>
                <p class="text-gray-600 leading-relaxed">
                    Gr├íficos simples mostram seus h├íbitos financeiros e ajudam voc├¬
            ...
            <div class="group bg-white rounded-2xl p-8 shadow-md hover:shadow-2xl transition-all duration-300 hover:-translate-y-2" data-aos="fade-up" data-aos-delay="500">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-3">F├ícil de usar, mesmo para iniciantes</h3>
                <p class="text-gray-600 leading-relaxed">
            ...
            <div class="sm:col-span-2 lg:col-span-1 group bg-gradient-to-br from-primary to-orange-600 rounded-2xl p-8 shadow-md hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 text-white" data-aos="fade-up" data-aos-delay="600">
                ...
                <p class="text-blue-50 leading-relaxed mb-6">
                    Sem necessidade de cart├úo de cr├⌐dito. Crie sua conta gratuitamente e comece a organizar suas finan├ºas hoje.
                </p>
                <a href="<?= BASE_URL ?>login" 
        ...
        <div class="max-w-2xl mx-auto text-center bg-white rounded-2xl shadow-xl p-8 sm:p-12" data-aos="fade-up">
            ...
            <p class="text-lg text-gray-600 mb-8">
                Comece agora mesmo, sem complica├º├úo e sem custos iniciais.
            </p>
            <a href="<?= BASE_URL ?>login" 
...
<section id="planos" class="relative py-20 md:py-32 bg-white">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Header -->
        <!-- Container ├║nico com Alpine.js para sincronizar toggle e cards -->
        <div x-data="{ 
                period: 'mensal',
                get discount() {
                ...
                get periodLabel() {
                    if (this.period === 'mensal') return 'm├¬s';
            ...
            <div class="max-w-3xl mx-auto text-center mb-12" data-aos="fade-up">
                ...
                <p class="text-lg sm:text-xl text-gray-600 mb-8">
                    Comece gr├ítis e evolua para o Pro quando quiser mais controle, organiza├º├úo e tranquilidade no dia a dia.
                </p>
            ...
            <div class="bg-white border-2 border-gray-200 rounded-2xl p-8 hover:border-orange-300 hover:shadow-xl transition-all duration-300" data-aos="fade-right">
                <div class="mb-6">
                    ...
                    <p class="text-gray-600">
                        <?= htmlspecialchars($planoGratuito->metadados['descricao'] ?? 'Ideal para testar o sistema e entender sua organiza├º├úo financeira.') ?>
                    </p>
                </div>
                ...
                <ul class="space-y-4 mb-8">
                    ...
                    $limitacoes = $planoGratuito->metadados['limitacoes'] ?? [
                        'Relat├│rios avan├ºados',
                        'Agendamentos de pagamentos',
                        'Exporta├º├úo de dados',
            ...
            <div class="relative bg-gradient-to-br from-primary to-orange-600 rounded-2xl p-8 text-white shadow-2xl hover:shadow-3xl hover:scale-105 transition-all duration-300" 
                ...
                <div class="mb-6 pt-4">
                    ...
                    <!-- Pre├ºo Original Riscado (aparece apenas com desconto) -->
                    ...
                    <p class="text-orange-100">
                        <?php if (isset($plano->metadados['mensagens'])): ?>
                            <span x-show="period === 'mensal'"><?= htmlspecialchars($plano->metadados['mensagens']['mensal'] ?? 'Plano mensal flex├¡vel') ?></span>
                        ...
                        <?php else: ?>
                            <span x-show="period === 'mensal'">Menos que um lanche por m├¬s para ter controle total do seu dinheiro.</span>
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white rounded-3xl shadow-2xl p-8 sm:p-12 lg:p-16" data-aos="zoom-in">
                ...
                <p class="text-lg sm:text-xl text-center text-gray-600 mb-12 max-w-2xl mx-auto">
                    ...
                    Voc├¬ come├ºa gr├ítis e s├│ evolui para o Pro se fizer sentido para voc├¬.
                </p>
                ...
                <ul class="space-y-6 mb-12">
                    <li class="flex items-start gap-4 group">
                        ...
                        <div class="flex-1 pt-2">
                            <p class="text-lg text-gray-800 font-medium">
                                Comece gr├ítis, sem cart├úo de cr├⌐dito
                            </p>
                        </div>
                    </li>
                    ...
                    <li class="flex items-start gap-4 group">
                        ...
                        <div class="flex-1 pt-2">
                            <p class="text-lg text-gray-800 font-medium">
                                Seus dados s├úo privados e protegidos
                            </p>
                        </div>
                    </li>
                </ul>
                ...
                <div class="text-center">
                    ...
                    <p class="text-sm text-gray-500">
                        ...
                        Leva menos de 2 minutos para come├ºar
                    </p>
                </div>
...
<section id="contato" class="relative py-20 md:py-32 bg-white" x-data="{ activeTab: 'whatsapp' }">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="max-w-3xl mx-auto text-center mb-12" data-aos="fade-up">
            ...
            <p class="text-lg sm:text-xl text-gray-600 mb-8">
                Tirou d├║vidas, quer sugest├╡es ou precisa de ajuda? Escolha o canal abaixo.
            </p>
        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div x-show="activeTab === 'whatsapp'" 
                ...
                <div class="text-center mb-8">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 mb-2">Atendimento r├ípido</h3>
                    <p class="text-gray-600">Normalmente respondemos em poucos minutos em hor├írio comercial.</p>
                </div>
            ...
            <div x-show="activeTab === 'email'" 
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-600">Prefere e-mail? Mande sua d├║vida e respondemos em at├⌐ 1 dia ├║til.</p>
                </div>
                ...
                <form id="contactForm" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input id="lk_assunto" 
                               name="assunto" 
                               type="text" 
                               placeholder="Ex: D├║vida sobre o plano Pro" 
                               required
                               class="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-xl focus:border-primary focus:ring-2 focus:ring-orange-200 outline-none transition-all">
                    </div>
...
<!-- Estilos Tailwind customizados e anima├º├╡es -->
<style>
    @keyframes blob {
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (contactForm) {
            contactForm.addEventListener('submit', async function(e) {
                ...
                // Desabilita o bot├úo e mostra loading
        ...
        // Fun├º├úo para mostrar notifica├º├╡es
        function showNotification(message, type = 'success') {
            // Remove notifica├º├úo anterior se existir
            const oldNotification = document.querySelector('.contact-notification');
            if (oldNotification) {
                oldNotification.remove();
            }
            
            // Cria nova notifica├º├úo
    ...
    // Fallback para galeria (caso Alpine.js n├úo carregue)
    document.addEventListener('DOMContentLoaded', function() {
        ...
        window.addEventListener('open-gallery', function() {
            if (modal) {
                ...
                // Se n├úo, pelo menos o modal fica vis├¡vel
            }
        });
        
        // Fallback: se clicar no bot├úo e nada acontecer ap├│s 100ms, abre manualmente
        setTimeout(function() {
