<section id="funcionalidades" class="lk-section lk-func">
    <div class="lk-container lk-func-grid">
        ...
        <div class="lk-func-text">
            ...
            <h2>Veja o Lukrato organizando suas finanças por você.</h2>
            ...
            <ul class="lk-func-list">
                <li class="lk-feature">
                    ...
                    <div class="lk-feature-body">
                        <strong>Visão clara do mês</strong><br>
                        <span>Saldo consolidado e leitura rápida do que importa.</span>
                    </div>
                </li>
                ...
                <li class="lk-feature">
                    ...
                    <div class="lk-feature-body">
                        <strong>Relatórios e gráficos</strong><br>
                        <span>Entenda seus hábitos com visual limpo e objetivo.</span>
                    </div>
                </li>
            </ul>
