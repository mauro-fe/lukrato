...
<section id="planos" class="relative py-16 md:py-24 bg-gradient-to-b from-gray-50 to-white"
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <?php
        // === Definição unificada de features para comparação padronizada ===
        $allFeatures = [
        ...
        <div x-data="{ 
                ...
                get periodMultiplier() {
                    if (this.period === 'semestral') return 6;
                    if (this.period === 'anual') return 12;
                    return 1;
                },
                calcPrice(base) {
                    if (this.period === 'mensal') return base.toFixed(2);
                    const total = base * this.periodMultiplier * (1 - this.discount / 100);
                ...
                calcSavings(base) {
                    return (base * this.periodMultiplier * this.discount / 100).toFixed(2);
                },
                calcOriginal(base) {
                    return (base * this.periodMultiplier).toFixed(2);
                },
                scrollToProCard() {
                    setTimeout(() => {
                ...
                ?>
                    ...
                    <?php if (!$isUltra): ?>
                        ...
                        <div id="card-pro"
                            ...
                            x-data="{ basePrice: <?= $precoMensal ?> }" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <div class="flex-grow">
                                ...
                                <div class="mb-6 pt-2">
                                    <div class="flex items-center gap-3 mb-1">
                                        ...
                                        <h3 class="text-xl font-bold text-gray-900"><?= htmlspecialchars($plano->nome) ?></h3>
                                    </div>
                                    ...
                                    <div class="h-5 mb-1">
                                        <template x-if="period !== 'mensal'">
                                            <span class="text-gray-400 line-through text-sm"
                                                x-text="'De R$ ' + calcOriginal(basePrice)"></span>
                                        </template>
                                    </div>
                    ...
                    <?php else: ?>
                        ...
                        <div id="card-ultra"
                            ...
                            x-data="{ basePrice: <?= $precoMensal ?> }" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div class="flex-grow">
                                ...
                                <div class="mb-6 pt-2">
                                    <div class="flex items-center gap-3 mb-1">
                                        ...
                                        <h3 class="text-xl font-bold text-white"><?= htmlspecialchars($plano->nome) ?></h3>
                                    </div>
            ...
            <div class="text-center mb-12" data-aos="fade-up">
                ...
                <button @click="showTable = !showTable"
                    ...
                    <span <span x-show="showTable">Ocultar comparação detalhada</span>
                                ...
                                <tr class="border-b border-gray-100">
                                    ...
                                    <th class="text-center py-4 px-4 w-1/5 relative">
                                        ...
                                        <span class="text-xs font-normal text-gray-400"
                                            x-text="'R$ ' + (<?= $planosPagos->first() ? $planosPagos->first()->preco_centavos / 100 : 0 ?>).toFixed(2) + '/mês'">
                                        </span>
                                        <span
                                    ...
                                    <th class="text-center py-4 px-4 font-semibold text-gray-900 w-1/5">
                                        ...
                                        <span class="text-xs font-normal text-gray-400"
                                            x-text="'R$ ' + (<?= $planosPagos->last() ? $planosPagos->last()->preco_centavos / 100 : 0 ?>).toFixed(2) + '/mês'">
                                        </span>
                                    </th>
                                </tr>
                            </thead>
