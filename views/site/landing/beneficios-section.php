    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8" role="list">
            ...
            <article class="group bg-white rounded-2xl p-7 shadow-sm border border-gray-100 hover:shadow-lg hover:border-orange-100 transition-all duration-300"
                data-aos="fade-up" data-aos-delay="0" role="listitem">
                <div class="w-12 h-12 rounded-xl bg-orange-50 flex items-center justify-center text-primary mb-5"
                    aria-hidden="true">
            ...
            <!-- Card 6 - destaque -->
            <article class="group bg-gradient-to-br from-primary to-orange-600 rounded-2xl p-7 shadow-sm hover:shadow-lg transition-all duration-300 text-white"
