...
<section id="inteligencia-artificial" class="relative py-16 md:py-24 overflow-hidden bg-gradient-to-b from-white to-gray-50"
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-2 gap-6 lg:gap-8 max-w-5xl mx-auto mb-12">
            ...
            <!-- Card 2 - Categorizador Inteligente -->
            <article class="group bg-white rounded-2xl p-7 shadow-sm border border-gray-100 hover:shadow-lg hover:border-orange-100 transition-all duration-300"
                ...
                <h3 class="font-bold text-lg text-gray-900 mb-2">Categorizador inteligente</h3>
                <p class="text-gray-600 text-sm leading-relaxed">
                    Digitou a descrição do lançamento? A IA sugere a categoria certa automaticamente.
                    Economize tempo e mantenha tudo organizado sem esforço.
                </p>
            </article>
            ...
            <article class="group bg-white rounded-2xl p-7 shadow-sm border border-gray-100 hover:shadow-lg hover:border-orange-100 transition-all duration-300"
                ...
                <h3 class="font-bold text-lg text-gray-900 mb-2">Análise financeira inteligente</h3>
                <p class="text-gray-600 text-sm leading-relaxed">
                ...
                <div class="relative z-10 flex flex-col md:flex-row items-center gap-6 md:gap-10">
                    ...
                    <div class="flex-shrink-0">
                        <a href="<?= BASE_URL ?>login"
                            class="inline-flex items-center gap-2 px-8 py-4 bg-white text-orange-600 font-bold rounded-xl hover:bg-gray-50 transition-all shadow-lg hover:shadow-xl hover:scale-[1.02]">
