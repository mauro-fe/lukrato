...
<footer class="lk-footer">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div class="space-y-4">
                ...
                <div class="lk-footer-icons flex gap-3 pt-2">
                    <a href="#"
                        class="w-10 h-10 bg-white rounded-lg flex items-center justify-center transition-colors">
            ...
            <div class="lk-footer-links">
                ...
                <nav class="flex flex-col gap-3">
                    <a href="<?= BASE_URL ?>/#funcionalidades"
                        class="text-white-400 hover:text-primary transition-colors">
                        Funcionalidades
                    </a>
                    <a href="<?= BASE_URL ?>/#beneficios" class="text-white-400 hover:text-white transition-colors">
                        Benefícios
                    </a>
                    <a href="<?= BASE_URL ?>/#planos" class="text-white-400 hover:text-white transition-colors">
                        Planos
                    </a>
                    <a href="<?= BASE_URL ?>login" class="text-white-400 hover:text-white transition-colors">
                        Entrar
                    </a>
                </nav>
            </div>
            ...
            <div class="lk-footer-links">
                ...
                <nav class="flex flex-col gap-3">
                    <a href="<?= BASE_URL ?>termos" class="text-white-400 hover:text-white transition-colors">
                        Termos de Uso
                    </a>
                    <a href="<?= BASE_URL ?>privacidade" class="text-white-400 hover:text-white transition-colors">
                        Política de Privacidade
                    </a>
                    <a href="<?= BASE_URL ?>lgpd" class="text-white-400 hover:text-white transition-colors">
            ...
            <div class="lk-footer-links">
                ...
                <div class="flex flex-col gap-3">
                    <a href="https://wa.me/5544999506302"
                        class="inline-flex items-center gap-2 text-white-400 hover:text-white transition-colors">
                        <i class="fa-brands fa-whatsapp"></i>
                        WhatsApp comercial
                    </a>
                    <a href="mailto:lukratosistema@gmail.com"
                        class="inline-flex items-center gap-2 text-white-400 hover:text-white transition-colors break-all">
        ...
        <!-- Bottom -->
        <div class="pt-8 border-t border-white-700 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p class="text-white-400 text-sm">
                © 2025 Lukrato. Todos os direitos reservados.
            </p>
            <p class="text-white-500 text-sm italic">
