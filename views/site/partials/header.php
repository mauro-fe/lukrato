...
<body class="antialiased">
    ...
    <header x-data="{ 
                ...
                scrolled: false
            }" @scroll.window="scrolled = window.scrollY > 20" :class="scrolled ? 'bg-white shadow-lg' : 'bg-white/95'"
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div x-show="mobileMenuOpen" x-transition:enter="transition ease-out duration-200"
                ...
                class="lg:hidden py-4 border-t border-gray-100" style="display: none;">
