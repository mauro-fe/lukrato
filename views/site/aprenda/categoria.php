        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <?php if ($totalPages > 1): ?>
                <nav class="aprenda-pagination" aria-label="Paginação">
                    <?php if ($page > 1): ?>
                        <a href="<?= rtrim(BASE_URL, '/') ?>/blog/categoria/<?= $categoria->slug ?>?page=<?= $page - 1 ?>" class="aprenda-page-btn" aria-label="Página anterior">
                    ...
                    <?php if ($page < $totalPages): ?>
                        <a href="<?= rtrim(BASE_URL, '/') ?>/blog/categoria/<?= $categoria->slug ?>?page=<?= $page + 1 ?>" class="aprenda-page-btn" aria-label="Próxima página">
...
<?php else: ?>
    <section class="py-20 bg-gray-50 dark:bg-gray-800/50">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a href="<?= rtrim(BASE_URL, '/') ?>/blog" class="inline-flex items-center gap-2 text-primary font-medium hover:underline">
