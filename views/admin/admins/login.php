            ...
            <div class="card auth-tabs-card" data-active="login">
                ...
                <div class="tab-panel" id="tab-login" role="tabpanel" aria-labelledby="btn-login">
                    ...
                    <form action="<?= BASE_URL ?>login/entrar" method="POST" id="loginForm" novalidate>
                        ...
                        <button type="submit" id="submitBtn" class="btn-primary"><span class="btn-text">Entrar</span></button>
                ...
                <div class="tab-panel is-hidden" id="tab-register" role="tabpanel" aria-labelledby="btn-register">
                    ...
                    <form action="<?= BASE_URL ?>register/criar" method="POST" id="registerForm" novalidate>
                        ...
                        <div class="field">
                            <input type="text" id="name" name="name" placeholder="Nome completo" autocomplete="name" required />
                            <small class="field-error" id="nameError"></small>
                        </div>

                        <div class="field">
                            <input type="email" id="reg_email" name="email" placeholder="E-mail" autocomplete="email" required />
                            <small class="field-error" id="regEmailError"></small>
                        </div>

                        <div class="field">
                            <input type="password" id="reg_password" name="password" placeholder="Senha" autocomplete="new-password" required />
                            <small class="field-error" id="regPasswordError"></small>
                        </div>

                        <div class="field">
                            <input type="password" id="reg_password_confirm" name="password_confirmation" placeholder="Confirmar senha" autocomplete="new-password" required />
