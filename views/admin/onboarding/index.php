...
@keyframes obIconPulse {
    0%, 100% { box-shadow: 0 8px 24px color-mix(in srgb, var(--color-primary) 30%, transparent); }
    50%      { box-shadow: 0 8px 32px color-mix(in srgb, var(--color-primary) 50%, transparent); }
}
...
<div class="lk-onboarding-wrapper">
    <div class="lk-onboarding-card">
        ...
        <!-- Form -->
        <form method="POST" action="<?= BASE_URL ?>api/onboarding/conta" class="lk-onboarding-form" id="onboardingContaForm">
