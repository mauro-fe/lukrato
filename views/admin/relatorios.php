            ...
            <div class="lk-h">
                ...
                <div class="lk-controls">
                    ...
                    <div class="lk-seg" id="tabs">
                        <button class="active" data-view="pizza"><i class="fa-solid fa-chart-pie"></i> Por categoria</button>
                    ...
                    <div class="lk-sel" id="typeSelect">
                        <button id="typeBtn"><span class="lb">Despesas por categorias</span> <i class="fa-solid fa-chevron-down"></i></button>
