            ...
            <div class="modal-body pt-0">
                ...
                <form id="formLancamento" novalidate>
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control form-control-sm" id="editLancData" required aria-required="true">
                    </div>
                    <div class="row g-3">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select form-select-sm" id="editLancConta" required aria-required="true"></select>
                        </div>
                    </div>
                    <div class="mb-3 mt-3">
                    ...
                    <div class="row g-3">
                        <div class="col-md-3">
                            ...
                            <input type="number" class="form-control form-control-sm" id="editLancValor" step="0.01" required aria-required="true">
                        </div>
                        <div class="col-md-9">
                            <label for="editLancDescricao" class="form-label">Descrição</label>
                            <input type="text" class="form-control form-control-sm" id="editLancDescricao" aria-label="Descrição do lançamento">
                        </div>
                    </div>
