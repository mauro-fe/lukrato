...
<div class="form-row">
    ...
    <div class="form-group">
        ...
        <input type="text" id="ultimosDigitos" name="ultimos_digitos" class="form-input" placeholder="1234" required
...
<div class="form-group">
    ...
    <div class="input-with-prefix">
        ...
        <input type="text" id="limiteTotal" name="limite_total" class="form-input" placeholder="0,00" required>
    </div>
...
<div class="form-row">
    <div class="form-group">
        ...
        <input type="number" id="diaFechamento" name="dia_fechamento" class="form-input" min="1" max="31"
    ...
    <div class="form-group">
        <label for="diaVencimento" class="form-label lk-label">
            ...
            <button type="button" class="lk-info" data-lk-tooltip-title="Dia de vencimento"
                data-lk-tooltip="Ultimo dia para pagar a fatura sem juros." aria-label="Ajuda: Dia de vencimento">
                <i data-lucide="info" aria-hidden="true"></i>
            </button>
        </label>
        <input type="number" id="diaVencimento" name="dia_vencimento" class="form-input" min="1" max="31"
    ...
    <div id="cartaoCanaisLembrete" style="display: none; margin-top: 8px;">
        <div class="reminder-channels">
            <label class="reminder-channel">
                <input type="checkbox" id="cartaoCanalInapp" name="fatura_canal_inapp" checked style="width: auto;">
                <i data-lucide="bell" style="width: 14px; height: 14px;"></i>
                Notificacao
            </label>
            <label class="reminder-channel">
                <input type="checkbox" id="cartaoCanalEmail" name="fatura_canal_email" style="width: auto;">
