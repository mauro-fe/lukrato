...
<div class="lk-modal-overlay lk-modal-overlay-lancamento" id="modalLancamentoOverlay">
                ...
                <div class="lk-wizard-step" data-step="4" id="contasStep4">
                    ...
                    <div class="lk-form-group">
                        <label class="lk-label required">
                            <i data-lucide="calendar-clock"></i>
                            <span id="labelDataLancamento">Quando?</span>
                        </label>
                        <div class="lk-datetime-inline">
                            <div class="lk-datetime-date">
                                <i data-lucide="calendar" class="lk-datetime-icon"></i>
                                <input type="date" id="lancamentoData" name="data" class="lk-input lk-input-date" required>
                            </div>
                            ...
                            <div class="lk-datetime-time">
                                ...
                                <input type="time" id="lancamentoHora" name="hora_lancamento" class="lk-input lk-input-time" placeholder="--:--">
                            </div>
                        </div>
                ...
                <div class="lk-wizard-step" data-step="5" id="contasStep5">
                    ...
                    <div class="lk-form-group" id="categoriaGroup">
                        ...
                        <div class="lk-ai-category-row">
                            ...
                            <button type="button" class="lk-btn-ai-suggest" id="btnAiSuggestCategoria"
                                onclick="contasManager.sugerirCategoriaIA()"
