...
$sidebarThemeLabel = strtolower((string) $userTheme) === 'light' ? 'Light' : 'Dark';
$sidebarThemeNextLabel = $sidebarThemeLabel === 'Dark' ? 'Light' : 'Dark';
...
<body data-lk-menu="<?= htmlspecialchars((string) $menu, ENT_QUOTES, 'UTF-8') ?>"
    ...
    <aside class="sidebar surface-card" id="sidebar-main">
        ...
        <div class="sidebar-footer">
            ...
            <?php endif; ?>
            <button id="sidebarThemeToggle" type="button" class="nav-item theme-toggle sidebar-theme-toggle"
                data-theme-toggle
                aria-label="Tema atual: <?= htmlspecialchars($sidebarThemeLabel, ENT_QUOTES, 'UTF-8') ?>. Alternar para <?= htmlspecialchars($sidebarThemeNextLabel, ENT_QUOTES, 'UTF-8') ?>"
                title="Tema atual: <?= htmlspecialchars($sidebarThemeLabel, ENT_QUOTES, 'UTF-8') ?>">
                <div class="sidebar-theme-toggle__icon" aria-hidden="true">
                    <i data-lucide="sun"></i>
                    <i data-lucide="moon"></i>
                </div>
                <span class="nav-item-content">
                    <span class="nav-item-title"
                        data-theme-current-label><?= htmlspecialchars($sidebarThemeLabel, ENT_QUOTES, 'UTF-8') ?></span>
