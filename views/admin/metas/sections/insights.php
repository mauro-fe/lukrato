<!-- ==================== INSIGHTS ==================== -->
<div class="met-insights-section surface-card surface-card--interactive" id="metInsightsSection" style="display:none;" data-aos="fade-up">
    <div class="met-insights-section__head">
