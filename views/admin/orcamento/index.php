        ...
        <div class="orc-customize-modal surface-card" role="dialog" aria-modal="true"
            ...
            <div class="orc-customize-body">
                ...
                <div class="orc-customize-presets" role="group" aria-label="Preset de visualizacao">
                    <button class="orc-customize-preset" id="btnPresetEssencialOrcamento" type="button">Modo essencial</button>
                    <button class="orc-customize-preset" id="btnPresetCompletoOrcamento" type="button">Modo completo</button>
                </div>
