<div class="quality-section" id="qualitySection">
    ...
    <div class="metrics-grid">
        <div class="metric-card warning">
            ...
            <div class="metric-label">Baixa confiança</div>
        </div>
        <div class="metric-card warning">
    ...
    <div class="quality-panels">
        <div class="metric-card quality-panel">
            <div class="metric-label quality-panel-title">Distribuição de intents</div>
        ...
        <div class="metric-card quality-panel">
            <div class="metric-label quality-panel-title">Origem da decisão</div>
            <div id="sourceDistribution" class="quality-panel-list">
                <span class="panel-loading">Carregando...</span>
            </div>
        </div>
        <div class="metric-card quality-panel">
            <div class="metric-label quality-panel-title">Latência por tipo</div>
