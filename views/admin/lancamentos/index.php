        ...
        <div class="modern-card export-card <?= !$isPro ? 'pro-locked' : '' ?>" data-aos="fade-up" data-aos-delay="100"
            ...
            <div class="card-header-icon">
                ...
                <div class="card-title-group">
                    ...
                    <p class="card-subtitle">Bloco secundario para exportacao rapida em PDF ou Excel.</p>
                </div>
                <?php if (!$isPro): ?>
                    ...
                    <div class="pro-overlay">
                        <div class="pro-message">
                            ...
                            <p
                                ...
                                Exportacao de lancamentos e exclusiva do <a href="<?= BASE_URL ?>billing">plano Pro</a>.
                            </p>
                        </div>
                    </div>
                <?php endif; ?>
                    ...
                    <div class="export-filters-row">
                        ...
                        <div class="export-filter-item">
                            ...
                            <select id="exportCategoria" class="modern-select export-select"
                                data-lk-custom-select="export" <?= !$isPro ? 'disabled' : '' ?>>
                                <option value="">Todas</option>
                            </select>
                        </div>
                ...
                <div class="lk-filters-row">
                    ...
                    <div class="lk-filter-group">
                        <div class="lk-filter-chip-select">
                            <i data-lucide="tag"></i>
                            <select id="filtroTipo" class="lk-filter-native" data-lk-custom-select="chip"
                        ...
                        <div class="lk-filter-chip-select">
                            ...
                            <select id="filtroCategoria" class="lk-filter-native" data-lk-custom-select="chip"
                        ...
                        <div class="lk-filter-chip-select">
                            <i data-lucide="wallet"></i>
                            <select id="filtroConta" class="lk-filter-native" data-lk-custom-select="chip"
                        ...
                        <div class="lk-filter-chip-select">
                            ...
                            <select id="filtroStatus" class="lk-filter-native" data-lk-custom-select="chip"
                                ...
                                <tr>
                                    <th class="th-checkbox">
                                        <input type="checkbox" id="selectAllLancamentos" class="lk-checkbox"
                                            title="Selecionar itens da pagina atual"
                                            aria-label="Selecionar itens da pagina atual">
                                    </th>
