<section class="lan-summary-strip" id="lanSummaryStrip" data-aos="fade-up" data-aos-delay="100"
    ...
    <div class="lan-summary-card total surface-card surface-card--interactive">
        <div class="lan-summary-icon"><i data-lucide="rows-3"></i></div>
        <div class="lan-summary-info">
            <span class="lan-summary-label">Lançamentos</span>
            <span class="lan-summary-value" id="lanHeroTotalCount">0 lançamentos</span>
        </div>
    </div>
