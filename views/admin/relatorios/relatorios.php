        ...
        (function() {
            ...
            async function loadAccounts() {
                ...
                try {
                    ...
                    if (st.accountId) {
                        accountSelect.value = String(st.accountId);
                    } else {
                        accountSelect.value = '';
                    }
            ...
            async function fetchData() {
                ...
                try {
                    ...
                    // 👇 novo: se 403, mostra upgrade e retorna vazio (para parar a renderização)
                    if (await handleFetch403(r, base)) {
                        return {
                            labels: [],
                            values: []
                        };
                    ...
                    // payload embrulhado ou não
                    const payload = (json && typeof json === 'object' && 'status' in json && 'data' in json) ? json
                        .data : json;
                    return payload;
                } catch (e) {
                    console.error(e);
