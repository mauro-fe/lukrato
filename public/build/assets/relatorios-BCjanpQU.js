import{m as Ae,b as Te,e as he,k as R}from"./api-EIRNFJb7.js";import{a as Ie}from"./utils-Bj4jxwhy.js";import{c as $e,p as _e,f as Me}from"./ui-preferences-B8SkNUZA.js";import{o as Le,g as Re,e as ke}from"./runtime-config-BDcybaNg.js";import{r as Oe}from"./finance-CgaDv1sH.js";import{r as Pe,a as Ne,b as Be,c as De,d as Ve,e as ie}from"./reports-CXrVZnrN.js";const Y="Relatórios são exclusivos do plano Pro.",u={BASE_URL:Ae(),CHART_COLORS:["#E67E22","#2C3E50","#2ECC71","#F39C12","#9B59B6","#1ABC9C","#E74C3C","#3498DB"],FETCH_TIMEOUT:3e4,VIEWS:{CATEGORY:"category",BALANCE:"balance",COMPARISON:"comparison",ACCOUNTS:"accounts",CARDS:"cards",EVOLUTION:"evolution",ANNUAL_SUMMARY:"annual_summary",ANNUAL_CATEGORY:"annual_category"}},Fe=new Set([u.VIEWS.ANNUAL_SUMMARY,u.VIEWS.ANNUAL_CATEGORY]),q={[u.VIEWS.CATEGORY]:[{value:"despesas_por_categoria",label:"Despesas por categoria"},{value:"receitas_por_categoria",label:"Receitas por categoria"}],[u.VIEWS.ANNUAL_CATEGORY]:[{value:"despesas_anuais_por_categoria",label:"Despesas anuais por categoria"},{value:"receitas_anuais_por_categoria",label:"Receitas anuais por categoria"}]},L={ACTIVE_SECTION:"rel_active_section",ACTIVE_VIEW:"rel_active_view",CATEGORY_TYPE:"rel_category_type",ANNUAL_CATEGORY_TYPE:"rel_annual_category_type"},ce={overview:{kicker:"Painel consolidado",title:"Leia seu mes com contexto",description:"Veja seu pulso financeiro, identifique sinais importantes e acompanhe a evolucao do periodo em um resumo rapido."},relatorios:{kicker:"Relatorio ativo",title:"Transforme lancamentos em decisao",description:"Explore seus numeros por categoria, conta, cartao e evolucao para descobrir onde agir."},insights:{kicker:"Leitura automatica",title:"Insights que ajudam a agir",description:"Receba sinais claros sobre gastos, saldo, concentracoes e oportunidades sem precisar interpretar tudo manualmente."},comparativos:{kicker:"Comparacao temporal",title:"Compare e ajuste sua rota",description:"Entenda o que melhorou, piorou ou estagnou em relacao ao mes e ao ano anteriores."}},le={[u.VIEWS.CATEGORY]:{title:"Categorias do periodo",description:"Encontre rapidamente onde seu dinheiro esta concentrado por categoria."},[u.VIEWS.BALANCE]:{title:"Saldo diario",description:"Acompanhe como seu caixa evolui ao longo do periodo."},[u.VIEWS.COMPARISON]:{title:"Receitas x despesas",description:"Compare entradas e saidas para entender pressao ou folga no caixa."},[u.VIEWS.ACCOUNTS]:{title:"Desempenho por conta",description:"Descubra quais contas concentram mais entradas e saidas."},[u.VIEWS.CARDS]:{title:"Saude dos cartoes",description:"Monitore faturas, uso de limite e sinais de atencao nos cartoes."},[u.VIEWS.EVOLUTION]:{title:"Evolucao em 12 meses",description:"Observe tendencia, sazonalidade e ritmo financeiro ao longo do ultimo ano."},[u.VIEWS.ANNUAL_SUMMARY]:{title:"Resumo anual",description:"Compare mes a mes como receitas, despesas e saldo se comportaram no ano."},[u.VIEWS.ANNUAL_CATEGORY]:{title:"Categorias do ano",description:"Veja quais categorias dominaram seu ano e onde houve maior concentracao."}};function ge(){const e=new Date;return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}`}const f=e=>String(e??"").replace(/[&<>"']/g,function(t){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[t]??t});function Ue(e,t="#cccccc"){return/^#[0-9A-Fa-f]{6}$/.test(e)?e:t}const i={activeSection:"overview",currentView:u.VIEWS.CATEGORY,categoryType:"despesas_por_categoria",annualCategoryType:"despesas_anuais_por_categoria",currentMonth:ge(),currentAccount:null,chart:null,accounts:[],accessRestricted:!1,lastReportError:null,activeDrilldown:null,reportDetails:null},x={getCurrentMonth:ge,formatCurrency(e){return Ie(e)},formatMonthLabel(e){const[t,a]=e.split("-");return new Date(t,a-1).toLocaleDateString("pt-BR",{month:"long",year:"numeric"})},addMonths(e,t){const[a,s]=e.split("-").map(Number),o=new Date(a,s-1+t);return`${o.getFullYear()}-${String(o.getMonth()+1).padStart(2,"0")}`},hexToRgba(e,t=.25){const a=parseInt(e.slice(1,3),16),s=parseInt(e.slice(3,5),16),o=parseInt(e.slice(5,7),16);return`rgba(${a}, ${s}, ${o}, ${t})`},generateShades(e,t){const a=parseInt(e.slice(1,3),16),s=parseInt(e.slice(3,5),16),o=parseInt(e.slice(5,7),16),r=[];for(let n=0;n<t;n++){const l=.35-n/Math.max(t-1,1)*.7,c=h=>Math.min(255,Math.max(0,Math.round(h+(l>0?(255-h)*l:h*l)))),d=c(a),m=c(s),p=c(o);r.push(`#${d.toString(16).padStart(2,"0")}${m.toString(16).padStart(2,"0")}${p.toString(16).padStart(2,"0")}`)}return r},isYearlyView(e=i.currentView){return Fe.has(e)},extractFilename(e){if(!e)return null;const t=/filename\*=UTF-8''([^;]+)/i.exec(e);if(t)try{return decodeURIComponent(t[1])}catch{return t[1]}const a=/filename="?([^";]+)"?/i.exec(e);return a?a[1]:null},getCssVar(e,t=""){try{return(getComputedStyle(document.documentElement).getPropertyValue(e)||"").trim()||t}catch{return t}},isLightTheme(){try{return(document.documentElement?.getAttribute("data-theme")||"dark")==="light"}catch{return!1}},getReportType(){return{[u.VIEWS.CATEGORY]:i.categoryType,[u.VIEWS.ANNUAL_CATEGORY]:i.annualCategoryType,[u.VIEWS.BALANCE]:"saldo_mensal",[u.VIEWS.COMPARISON]:"receitas_despesas_diario",[u.VIEWS.ACCOUNTS]:"receitas_despesas_por_conta",[u.VIEWS.CARDS]:"cartoes_credito",[u.VIEWS.EVOLUTION]:"evolucao_12m",[u.VIEWS.ANNUAL_SUMMARY]:"resumo_anual"}[i.currentView]??i.categoryType},getActiveCategoryType(){return i.currentView===u.VIEWS.ANNUAL_CATEGORY?i.annualCategoryType:i.categoryType}},M={},_=e=>x.formatCurrency(e),U=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]||t);function H(){const e=(document.documentElement.getAttribute("data-theme")||"").toLowerCase()==="light"||x.isLightTheme?.();return{isLight:e,mode:e?"light":"dark",textColor:e?"#2c3e50":"#ffffff",textMuted:e?"#6c757d":"rgba(255, 255, 255, 0.7)",gridColor:e?"rgba(0, 0, 0, 0.08)":"rgba(255, 255, 255, 0.05)",surfaceColor:getComputedStyle(document.documentElement).getPropertyValue("--color-surface").trim()}}function Q(e=[]){return e.map(t=>{const a=Number(t);return Number.isFinite(a)?a:0})}function de(e,t=380){const a=e?.closest(".chart-container")||e?.parentElement,s=a?getComputedStyle(a):null,o=s?Number.parseFloat(s.height):Number.NaN,r=s?Number.parseFloat(s.minHeight):Number.NaN,n=a?.getBoundingClientRect?.().height??Number.NaN,l=s?(Number.parseFloat(s.paddingTop)||0)+(Number.parseFloat(s.paddingBottom)||0):0,c=window.innerWidth<768?320:t,d=[o,n,r,c].find(m=>Number.isFinite(m)&&m>0)??c;return Math.max(260,Math.round(d-l))}const v={_currentEntries:null,destroy(){i.chart&&(Array.isArray(i.chart)?i.chart.forEach(e=>e?.destroy()):i.chart.destroy(),i.chart=null),v._drilldownChart&&(v._drilldownChart.destroy(),v._drilldownChart=null),i.activeDrilldown=null,i.reportDetails=null},setupDefaults(){const e=getComputedStyle(document.documentElement).getPropertyValue("--color-text").trim();window.Apex=window.Apex||{},window.Apex.chart={foreColor:e,fontFamily:"Inter, Arial, sans-serif"},window.Apex.grid={borderColor:"rgba(255, 255, 255, 0.1)"}},renderPie(e){const{labels:t=[],values:a=[],details:s=null,cat_ids:o=null}=e;if(!t.length||!a.some(y=>y>0))return M.UI.showEmptyState();let r=t.map((y,C)=>({label:y,value:Number(a[C])||0,color:u.CHART_COLORS[C%u.CHART_COLORS.length],catId:o?o[C]??null:null})).filter(y=>y.value>0).sort((y,C)=>C.value-y.value);!o&&s&&(r=r.map(y=>{const C=s.find(k=>k.label===y.label);return{...y,catId:C?.cat_id??null}}));const n=window.innerWidth<768;let l=r;if(n&&r.length>5){const y=r.slice(0,5),k=r.slice(5).reduce((V,j)=>V+j.value,0);l=[...y,{label:"Outros",value:k,color:"#95a5a6",isOthers:!0}]}const c=!n&&l.length>2,d=c?Math.ceil(l.length/2):l.length,m=c?[l.slice(0,d),l.slice(d)].filter(y=>y.length):[l],p=`
        ...
        `;M.UI.setContent(p),v.destroy(),i.reportDetails=s,i.activeDrilldown=null,v._currentEntries=l;const h=x.getActiveCategoryType(),A={receitas_por_categoria:"Receitas por Categoria",despesas_por_categoria:"Despesas por Categoria",receitas_anuais_por_categoria:"Receitas anuais por Categoria",despesas_anuais_por_categoria:"Despesas anuais por Categoria"}[h]||"Distribuição por Categoria",g=H();let T=0;i.chart=m.map((y,C)=>{const k=document.getElementById(`chart${C}`);if(!k)return null;const V=y.reduce((S,F)=>S+F.value,0),j=T;T+=y.length;const oe=new ApexCharts(k,{chart:{type:"donut",height:"100%",background:"transparent",fontFamily:"Inter, Arial, sans-serif",events:{dataPointSelection:(S,F,re)=>{const ne=j+re.dataPointIndex,K=l[ne];!K||K.isOthers||v.handlePieClick(K,ne,re.dataPointIndex,C)},dataPointMouseEnter:S=>{S.target&&(S.target.style.cursor="pointer")},dataPointMouseLeave:S=>{S.target&&(S.target.style.cursor="default")}}},series:y.map(S=>S.value),labels:y.map(S=>S.label),colors:y.map(S=>S.color),stroke:{width:2,colors:[g.surfaceColor]},plotOptions:{pie:{donut:{size:"60%"},expandOnClick:!0}},legend:{show:!n,position:"bottom",labels:{colors:g.textColor},markers:{shape:"circle"}},title:{text:m.length>1?`${A} - Parte ${C+1}`:A,align:"center",style:{fontSize:"14px",fontWeight:"bold",color:g.textColor}},tooltip:{theme:g.mode,y:{formatter:S=>{const F=V>0?(S/V*100).toFixed(1):"0";return`${_(S)} (${F}%)`}}},dataLabels:{enabled:!1},theme:{mode:g.mode}});return oe.render(),oe}),n&&v.renderMobileCategoryList(l)},renderMobileCategoryList(e){const t=document.getElementById("categoryListMobile");if(!t)return;const a=e.reduce((r,n)=>r+n.value,0),s=!!i.reportDetails&&window.IS_PRO,o=e.map((r,n)=>{const l=(r.value/a*100).toFixed(1),c=s&&r.catId!=null?i.reportDetails.find(h=>h.cat_id===r.catId):null,d=c&&c.subcategories&&c.subcategories.filter(h=>h.id!==0).length>0,m=d?'<i data-lucide="chevron-down" class="category-chevron"></i>':"";let p="";if(d){const h=x.generateShades(r.color,c.subcategories.length);p=`
                ...
                <div class="category-item ${d?"has-subcats":""}"
                    ...
                    <div class="category-info">
                        ...
                        <span class="category-value">${_(r.value)}</span>
                    </div>
        ...
        `;a.innerHTML=`
            <div class="drilldown-header" style="border-left-color: ${t}">
                <div class="drilldown-title">
                    ...
                    <h4>${U(s)}</h4>
                    <span class="drilldown-total">${_(o)}</span>
                </div>
        ...
        `,a.setAttribute("aria-hidden","false"),requestAnimationFrame(()=>{a.style.maxHeight=a.scrollHeight+"px"}),document.getElementById("drilldownCloseBtn")?.addEventListener("click",()=>{v.closeDrilldown()}),c||v._renderDrilldownMiniChart(r,n),window.lucide&&lucide.createIcons()},_renderDrilldownMiniChart(e,t){const a=document.getElementById("drilldownMiniChart");if(!a)return;v._drilldownChart&&(v._drilldownChart.destroy(),v._drilldownChart=null);const s=H(),o=e.reduce((r,n)=>r+n.total,0);v._drilldownChart=new ApexCharts(a,{chart:{type:"donut",height:"100%",background:"transparent",fontFamily:"Inter, Arial, sans-serif"},series:e.map(r=>r.total),labels:e.map(r=>r.label),colors:t,stroke:{width:2,colors:[s.surfaceColor]},plotOptions:{pie:{donut:{size:"55%"}}},legend:{show:!1},tooltip:{theme:s.mode,y:{formatter:r=>{const n=o>0?(r/o*100).toFixed(1):"0";return`${_(r)} (${n}%)`}}},dataLabels:{enabled:!1},theme:{mode:s.mode}}),v._drilldownChart.render()},_drilldownChart:null,renderLine(e){const{labels:t=[],values:a=[]}={...e,values:Q(e?.values)};if(!t.length)return M.UI.showEmptyState();M.UI.setContent(`
            <div class="chart-container chart-container-line">
                <div class="chart-wrapper chart-wrapper-line">
                    <div id="chart0"></div>
                </div>
            </div>
        `),v.destroy();const s=getComputedStyle(document.documentElement).getPropertyValue("--color-primary").trim(),o=H(),r=document.getElementById("chart0"),n=de(r,420),l=new ApexCharts(r,{chart:{type:"area",height:n,toolbar:{show:!1},background:"transparent",fontFamily:"Inter, Arial, sans-serif",parentHeightOffset:0,redrawOnParentResize:!0,redrawOnWindowResize:!0},series:[{name:"Saldo Diário",data:a.map(Number)}],xaxis:{categories:t,labels:{style:{fontSize:"11px"}},axisBorder:{show:!1},axisTicks:{show:!1}},yaxis:{labels:{style:{colors:o.isLight?"#000":"#fff",fontSize:"11px"},formatter:c=>_(c)}},colors:[s],stroke:{curve:"smooth",width:2.5},fill:{type:"gradient",gradient:{shadeIntensity:1,opacityFrom:.4,opacityTo:.05,stops:[0,100]}},markers:{size:4,hover:{size:6}},grid:{borderColor:o.gridColor,strokeDashArray:4},tooltip:{theme:o.mode,y:{formatter:c=>_(c)}},legend:{position:"bottom",labels:{colors:o.textColor}},title:{text:"Evolução do Saldo Mensal",align:"center",style:{fontSize:"16px",fontWeight:"bold",color:o.textColor}},dataLabels:{enabled:!1},theme:{mode:o.mode}});l.render(),i.chart=l},renderBar(e){const{labels:t=[],receitas:a=[],despesas:s=[]}={...e,receitas:Q(e?.receitas),despesas:Q(e?.despesas)};if(!t.length)return M.UI.showEmptyState();M.UI.setContent(`
            <div class="chart-container chart-container-bar">
                <div class="chart-wrapper chart-wrapper-bar">
                    <div id="chart0"></div>
                </div>
            </div>
        `),v.destroy();const o=x.getCssVar("--color-success","#2ecc71"),r=x.getCssVar("--color-danger","#e74c3c"),n=H(),l=document.getElementById("chart0"),c=de(l,420),d=i.currentView===u.VIEWS.ACCOUNTS?"Receitas x Despesas por Conta":i.currentView===u.VIEWS.ANNUAL_SUMMARY?"Resumo Anual por Mês":"Receitas x Despesas",m=new ApexCharts(l,{chart:{type:"bar",height:c,toolbar:{show:!1},background:"transparent",fontFamily:"Inter, Arial, sans-serif",parentHeightOffset:0,redrawOnParentResize:!0,redrawOnWindowResize:!0},series:[{name:"Receitas",data:a.map(Number)},{name:"Despesas",data:s.map(Number)}],xaxis:{categories:t,labels:{style:{colors:n.textMuted,fontSize:"11px"}},axisBorder:{show:!1},axisTicks:{show:!1}},yaxis:{labels:{style:{colors:n.isLight?"#000":"#fff",fontSize:"11px"},formatter:p=>_(p)}},colors:[o,r],plotOptions:{bar:{borderRadius:6,columnWidth:"55%"}},grid:{borderColor:n.gridColor,strokeDashArray:4,xaxis:{lines:{show:!1}}},tooltip:{theme:n.mode,shared:!0,intersect:!1,y:{formatter:p=>_(p)}},legend:{position:"bottom",labels:{colors:n.textColor},markers:{shape:"circle"}},title:{text:d,align:"center",style:{fontSize:"16px",fontWeight:"bold",color:n.textColor}},dataLabels:{enabled:!1},theme:{mode:n.mode}});m.render(),i.chart=m}};M.ChartManager=v;const He={toggleRelQuickStats:"relQuickStats",toggleRelOverviewCharts:"relOverviewChartsRow",toggleRelControls:"relControlsRow"},ve={toggleRelQuickStats:!0,toggleRelOverviewCharts:!0,toggleRelControls:!0},We={...ve,toggleRelQuickStats:!1,toggleRelControls:!1};async function Ye(){return Me("relatorios")}async function qe(e){await _e("relatorios",e)}const ze=$e({storageKey:"lk_relatorios_prefs",sectionMap:He,completeDefaults:ve,essentialDefaults:We,loadPreferences:Ye,savePreferences:qe,modal:{overlayId:"relatoriosCustomizeModalOverlay",openButtonId:"btnCustomizeRelatorios",closeButtonId:"btnCloseCustomizeRelatorios",saveButtonId:"btnSaveCustomizeRelatorios",presetEssentialButtonId:"btnPresetEssencialRelatorios",presetCompleteButtonId:"btnPresetCompletoRelatorios"}});function Ge(){ze.init()}const b=e=>x.formatCurrency(e);function W(e,t,a,s=!1){const o=document.getElementById(e);if(!o)return;if(!a||a===0){o.innerHTML="",o.className="stat-trend";return}const r=(t-a)/Math.abs(a)*100,n=Math.abs(r).toFixed(1);if(Math.abs(r)<.5)o.className="stat-trend trend-neutral",o.textContent="— Sem alteração";else{const l=r>0,c=s?!l:l;o.className=`stat-trend ${c?"trend-positive":"trend-negative"}`;const d=l?"↑":"↓";o.textContent=`${d} ${n}% vs mês anterior`}}function je(e){const t=document.querySelector(".chart-insight-line");if(t&&t.remove(),!e)return;let a="";switch(i.currentView){case u.VIEWS.CATEGORY:case u.VIEWS.ANNUAL_CATEGORY:{if(!e.labels||!e.values||e.values.length===0)break;const n=e.values.reduce((l,c)=>l+Number(c),0);if(n>0){const l=e.values.reduce((d,m,p,h)=>Number(m)>Number(h[d])?p:d,0),c=(Number(e.values[l])/n*100).toFixed(0);a=`${e.labels[l]} lidera com ${c}% dos gastos (${b(e.values[l])})`}break}case u.VIEWS.BALANCE:{if(!e.labels||!e.values||e.values.length===0)break;const n=e.values.map(Number),l=Math.min(...n),c=n.indexOf(l);a=`Menor saldo: ${b(l)} em ${e.labels[c]}`;break}case u.VIEWS.COMPARISON:{if(!e.receitas||!e.despesas)break;const n=e.receitas.map(Number),l=e.despesas.map(Number);a=`Em ${n.filter((d,m)=>d>(l[m]||0)).length} de ${n.length} dias, receitas superaram despesas`;break}case u.VIEWS.ACCOUNTS:{if(!e.labels||!e.despesas||e.despesas.length===0)break;const n=e.despesas.map(Number),l=n.reduce((c,d,m,p)=>d>p[c]?m:c,0);a=`Maior gasto: ${e.labels[l]} com ${b(n[l])} em despesas`;break}case u.VIEWS.EVOLUTION:{if(!e.values||e.values.length<2)break;const n=e.values.map(Number),l=n[0],c=n[n.length-1];a=`Evolução nos últimos 12 meses: ${c>l?"tendência de alta":c<l?"tendência de queda":"estável"}`;break}case u.VIEWS.ANNUAL_SUMMARY:{if(!e.labels||!e.receitas||e.receitas.length===0)break;const n=e.receitas.map(Number),l=e.despesas.map(Number),c=n.map((p,h)=>p-(l[h]||0)),d=c.reduce((p,h,w,A)=>h>A[p]?w:p,0),m=c.reduce((p,h,w,A)=>h<A[p]?w:p,0);a=`Melhor mês: ${e.labels[d]}. Pior mês: ${e.labels[m]}`;break}}if(!a)return;const o=document.getElementById("reportArea");if(!o)return;const r=document.createElement("div");r.className="chart-insight-line",r.innerHTML=`<i data-lucide="sparkles"></i> <span>${f(a)}</span>`,o.appendChild(r),window.lucide&&lucide.createIcons()}function Ke(e){return!e||e.length===0?"":`
    ...
    `}let B=null;function Ze(e){if(!e||e.length===0)return;const t=document.getElementById("evolucaoMiniChart");if(!t)return;const a=e.map(l=>l.label),o=getComputedStyle(document.documentElement).getPropertyValue("--color-text-muted").trim()||"#999",n=document.documentElement.getAttribute("data-theme")==="dark"?"dark":"light";B&&(B.destroy(),B=null),B=new ApexCharts(t,{chart:{type:"line",height:260,stacked:!1,toolbar:{show:!1},background:"transparent",fontFamily:"Inter, Arial, sans-serif"},series:[{name:"Receitas",type:"column",data:e.map(l=>l.receitas)},{name:"Despesas",type:"column",data:e.map(l=>l.despesas)},{name:"Saldo",type:"area",data:e.map(l=>l.saldo)}],xaxis:{categories:a,labels:{style:{colors:o}},axisBorder:{show:!1},axisTicks:{show:!1}},yaxis:{labels:{style:{colors:o},formatter:l=>b(l)}},colors:["rgba(46, 204, 113, 0.85)","rgba(231, 76, 60, 0.85)","#3498db"],stroke:{width:[0,0,2.5],curve:"smooth"},fill:{opacity:[.85,.85,.1]},plotOptions:{bar:{borderRadius:6,columnWidth:"55%"}},grid:{borderColor:"rgba(128,128,128,0.1)",strokeDashArray:4,xaxis:{lines:{show:!1}}},tooltip:{theme:n,shared:!0,intersect:!1,y:{formatter:l=>b(l)}},legend:{position:"bottom",labels:{colors:o},markers:{shape:"circle"}},dataLabels:{enabled:!1},theme:{mode:n}}),B.render()}function Je(e){if(!e)return"";const t=e.variacao>0?"trend-negative":e.variacao<0?"trend-positive":"trend-neutral",a=e.variacao>0?"arrow-up":e.variacao<0?"arrow-down":"equal";return`
    ...
    `}function et(e){if(!e||e.length===0)return"";const t={Pix:"zap","Cartão de Crédito":"credit-card","Cartão de Débito":"credit-card",Dinheiro:"banknote",Boleto:"file-text",Depósito:"landmark",Transferência:"arrow-right-left",Estorno:"undo-2"},a=e.reduce((o,r)=>o+r.atual,0);return`
        <div class="comparative-card comp-full-width surface-card surface-card--interactive">
            <div class="comparative-header">
            ...
            <div class="forma-comp-row" style="animation-delay: ${r*.06}s">
                ...
                <div class="forma-comp-info">
                    <span class="forma-comp-name">${f(o.nome)}</span>
                    <div class="forma-comp-bar-bg">
                        <div class="forma-comp-bar" style="width: ${n}%"></div>
                    </div>
                </div>
                <div class="forma-comp-values">
                    <span class="forma-comp-current">${b(o.atual)} <small>(${o.atual_qtd}x)</small></span>
                    <span class="forma-comp-prev">${b(o.anterior)} <small>(${o.anterior_qtd}x)</small></span>
                </div>
            </div>
        `}).join("")}
            </div>
        </div>
    `}function ue(e,t,a){const s=c=>c>0?'<i data-lucide="arrow-up"></i>':c<0?'<i data-lucide="arrow-down"></i>':'<i data-lucide="equal"></i>',o=(c,d=!1)=>{if(d){if(c>0)return"trend-negative";if(c<0)return"trend-positive"}else{if(c>0)return"trend-positive";if(c<0)return"trend-negative"}return"trend-neutral"},r=c=>Math.abs(c)<.1?"Sem alteração":c>0?`Aumentou ${Math.abs(c).toFixed(1)}%`:c<0?`Reduziu ${Math.abs(c).toFixed(1)}%`:"Sem alteração",n=()=>{if(a.includes("mês")){const[c,d]=i.currentMonth.split("-");return new Date(c,d-1).toLocaleDateString("pt-BR",{month:"short",year:"numeric"})}else return i.currentMonth.split("-")[0]},l=()=>{if(a.includes("mês")){const[c,d]=i.currentMonth.split("-");return new Date(c,d-2).toLocaleDateString("pt-BR",{month:"short",year:"numeric"})}else return(parseInt(i.currentMonth.split("-")[0])-1).toString()};return`
            ...
            <div class="comparative-grid-new">
                <div class="comparative-item-new">
                    ...
                    <div class="item-trend ${o(t.variation.receitas,!1)}">
                        ...
                        <span>${r(t.variation.receitas)}</span>
                    </div>
                </div>
                ...
                <div class="comparative-item-new">
                    ...
                    <div class="item-trend ${o(t.variation.despesas,!0)}">
                        ...
                        <span>${r(t.variation.despesas)}</span>
                    </div>
                </div>
    ...
    `:"";t.innerHTML=`
        <div class="cards-report-container">
            ...
            <div class="cards-grid">
                ${e.cards&&e.cards.length>0?e.cards.map(s=>{const o=Ue(s.cor,"#E67E22");return`
                            ...
                            <div class="card-quick-info">
                                ...
                                ${s.proximos_meses&&s.proximos_meses.length>0&&s.proximos_meses.some(r=>r.valor>0)?`
                                    <div class="quick-info-item">
                                        ...
                                        <span>Próximo: ${b(s.proximos_meses.find(r=>r.valor>0)?.valor||0)}</span>
                                    </div>
                                `:""}
                            </div>
                        `:""}
    ...
    `,window.lucide&&lucide.createIcons()}const I=e=>x.formatCurrency(e),fe={"arrow-trend-up":"trending-up","arrow-trend-down":"trending-down","arrow-up":"arrow-up","arrow-down":"arrow-down","chart-line":"line-chart","chart-pie":"pie-chart","exclamation-triangle":"triangle-alert","exclamation-circle":"circle-alert","check-circle":"circle-check","info-circle":"info",lightbulb:"lightbulb",star:"star",bolt:"zap",wallet:"wallet","credit-card":"credit-card","calendar-check":"calendar-check",calendar:"calendar",crown:"crown",trophy:"trophy",leaf:"leaf","shield-alt":"shield","money-bill-wave":"banknote","trending-up":"trending-up","trending-down":"trending-down","shield-alert":"shield-alert",gauge:"gauge",target:"target",clock:"clock",receipt:"receipt",calculator:"calculator",layers:"layers","calendar-clock":"calendar-clock","pie-chart":"pie-chart","calendar-range":"calendar-range","list-plus":"list-plus","list-minus":"list-minus","file-text":"file-text","piggy-bank":"piggy-bank",banknote:"banknote"};let z=[];function at(){z.forEach(e=>{try{e.destroy()}catch{}}),z=[]}function st(e,t){if(!e)return;const a=t.saldo||0,s=a>=0?"var(--color-success)":"var(--color-danger)",o=a>=0?"positivo":"negativo";let r=`
        <p class="pulse-text">
            Neste mês você recebeu <strong>${I(t.totalReceitas)}</strong>
            e gastou <strong>${I(t.totalDespesas)}</strong>.
            Seu saldo é <strong style="color:${s}">${o} em ${I(Math.abs(a))}</strong>.
    `;t.totalCartoes>0&&(r+=` Faturas de cartões somam <strong>${I(t.totalCartoes)}</strong>.`),r+="</p>",e.innerHTML=r}function ot(e,t){if(e){if(t?.insights?.length>0){e.innerHTML=t.insights.map(a=>{const s=fe[a.icon]||a.icon;return`
                ...
                </div>`}).join("");return}e.innerHTML='<p class="empty-message">Nenhum insight disponível no momento</p>'}}function rt(e,t){if(!e)return;if(!t?.labels?.length){e.innerHTML='<p class="empty-message" style="padding:var(--spacing-6)">Sem dados de categorias</p>';return}e.innerHTML="";const a=5,s=t.labels.slice(0,a),o=t.values.slice(0,a).map(Number);if(t.labels.length>a){const n=t.values.slice(a).reduce((l,c)=>l+Number(c),0);s.push("Outros"),o.push(n)}const r=new ApexCharts(e,{chart:{type:"donut",height:220,background:"transparent"},series:o,labels:s,colors:["#E67E22","#2C3E50","#2ECC71","#F39C12","#9B59B6","#1ABC9C"],legend:{position:"bottom",fontSize:"11px",labels:{colors:"var(--color-text-muted)"}},dataLabels:{enabled:!1},plotOptions:{pie:{donut:{size:"60%"}}},stroke:{show:!1},tooltip:{y:{formatter:n=>I(n)}}});r.render(),z.push(r)}function nt(e,t){if(!e)return;if(!t?.labels?.length){e.innerHTML='<p class="empty-message" style="padding:var(--spacing-6)">Sem dados de movimentação</p>';return}e.innerHTML="";const a=(t.receitas||[]).map(Number),s=(t.despesas||[]).map(Number),o=[],r=[],n=[],l=7;for(let d=0;d<t.labels.length;d+=l){const m=Math.floor(d/l)+1;o.push(`Sem ${m}`),r.push(a.slice(d,d+l).reduce((p,h)=>p+h,0)),n.push(s.slice(d,d+l).reduce((p,h)=>p+h,0))}const c=new ApexCharts(e,{chart:{type:"bar",height:220,background:"transparent",toolbar:{show:!1}},series:[{name:"Receitas",data:r},{name:"Despesas",data:n}],colors:["#2ECC71","#E74C3C"],xaxis:{categories:o,labels:{style:{colors:"var(--color-text-muted)",fontSize:"11px"}},axisBorder:{show:!1},axisTicks:{show:!1}},yaxis:{labels:{style:{fontSize:"10px"},formatter:d=>I(d)}},plotOptions:{bar:{columnWidth:"60%",borderRadius:4}},dataLabels:{enabled:!1},legend:{position:"bottom",fontSize:"11px",labels:{colors:"var(--color-text-muted)"}},grid:{borderColor:"rgba(255,255,255,0.05)"},tooltip:{shared:!0,intersect:!1,y:{formatter:d=>I(d)}}});c.render(),z.push(c)}function it({API:e}){async function t(){const r=document.getElementById("overviewPulse"),n=document.getElementById("overviewInsights"),l=document.getElementById("overviewCategoryChart"),c=document.getElementById("overviewComparisonChart");at();const[d,m,p,h]=await Promise.all([e.fetchSummaryStats(),e.fetchInsightsTeaser(),e.fetchReportDataForType("despesas_por_categoria",{accountId:null}),e.fetchReportDataForType("receitas_despesas_diario",{accountId:null})]);st(r,d),ot(n,m),rt(l,p),nt(c,h),window.lucide&&lucide.createIcons()}async function a(){const r=document.getElementById("insightsContainer");if(!r)return;const n=window.IS_PRO?await e.fetchInsights():await e.fetchInsightsTeaser();if(!n||!n.insights||n.insights.length===0){r.innerHTML='<p class="empty-message">Nenhum insight disponível no momento</p>';return}const l=n.insights.map(c=>{const d=fe[c.icon]||c.icon;return`
