import{h as ee,b as te,g as ae,c as A,d as S,e as y}from"./api-DpYnTMaG.js";import{b as re,r as oe,a as se}from"./finance-CgaDv1sH.js";import{r as ne,a as ie,b as z,c as le,d as q,e as ce,f as V}from"./faturas-osFPSmt_.js";import{r as x}from"./ui-H2yoVZe7.js";import{c as de,p as ue,f as me}from"./ui-preferences-CUuIZRMg.js";function pe(e){return{house:"#f97316",utensils:"#ef4444",car:"#3b82f6",lightbulb:"#eab308","heart-pulse":"#ef4444","graduation-cap":"#6366f1",shirt:"#ec4899",clapperboard:"#a855f7","credit-card":"#0ea5e9",smartphone:"#6366f1","shopping-cart":"#f97316",coins:"#eab308",briefcase:"#3b82f6",laptop:"#06b6d4","trending-up":"#22c55e",gift:"#ec4899",banknote:"#22c55e",trophy:"#f59e0b",wallet:"#14b8a6",tag:"#94a3b8","pie-chart":"#8b5cf6","piggy-bank":"#ec4899",plane:"#0ea5e9","gamepad-2":"#a855f7",baby:"#f472b6",dog:"#92400e",wrench:"#64748b",church:"#6366f1",dumbbell:"#ef4444",music:"#a855f7","book-open":"#3b82f6",scissors:"#ec4899","building-2":"#64748b",landmark:"#3b82f6",receipt:"#14b8a6"}[e]||"#f97316"}const w={BASE_URL:ee(),ENDPOINTS:{parcelamentos:ne(),categorias:se(),contas:oe(),cartoes:re()},TIMEOUTS:{alert:5e3,successMessage:2e3}},s={};function U(e){const t=document.getElementById(e);return t?(window.LK?.modalSystem?.prepareBootstrapModal(t,{scope:"page"}),t):null}function fe(){s.loadingEl=document.getElementById("loadingParcelamentos"),s.containerEl=document.getElementById("parcelamentosContainer"),s.emptyStateEl=document.getElementById("emptyState"),s.detailPageEl=document.getElementById("faturaDetalhePage"),s.detailPageShell=document.getElementById("faturaDetalheShell"),s.detailPageLoading=document.getElementById("faturaDetalheLoading"),s.detailPageContent=document.getElementById("faturaDetalheContent"),s.detailPageTitle=document.getElementById("faturaDetalheTitle"),s.detailPageSubtitle=document.getElementById("faturaDetalheSubtitle"),s.filtroStatus=document.getElementById("filtroStatus"),s.filtroCartao=document.getElementById("filtroCartao"),s.filtroAno=document.getElementById("filtroAno"),s.filtroMes=document.getElementById("filtroMes"),s.btnFiltrar=document.getElementById("btnFiltrar"),s.btnLimparFiltros=document.getElementById("btnLimparFiltros"),s.filtersContainer=document.querySelector(".filters-modern"),s.filtersBody=document.getElementById("filtersBody"),s.toggleFilters=document.getElementById("toggleFilters"),s.activeFilters=document.getElementById("activeFilters"),s.filtersSummary=document.getElementById("faturasFiltersSummary"),s.resultsSummary=document.getElementById("faturasResultsSummary"),s.contextSummary=document.getElementById("faturasContextSummary"),s.modalPagarFatura=U("modalPagarFatura"),s.modalEditarItemFatura=U("modalEditarItemFatura")}const i={parcelamentos:[],cartoes:[],faturaAtual:null,currentDetailId:null,sortColumn:"data_compra",sortDirection:"asc",filtros:{status:"",cartao_id:"",ano:new Date().getFullYear(),mes:""},anosCarregados:!1},p={},d={formatMoney(e){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(e||0)},formatDate(e){return e?new Date(e+"T00:00:00").toLocaleDateString("pt-BR"):""},parseMoney(e){return e&&parseFloat(e.replace(/[^\d,]/g,"").replace(",","."))||0},showAlert(e,t,a="danger"){e&&(e.className=`alert alert-${a}`,e.textContent=t,e.style.display="block",setTimeout(()=>{e.style.display="none"},w.TIMEOUTS.alert))},getCSRFToken(){return ae()},escapeHtml(e){if(!e)return"";const t=document.createElement("div");return t.textContent=e,t.innerHTML},buildUrl(e,t={}){const a=e.startsWith("http")?e:w.BASE_URL+e.replace(/^\//,""),r=Object.entries(t).filter(([o,n])=>n!=null&&n!=="").map(([o,n])=>`${o}=${encodeURIComponent(n)}`);return r.length>0?`${a}?${r.join("&")}`:a},async apiRequest(e,t={}){const a=e.startsWith("http")?e:w.BASE_URL+e.replace(/^\//,"");try{return await te(a,{...t,headers:{"X-CSRF-Token":this.getCSRFToken(),...t.headers}})}catch(r){throw console.error("Erro na requisição:",r),r}},debounce(e,t){let a;return function(...o){const n=()=>{clearTimeout(a),e(...o)};clearTimeout(a),a=setTimeout(n,t)}},calcularDiferencaDias(e,t){const a=new Date(e+"T00:00:00"),r=new Date(t+"T00:00:00");return Math.floor((a-r)/(1e3*60*60*24))}},ge={async listarParcelamentos(e={}){const t={status:e.status,cartao_id:e.cartao_id,ano:e.ano,mes:e.mes},a=d.buildUrl(w.ENDPOINTS.parcelamentos,t);return await d.apiRequest(a)},async listarCartoes(){return await d.apiRequest(w.ENDPOINTS.cartoes)},async buscarParcelamento(e){const t=parseInt(e,10);if(isNaN(t))throw new Error("ID inválido");return await d.apiRequest(V(t))},async criarParcelamento(e){return await d.apiRequest(w.ENDPOINTS.parcelamentos,{method:"POST",body:JSON.stringify(e)})},async cancelarParcelamento(e){return await d.apiRequest(V(e),{method:"DELETE"})},async toggleItemFatura(e,t,a){return await d.apiRequest(ce(e,t),{method:"POST",body:JSON.stringify({pago:a})})},async atualizarItemFatura(e,t,a){return await d.apiRequest(q(e,t),{method:"PUT",body:JSON.stringify(a)})},async excluirItemFatura(e,t){return await d.apiRequest(q(e,t),{method:"DELETE"})},async excluirParcelamentoDoItem(e,t){return await d.apiRequest(le(e,t),{method:"DELETE"})},async pagarFaturaCompleta(e,t,a,r=null){const o={mes:t,ano:a};return r&&(o.conta_id=r),await d.apiRequest(z(e),{method:"POST",body:JSON.stringify(o)})},async pagarFaturaParcial(e,t,a,r,o){return await d.apiRequest(z(e),{method:"POST",body:JSON.stringify({mes:t,ano:a,conta_id:r,valor_parcial:o})})},async desfazerPagamentoFatura(e,t,a){return await d.apiRequest(ie(e),{method:"POST",body:JSON.stringify({mes:t,ano:a})})},async listarContas(){return await d.apiRequest(`${w.ENDPOINTS.contas}?with_balances=1`)}};p.API=ge;const H=(e,t=0,a=100)=>Math.min(a,Math.max(t,Number(e)||0)),v=(e,t="")=>d.escapeHtml(String(e??t)),he=(e,t=0)=>`${(Number(e)||0).toLocaleString("pt-BR",{minimumFractionDigits:t,maximumFractionDigits:t})}%`,_=(e,t)=>`data-lk-tooltip-title="${v(e)}" data-lk-tooltip="${v(t)}"`,j=/(#[0-9a-fA-F]{3,8}|rgba?\([^)]+\)|hsla?\([^)]+\))/,P={vencida:0,proxima:1,parcial:2,pendente:3,paga:4,cancelado:5,indefinido:6},ve={renderParcelamentos(e){if(!Array.isArray(e)||e.length===0){this.showEmpty();return}s.emptyStateEl.style.display="none",s.containerEl.style.display="grid";const t=this.sortParcelamentosByRelevance(e),a=document.createDocumentFragment();t.forEach(r=>{const o=this.createParcelamentoCard(r);a.appendChild(o)}),s.containerEl.innerHTML="",s.containerEl.appendChild(a),x()},createParcelamentoCard(e){const t=e.progresso||0,a=e.parcelas_pendentes||0,r=e.parcelas_pagas||0,o=r+a,n=this.getReferenceMeta(e),l=this.getDueMeta(e),c=this.getStatusMeta(e.status,t,l),u=n.isPastReference&&c.badgeClass==="badge-paga",m=document.createElement("div");m.className=`parcelamento-card surface-card surface-card--interactive surface-card--clip status-${e.status}`,m.dataset.id=e.id,m.style.setProperty("--fatura-accent",this.getAccentColorSolid(e.cartao)),n.isCurrentMonth&&m.classList.add("is-current-focus"),n.isPastReference&&m.classList.add("is-reference-past"),u&&m.classList.add("is-historical-paid");const f=this.getStatusBadge(e.status,t,l),h=e.mes_referencia||"",b=e.ano_referencia||"";return m.innerHTML=this.createCardHTML({parc:e,statusBadge:f,mes:h,ano:b,itensPendentes:a,itensPagos:r,totalItens:o,progresso:t,referenceMeta:n,dueMeta:l,statusMeta:c}),m},getReferenceMeta(e){let t=Number.parseInt(String(e?.mes_referencia??""),10),a=Number.parseInt(String(e?.ano_referencia??""),10);if(!Number.isInteger(t)||t<1||t>12||!Number.isInteger(a)||a<1900){const m=String(e?.descricao??"").match(/(\d{1,2})\/(\d{4})/);m&&(t=Number.parseInt(m[1],10),a=Number.parseInt(m[2],10))}if((!Number.isInteger(t)||t<1||t>12||!Number.isInteger(a)||a<1900)&&e?.data_vencimento){const u=new Date(`${e.data_vencimento}T00:00:00`);Number.isNaN(u.getTime())||(t=u.getMonth()+1,a=u.getFullYear())}const r=Number.isInteger(t)&&t>=1&&t<=12&&Number.isInteger(a)&&a>=1900,o=new Date,n=o.getMonth()+1,l=o.getFullYear(),c=r?(a-l)*12+(t-n):Number.MAX_SAFE_INTEGER;return{month:t,year:a,hasReference:r,monthOffset:c,isCurrentMonth:r&&c===0,isFutureReference:r&&c>0,isPastReference:r&&c<0}},getStatusSortRank(e,t){return e.status==="cancelado"?P.cancelado:t?.isVencida?P.vencida:t?.isProxima?P.proxima:(Number(e.progresso)||0)>=100||e.status==="paga"||e.status==="concluido"?P.paga:(Number(e.progresso)||0)>0||e.status==="parcial"?P.parcial:e.status==="pendente"?P.pendente:P.indefinido},getRelevanceBucket(e){return e.isCurrentMonth?0:e.isFutureReference?1:e.isPastReference?2:3},compareDueDates(e,t){return!e&&!t?0:e?t?e.localeCompare(t):-1:1},sortParcelamentosByRelevance(e){return[...e].sort((t,a)=>{const r=this.getReferenceMeta(t),o=this.getReferenceMeta(a),n=this.getRelevanceBucket(r),l=this.getRelevanceBucket(o);if(n!==l)return n-l;if(r.monthOffset!==o.monthOffset)return n===2?o.monthOffset-r.monthOffset:r.monthOffset-o.monthOffset;const c=this.getDueMeta(t),u=this.getDueMeta(a),m=this.getStatusSortRank(t,c),f=this.getStatusSortRank(a,u);if(m!==f)return m-f;const h=this.compareDueDates(t.data_vencimento,a.data_vencimento);if(h!==0)return h;const b=(Number(a.valor_total)||0)-(Number(t.valor_total)||0);if(b!==0)return b;const E=String(t.cartao?.nome||t.cartao?.nome_cartao||t.cartao?.bandeira||""),$=String(a.cartao?.nome||a.cartao?.nome_cartao||a.cartao?.bandeira||"");return E.localeCompare($,"pt-BR")})},attachCardEventListeners(){},getAccentColorSolid(e){const a={visa:"#1A1F71",mastercard:"#EB001B",elo:"#FFCB05",amex:"#006FCF",diners:"#0079BE",discover:"#FF6000",hipercard:"#B11116"}[e?.bandeira?.toLowerCase()]||"#3b82f6",r=String(e?.cor_cartao||e?.conta?.instituicao_financeira?.cor_primaria||a).trim();return r?/gradient/i.test(r)?r.match(j)?.[1]||a:/^var\(/i.test(r)||j.test(r)?r:a:a},getBandeiraIcon(e){return{visa:'<svg viewBox="0 0 48 32" width="32" height="22" fill="none"><rect width="48" height="32" rx="4" fill="#1A1F71"/><text x="24" y="20" text-anchor="middle" font-size="12" font-weight="bold" fill="#fff" font-family="sans-serif">VISA</text></svg>',mastercard:'<svg viewBox="0 0 48 32" width="32" height="22" fill="none"><rect width="48" height="32" rx="4" fill="#1A1F71" opacity="0"/><circle cx="19" cy="16" r="10" fill="#EB001B" opacity=".85"/><circle cx="29" cy="16" r="10" fill="#F79E1B" opacity=".85"/></svg>',elo:'<svg viewBox="0 0 48 32" width="32" height="22" fill="none"><rect width="48" height="32" rx="4" fill="#000"/><text x="24" y="20" text-anchor="middle" font-size="13" font-weight="bold" fill="#FFCB05" font-family="sans-serif">elo</text></svg>',amex:'<svg viewBox="0 0 48 32" width="32" height="22" fill="none"><rect width="48" height="32" rx="4" fill="#006FCF"/><text x="24" y="20" text-anchor="middle" font-size="9" font-weight="bold" fill="#fff" font-family="sans-serif">AMEX</text></svg>',hipercard:'<svg viewBox="0 0 48 32" width="32" height="22" fill="none"><rect width="48" height="32" rx="4" fill="#B11116"/><text x="24" y="20" text-anchor="middle" font-size="8" font-weight="bold" fill="#fff" font-family="sans-serif">HIPER</text></svg>',diners:'<svg viewBox="0 0 48 32" width="32" height="22" fill="none"><rect width="48" height="32" rx="4" fill="#0079BE"/><text x="24" y="20" text-anchor="middle" font-size="8" font-weight="bold" fill="#fff" font-family="sans-serif">DINERS</text></svg>'}[e]||'<i data-lucide="credit-card"></i>'},getDueMeta(e){let t=e.data_vencimento;if(!t&&e.cartao?.dia_vencimento&&e.descricao){const u=e.descricao.match(/(\d{1,2})\/(\d{4})/);if(u){const m=u[1].padStart(2,"0"),f=u[2],h=String(e.cartao.dia_vencimento).padStart(2,"0");t=`${f}-${m}-${h}`}}if(!t)return{hasDate:!1,label:"A definir",helper:"Sem data de vencimento informada",detailClass:"",isVencida:!1,isProxima:!1};const a=d.formatDate(t),r=new Date;r.setHours(0,0,0,0);const o=new Date(`${t}T00:00:00`),n=e.status!=="paga"&&e.status!=="concluido"&&e.status!=="cancelado",l=n&&o<r,c=n&&!l&&o-r<=4320*60*1e3;return{hasDate:!0,raw:t,label:a,helper:l?"Vencimento expirado":c?"Vence em breve":"Dentro do prazo",detailClass:l?"is-danger":c?"is-warning":"",isVencida:l,isProxima:c}},getStatusMeta(e,t=null,a=null){const r=H(t);return e==="cancelado"?{badgeClass:"badge-cancelado",progressClass:"is-muted",icon:"ban",label:"Cancelada",shortLabel:"Cancelada",hint:"Sem cobranca ativa",tooltip:"Esta fatura foi cancelada e nao entra mais no acompanhamento ativo."}:r>=100||e==="paga"||e==="concluido"?{badgeClass:"badge-paga",progressClass:"is-safe",icon:"circle-check",label:"Paga",shortLabel:"Liquidada",hint:"Pagamento concluido",tooltip:"O valor desta fatura ja foi quitado integralmente."}:a?.isVencida?{badgeClass:"badge-alerta",progressClass:"is-danger",icon:"triangle-alert",label:"Vencida",shortLabel:"Em atraso",hint:"Regularize esta fatura",tooltip:"A fatura passou do vencimento e merece prioridade para evitar juros."}:a?.isProxima?{badgeClass:"badge-alerta",progressClass:"is-warning",icon:"clock-3",label:"Vence em breve",shortLabel:"Vence logo",hint:"Priorize o pagamento",tooltip:"O vencimento esta proximo. Vale organizar o pagamento desta fatura."}:r>0?{badgeClass:"badge-parcial",progressClass:"is-warning",icon:"loader-2",label:"Pagamento parcial",shortLabel:"Parcial",hint:"Parte do valor ja foi paga",tooltip:"A fatura segue aberta, mas ja possui pagamentos registrados."}:{badgeClass:"badge-pendente",progressClass:"is-safe",icon:"clock-3",label:"Pendente",shortLabel:"No prazo",hint:"Aguardando pagamento",tooltip:"A fatura segue aberta e ainda esta dentro do prazo normal de pagamento."}},getResumoPrincipal(e,t,a,r,o,n){const l=e.total_estornos&&e.total_estornos>0,c=n>0?`${o}/${n} itens pagos`:"Sem itens consolidados",u=t.hasDate&&t.helper!=="Dentro do prazo"?`<span class="fatura-card-due-tag ${t.detailClass}">${v(t.helper)}</span>`:"";return`
            ...
            <div class="fatura-card-details">
                <div class="fatura-card-detail ${t.detailClass}" ${_("Vencimento",t.hasDate?`Data prevista para pagamento desta fatura: ${t.label}.`:"A fatura ainda nao possui data de vencimento consolidada.")}>
                ...
                <div class="fatura-card-detail ${a.progressClass}" ${_("Progresso de pagamento",n>0?`${o} de ${n} itens ja foram pagos nesta fatura.`:"Ainda nao existem itens suficientes para calcular o progresso de pagamento.")}>
        ...
        `},getProgressoSection(e,t,a,r,o){const n=H(r),l=n>0?Math.max(n,8):0;return e===0?`
            ...
            <div class="parc-progress-section ${o.progressClass}">
                <div class="parc-progress-header">
                    <span class="parc-progress-text">Pago ${he(n)}</span>
        ...
        `},createCardHTML({parc:e,statusBadge:t,mes:a,ano:r,itensPendentes:o,itensPagos:n,totalItens:l,progresso:c,referenceMeta:u,dueMeta:m,statusMeta:f}){const h=this.getResumoPrincipal(e,m,f,o,n,l),b=this.getProgressoSection(l,o,n,c,f),E=Number.parseInt(String(e.cartao?.id??e.cartao_id??0),10)||0,$=A("importacoes",{import_target:"cartao",...E>0?{cartao_id:E}:{}}),C=e.cartao&&(e.cartao.nome||e.cartao.bandeira)||"Cartao",g=e.cartao?.conta?.instituicao_financeira?.nome||"Sem instituicao",I=e.cartao?.ultimos_digitos?`Final ${e.cartao.ultimos_digitos}`:"",T=this.getAccentColorSolid(e.cartao),D=e.cartao?.bandeira?.toLowerCase()||"outros",L=this.getBandeiraIcon(D),N=u.hasReference?`${String(u.month).padStart(2,"0")}/${u.year}`:a&&r?`${a}/${r}`:"Fatura atual",G=u.isCurrentMonth?`Mes atual · ${N}`:N,W=u.isCurrentMonth?"fatura-card-period is-current":"fatura-card-period",X=u.isCurrentMonth?'<span class="fatura-list-kicker fatura-list-kicker--current">Fatura do mes</span>':u.isPastReference&&f.badgeClass==="badge-paga"?'<span class="fatura-list-kicker fatura-list-kicker--history">Historico pago</span>':"",Q=[v(g),I?v(I):""].filter(Boolean).join(" - "),Z=A(`faturas/${e.id}`);return`
            <div class="fatura-card-shell" style="--fatura-accent:${T};">
                <div class="fatura-card-top">
                    ...
                    <div class="fatura-card-head">
                        <div class="fatura-card-title-wrap">
                            <span class="fatura-card-title">${v(C)}</span>
                            <span class="fatura-card-subtitle">${v(g)}</span>
                        </div>
                        <div class="fatura-card-meta">
                            <span class="${W}" ${_("Periodo da fatura","Competencia consolidada desta fatura para acompanhar fechamento e vencimento.")}>
                ...
                <div class="fatura-list-info">
                    ${X}
                    <span class="list-cartao-nome">${v(C)}</span>
                    <span class="list-periodo">${v(N)}</span>
                    <span class="list-cartao-numero">${Q}</span>
                </div>
        ...
        `}},be={getDetalhesTarget(){return s.detailPageContent||null},isDetailPageMode(){return!!(s.detailPageEl&&s.detailPageContent)},setDetailPageLoading(e){this.isDetailPageMode()&&(s.detailPageLoading&&(s.detailPageLoading.hidden=!e,s.detailPageLoading.style.display=e?"flex":"none"),s.detailPageContent&&(s.detailPageContent.hidden=e))},updateDetailPageMeta(e){if(!this.isDetailPageMode())return;const t=e.cartao?.nome||e.cartao?.bandeira||"Cartao",a=e.mes_referencia&&e.ano_referencia?`${this.getNomeMesCompleto(e.mes_referencia)} de ${e.ano_referencia}`:e.descricao||`Fatura #${e.id}`,r=e.data_vencimento?d.formatDate(e.data_vencimento):"a definir",o=String(e.status||"pendente").replace(/_/g," ").replace(/\b\w/g,n=>n.toUpperCase());if(s.detailPageTitle&&(s.detailPageTitle.textContent=`${t} - ${a}`),s.detailPageSubtitle&&(s.detailPageSubtitle.textContent=`Vencimento ${r} - Status ${o}.`),s.detailPageShell){const n=this.getAccentColorSolid(e.cartao);s.detailPageShell.style.setProperty("--card-accent",n)}document.title=`${t} - ${a} | Lukrato`},renderDetailPageState({title:e="Fatura indisponivel",message:t="Nao foi possivel carregar os detalhes desta fatura."}={}){if(!this.isDetailPageMode())return;const a=this.getDetalhesTarget();a&&(this.setDetailPageLoading(!1),s.detailPageTitle&&(s.detailPageTitle.textContent=e),s.detailPageSubtitle&&(s.detailPageSubtitle.textContent=t),a.innerHTML=`
            <div class="fat-detail-empty">
                ...
                <p>${d.escapeHtml(t)}</p>
                <a class="btn btn-primary" href="${d.escapeHtml(A("faturas"))}" data-no-transition="true">
                    Voltar para faturas
                </a>
            </div>
        `,x())},async showDetalhes(e){const t=this.getDetalhesTarget();if(!t){window.location.href=A(`faturas/${e}`);return}this.setDetailPageLoading(!0);try{const a=await p.API.buscarParcelamento(e),r=S(a,null);if(!r){this.renderDetailPageState({title:"Fatura indisponivel",message:"Esta fatura nao esta mais disponivel para consulta."});return}i.faturaAtual=r,i.currentDetailId=r.id,t.innerHTML=this.renderDetalhes(r),this.updateDetailPageMeta(r),this.setDetailPageLoading(!1),x(),this.attachDetalhesEventListeners(r.id)}catch(a){if(console.error("Erro ao abrir detalhes:",a),a?.status===404){this.renderDetailPageState({title:"Fatura nao encontrada",message:"Ela pode ter sido removida ou voce nao tem mais acesso a este registro."});return}this.renderDetailPageState({title:"Erro ao carregar fatura",message:y(a,"Nao foi possivel carregar os detalhes desta fatura.")})}},attachDetalhesEventListeners(e){const t=this.getDetalhesTarget();if(!t)return;t.querySelectorAll(".th-sortable").forEach(l=>{l.addEventListener("click",()=>{const c=l.dataset.sort;i.sortColumn===c?i.sortDirection=i.sortDirection==="asc"?"desc":"asc":(i.sortColumn=c,i.sortDirection="asc"),i.faturaAtual&&(t.innerHTML=this.renderDetalhes(i.faturaAtual),x(),this.attachDetalhesEventListeners(e))})}),t.querySelectorAll(".btn-pagar, .btn-desfazer").forEach(l=>{l.addEventListener("click",async c=>{const u=parseInt(c.currentTarget.dataset.lancamentoId,10),m=c.currentTarget.dataset.pago==="true";await this.toggleParcelaPaga(e,u,!m)})}),t.querySelectorAll(".btn-editar").forEach(l=>{l.addEventListener("click",async c=>{const u=parseInt(c.currentTarget.dataset.lancamentoId,10),m=c.currentTarget.dataset.descricao||"",f=parseFloat(c.currentTarget.dataset.valor)||0;await this.editarItemFatura(e,u,m,f)})}),t.querySelectorAll(".btn-excluir").forEach(l=>{l.addEventListener("click",async c=>{const u=parseInt(c.currentTarget.dataset.lancamentoId,10),m=c.currentTarget.dataset.ehParcelado==="true",f=parseInt(c.currentTarget.dataset.totalParcelas)||1;await this.excluirItemFatura(e,u,m,f)})})},renderDetalhes(e){const t=e.progresso||0,{valorPago:a,valorRestante:r}=this.calcularValores(e),o=e.parcelas_pendentes>0&&r>0;return`
        ...
        `,e.parcelas&&e.parcelas.length>0?this.sortParcelas(e.parcelas).forEach((n,l)=>{r+=this.renderParcelaCard(n,l,e.descricao)}):r+=`
            ...
            `,r+="</div>",r},sortParcelas(e){if(!e||e.length===0)return[];const t=[...e],a=i.sortDirection==="asc"?1:-1,r=i.sortColumn;return t.sort((o,n)=>{if(r==="descricao"){const l=(o.descricao||"").toLowerCase(),c=(n.descricao||"").toLowerCase();return l.localeCompare(c)*a}if(r==="data_compra"){const l=o.data_compra||"0000-00-00",c=n.data_compra||"0000-00-00";return l.localeCompare(c)*a}if(r==="valor"){const l=parseFloat(o.valor_parcela||o.valor||0),c=parseFloat(n.valor_parcela||n.valor||0);return(l-c)*a}return 0}),t},renderParcelaCard(e,t,a){const r=e.pago,o=e.tipo==="estorno",n=r?"parcela-paga":"parcela-pendente",l=r?"✅ Paga":"⏳ Pendente",c=r?"parcela-card-paga":"",u=`${this.getNomeMes(e.mes_referencia)}/${e.ano_referencia}`,m=`parcela-card-${e.id||t}`;let f=e.descricao||a;f=f.replace(/\s*\(\d+\/\d+\)\s*$/,"");let h="";if(e.categoria){const b=e.categoria.icone||"tag",E=e.categoria.nome||e.categoria;h=`<i data-lucide="${b}" style="width:14px;height:14px;display:inline-block;vertical-align:middle;color:${pe(b)}"></i> ${d.escapeHtml(E)}`}return o?`
        ...
        `},renderParcelaRow(e,t,a){const r=e.pago,o=e.tipo==="estorno",n=r?"tr-paga":"";let l=e.descricao||a;l=l.replace(/\s*\(\d+\/\d+\)\s*$/,""),e.categoria&&(l=e.categoria.nome||e.categoria);const c=e.data_compra?d.formatDate(e.data_compra):"-";return o?`
        ...
        `},renderParcelaButton(e,t){if(t)return`
            ...
            `}},getNomeMes(e){return["Jan","Fev","Mar","Abr","Mai","Jun","Jul","Ago","Set","Out","Nov","Dez"][e-1]||e},getNomeMesCompleto(e){return["Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"][e-1]||e}};let B=null,F=null,M=null;function R(){return{modalEl:document.getElementById("modalDeleteFaturaItemScope"),formEl:document.getElementById("deleteFaturaItemScopeForm"),titleEl:document.getElementById("modalDeleteFaturaItemScopeLabel"),subtitleEl:document.getElementById("deleteFaturaItemScopeModalSubtitle"),leadEl:document.getElementById("deleteFaturaItemScopeModalLead"),hintEl:document.getElementById("deleteFaturaItemScopeModalHint"),optionsEl:document.getElementById("deleteFaturaItemScopeOptions"),confirmButtonEl:document.getElementById("btnConfirmDeleteFaturaItemScope")}}function ye(){const{formEl:e,optionsEl:t}=R();e?.reset();const a=t?.querySelector('input[value="item"]');a&&(a.checked=!0),t&&(t.hidden=!1)}function we(e=1){const{titleEl:t,subtitleEl:a,leadEl:r,hintEl:o,optionsEl:n,confirmButtonEl:l}=R(),c=Number(e)>1;if(t&&(t.textContent="Excluir item da fatura"),a&&(a.textContent=c?`Este item faz parte de um parcelamento de ${e}x.`:"Revise a exclusão antes de confirmar."),r&&(r.textContent=c?"Escolha se deseja remover apenas esta parcela ou o parcelamento completo.":"Esta ação não pode ser desfeita."),o&&(o.textContent=c?"Excluir todo o parcelamento remove todas as parcelas vinculadas a esta compra.":"O item será removido permanentemente da fatura."),l&&(l.textContent=c?"Continuar":"Excluir item"),n){n.hidden=!c;const m=n.querySelector('[data-delete-fatura-scope-title="item"]'),f=n.querySelector('[data-delete-fatura-scope-text="item"]'),h=n.querySelector('[data-delete-fatura-scope-title="parcelamento"]'),b=n.querySelector('[data-delete-fatura-scope-text="parcelamento"]');m&&(m.textContent="Apenas esta parcela"),f&&(f.textContent="Remove somente o item atual da fatura."),h&&(h.textContent=`Todo o parcelamento (${e} parcelas)`),b&&(b.textContent="Remove todas as parcelas vinculadas a esta compra parcelada.")}const u=n?.querySelector('input[value="item"]');u&&(u.checked=!0)}function Ee(){const e=R();return B?{modal:B,...e}:!e.modalEl||!window.bootstrap?.Modal?null:(window.LK?.modalSystem?.prepareBootstrapModal(e.modalEl,{scope:"page"}),e.modalEl.dataset.bound||(e.modalEl.dataset.bound="1",e.formEl?.addEventListener("submit",t=>{t.preventDefault(),M={scope:e.optionsEl?.querySelector('input[name="deleteFaturaItemScopeOption"]:checked')?.value||"item"},B?.hide()}),e.modalEl.addEventListener("hidden.bs.modal",()=>{const t=F,a=M;F=null,M=null,ye(),typeof t=="function"&&t(a||null)})),B=window.bootstrap.Modal.getOrCreateInstance(e.modalEl,{backdrop:!0,keyboard:!0,focus:!0}),{modal:B,...e})}function Se(e=1){const t=Ee();return t?(typeof F=="function"&&F(null),F=null,M=null,we(e),new Promise(a=>{F=a,t.modal.show(),requestAnimationFrame(()=>{(Number(e)>1?t.optionsEl?.querySelector('input[name="deleteFaturaItemScopeOption"]:checked'):t.confirmButtonEl)?.focus?.()})})):Promise.resolve(null)}const Ie={async toggleParcelaPaga(e,t,a){try{const r=a?"pagar":"desfazer pagamento";if(!(await Swal.fire({title:a?"Marcar como pago?":"Desfazer pagamento?",text:`Deseja realmente ${r} este item?`,icon:"question",showCancelButton:!0,confirmButtonColor:a?"#10b981":"#ef4444",cancelButtonColor:"#6b7280",confirmButtonText:a?"Sim, marcar como pago":"Sim, desfazer",cancelButtonText:"Cancelar",heightAuto:!1,customClass:{container:"swal-above-modal"},didOpen:()=>{const n=document.querySelector(".swal2-container");n&&(n.style.zIndex="99999")}})).isConfirmed)return;Swal.fire({title:"Processando...",allowOutsideClick:!1,heightAuto:!1,didOpen:()=>{Swal.showLoading();const n=document.querySelector(".swal2-container");n&&(n.style.zIndex="99999")},customClass:{container:"swal-above-modal"}}),await p.API.toggleItemFatura(e,t,a),await Swal.fire({icon:"success",title:"Sucesso!",text:a?"Item marcado como pago":"Pagamento desfeito",timer:w.TIMEOUTS.successMessage,showConfirmButton:!1,heightAuto:!1,customClass:{container:"swal-above-modal"},didOpen:()=>{const n=document.querySelector(".swal2-container");n&&(n.style.zIndex="99999")}}),await p.App.refreshAfterMutation(e)}catch(r){console.error("Erro ao alternar status:",r),Swal.fire({icon:"error",title:"Erro",text:y(r,"Erro ao processar operação"),heightAuto:!1,customClass:{container:"swal-above-modal"},didOpen:()=>{const o=document.querySelector(".swal2-container");o&&(o.style.zIndex="99999")}})}},async editarItemFatura(e,t,a,r){const o=s.modalEditarItemFatura||document.getElementById("modalEditarItemFatura");if(!o){console.error("Modal de edição não encontrado");return}window.LK?.modalSystem?.prepareBootstrapModal(o,{scope:"page"}),document.getElementById("editItemFaturaId").value=e,document.getElementById("editItemId").value=t,document.getElementById("editItemDescricao").value=a,document.getElementById("editItemValor").value=r.toLocaleString("pt-BR",{minimumFractionDigits:2,maximumFractionDigits:2}),bootstrap.Modal.getOrCreateInstance(o,{backdrop:!0,keyboard:!0,focus:!0}).show()},async salvarItemFatura(){const e=document.getElementById("editItemFaturaId").value,t=document.getElementById("editItemId").value,a=document.getElementById("editItemDescricao").value.trim(),r=document.getElementById("editItemValor").value;if(!a){Swal.fire({icon:"warning",title:"Atenção",text:"Informe a descrição do item.",timer:2e3,showConfirmButton:!1});return}const o=parseFloat(r.replace(/\./g,"").replace(",","."))||0;if(o<=0){Swal.fire({icon:"warning",title:"Atenção",text:"Informe um valor válido.",timer:2e3,showConfirmButton:!1});return}try{const n=s.modalEditarItemFatura||document.getElementById("modalEditarItemFatura"),l=bootstrap.Modal.getInstance(n);l&&l.hide(),Swal.fire({title:"Atualizando item...",html:"Aguarde enquanto salvamos as alterações.",allowOutsideClick:!1,heightAuto:!1,didOpen:()=>{Swal.showLoading()}}),await p.API.atualizarItemFatura(e,t,{descricao:a,valor:o}),await Swal.fire({icon:"success",title:"Item Atualizado!",text:"O item foi atualizado com sucesso.",timer:w.TIMEOUTS.successMessage,showConfirmButton:!1,heightAuto:!1}),await p.App.refreshAfterMutation(e)}catch(n){console.error("Erro ao editar item:",n),Swal.fire({icon:"error",title:"Erro",text:y(n,"Não foi possível atualizar o item."),heightAuto:!1})}},async excluirItemFatura(e,t,a,r){try{const o="Excluir Item?",n="Deseja realmente excluir este item da fatura?",l="Sim, excluir item";if(a&&r>1){const u=await Se(r);if(!u?.scope)return;if(u.scope==="parcelamento")return await this.excluirParcelamentoCompleto(e,t,r)}if(!(await Swal.fire({title:o,text:n,icon:"warning",showCancelButton:!0,confirmButtonColor:"#ef4444",cancelButtonColor:"#6b7280",confirmButtonText:l,cancelButtonText:"Cancelar",heightAuto:!1,customClass:{container:"swal-above-modal"},didOpen:()=>{const u=document.querySelector(".swal2-container");u&&(u.style.zIndex="99999")}})).isConfirmed)return;Swal.fire({title:"Excluindo...",allowOutsideClick:!1,heightAuto:!1,didOpen:()=>{Swal.showLoading();const u=document.querySelector(".swal2-container");u&&(u.style.zIndex="99999")},customClass:{container:"swal-above-modal"}}),await p.API.excluirItemFatura(e,t),await Swal.fire({icon:"success",title:"Excluído!",text:"Item removido da fatura.",timer:w.TIMEOUTS.successMessage,showConfirmButton:!1,heightAuto:!1,customClass:{container:"swal-above-modal"},didOpen:()=>{const u=document.querySelector(".swal2-container");u&&(u.style.zIndex="99999")}}),await p.App.refreshAfterMutation(e)}catch(o){console.error("Erro ao excluir item:",o),Swal.fire({icon:"error",title:"Erro",text:y(o,"Não foi possível excluir o item."),heightAuto:!1,customClass:{container:"swal-above-modal"},didOpen:()=>{const n=document.querySelector(".swal2-container");n&&(n.style.zIndex="99999")}})}},async excluirParcelamentoCompleto(e,t,a){if((await Swal.fire({title:"Excluir Parcelamento Completo?",html:`
            ...
            `,icon:"warning",showCancelButton:!0,confirmButtonColor:"#ef4444",cancelButtonColor:"#6b7280",confirmButtonText:`Sim, excluir ${a} parcelas`,cancelButtonText:"Cancelar",heightAuto:!1,customClass:{container:"swal-above-modal"},didOpen:()=>{const o=document.querySelector(".swal2-container");o&&(o.style.zIndex="99999"),x()}})).isConfirmed){Swal.fire({title:"Excluindo parcelamento...",allowOutsideClick:!1,heightAuto:!1,didOpen:()=>{Swal.showLoading();const o=document.querySelector(".swal2-container");o&&(o.style.zIndex="99999")},customClass:{container:"swal-above-modal"}});try{const o=await p.API.excluirParcelamentoDoItem(e,t);await Swal.fire({icon:"success",title:"Parcelamento Excluído!",text:o.message||`${a} parcelas removidas.`,timer:w.TIMEOUTS.successMessage,showConfirmButton:!1,heightAuto:!1,customClass:{container:"swal-above-modal"},didOpen:()=>{const n=document.querySelector(".swal2-container");n&&(n.style.zIndex="99999")}}),await p.App.refreshAfterMutation(e)}catch(o){console.error("Erro ao excluir parcelamento:",o),Swal.fire({icon:"error",title:"Erro",text:y(o,"Não foi possível excluir o parcelamento."),heightAuto:!1,customClass:{container:"swal-above-modal"},didOpen:()=>{const n=document.querySelector(".swal2-container");n&&(n.style.zIndex="99999")}})}}},async pagarFaturaCompleta(e,t){try{Swal.fire({title:"Carregando...",html:"Buscando informações da fatura e contas disponíveis.",allowOutsideClick:!1,heightAuto:!1,didOpen:()=>{Swal.showLoading();const g=document.querySelector(".swal2-container");g&&(g.style.zIndex="99999")},customClass:{container:"swal-above-modal"}});const[a,r]=await Promise.all([p.API.buscarParcelamento(e),p.API.listarContas()]),o=S(a,null),n=S(r,[]);if(!o?.cartao)throw new Error("Dados da fatura incompletos");const l=o.cartao.id,c=o.cartao.conta_id||null,m=(o.descricao||"").match(/(\d+)\/(\d+)/),f=m?m[1]:null,h=m?m[2]:null;if(!f||!h)throw new Error("Não foi possível identificar o mês/ano da fatura");let b="";if(Array.isArray(n)&&n.length>0)n.forEach(g=>{const I=g.saldoAtual??g.saldo_atual??g.saldo??0,T=d.formatMoney(I),D=g.id===c,L=I>=t;b+=`<option value="${g.id}" ${D?"selected":""} ${L?"":'style="color: #dc2626;"'}>
                        ${d.escapeHtml(g.nome)} - ${T}${D?" (vinculada ao cartão)":""}
                ...
                `,icon:"question",showCancelButton:!0,confirmButtonColor:"#10b981",cancelButtonColor:"#6b7280",confirmButtonText:'<i data-lucide="check"></i> Sim, pagar tudo',cancelButtonText:"Cancelar",heightAuto:!1,customClass:{container:"swal-above-modal"},didOpen:()=>{const g=document.querySelector(".swal2-container");g&&(g.style.zIndex="99999"),x()},preConfirm:()=>{const g=document.getElementById("swalContaSelect"),I=g?parseInt(g.value):null;return I?{contaId:I}:(Swal.showValidationMessage("Selecione uma conta para débito"),!1)}});if(!E.isConfirmed)return;const $=E.value.contaId;Swal.fire({title:"Processando pagamento...",html:"Aguarde enquanto processamos o pagamento de todos os itens.",allowOutsideClick:!1,heightAuto:!1,didOpen:()=>{Swal.showLoading();const g=document.querySelector(".swal2-container");g&&(g.style.zIndex="99999")},customClass:{container:"swal-above-modal"}});const C=await p.API.pagarFaturaCompleta(l,parseInt(f),parseInt(h),$);if(!C.success)throw new Error(C.message||"Erro ao processar pagamento");await Swal.fire({icon:"success",title:"Fatura Paga!",html:`
            ...
            `).join(""),window.lucide&&lucide.createIcons(),s.activeFilters.querySelectorAll(".filter-badge-remove").forEach(t=>{t.addEventListener("click",a=>{const r=a.currentTarget.dataset.filter;this.removerFiltro(r)})})):(s.activeFilters.style.display="none",s.activeFilters.innerHTML="")},removerFiltro(e){i.filtros[e]="";const t={status:s.filtroStatus,cartao_id:s.filtroCartao,ano:s.filtroAno,mes:s.filtroMes};t[e]&&(t[e].value=""),this.atualizarBadgesFiltros(),this.carregarParcelamentos()}};p.App=J;const O={instance:null,faturaId:null,valorTotal:null,cartaoId:null,mes:null,ano:null,contas:[],contaPadraoId:null,init(){const e=s.modalPagarFatura||document.getElementById("modalPagarFatura");e&&(window.LK?.modalSystem?.prepareBootstrapModal(e,{scope:"page"}),this.instance=bootstrap.Modal.getOrCreateInstance(e,{backdrop:!0,keyboard:!0,focus:!0}),this.attachEvents())},attachEvents(){document.getElementById("btnPagarTotal")?.addEventListener("click",()=>{this.instance.hide(),p.UI.pagarFaturaCompleta(this.faturaId,this.valorTotal)}),document.getElementById("btnPagarParcial")?.addEventListener("click",()=>{this.mostrarFormularioParcial()}),document.getElementById("btnVoltarEscolha")?.addEventListener("click",()=>{this.mostrarEscolha()}),document.getElementById("btnConfirmarPagamento")?.addEventListener("click",()=>{this.confirmarPagamentoParcial()});const e=document.getElementById("valorPagamentoParcial");e&&(e.addEventListener("input",t=>{let a=t.target.value.replace(/\D/g,"");if(a===""){t.target.value="";return}a=(parseInt(a)/100).toFixed(2),t.target.value=parseFloat(a).toLocaleString("pt-BR",{minimumFractionDigits:2,maximumFractionDigits:2})}),e.addEventListener("focus",t=>{t.target.select()})),document.querySelectorAll(".btn-opcao-pagamento").forEach(t=>{t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-2px)",t.style.boxShadow="0 8px 25px rgba(0,0,0,0.2)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)",t.style.boxShadow="none"})})},async abrir(e,t){this.faturaId=e,this.valorTotal=t,document.getElementById("pagarFaturaId").value=e,document.getElementById("pagarFaturaValorTotal").value=t,document.getElementById("valorTotalDisplay").textContent=d.formatMoney(t),document.getElementById("valorTotalInfo").textContent=`Valor total da fatura: ${d.formatMoney(t)}`,document.getElementById("valorPagamentoParcial").value=d.formatMoney(t).replace("R$ ",""),this.mostrarEscolha(),await this.carregarDados(),this.instance.show()},async carregarDados(){try{const[e,t]=await Promise.all([p.API.buscarParcelamento(this.faturaId),p.API.listarContas()]),a=S(e,null);if(this.contas=S(t,[]),!a?.cartao)throw new Error("Dados da fatura incompletos");this.cartaoId=a.cartao.id,this.contaPadraoId=a.cartao.conta_id||null;const o=(a.descricao||"").match(/(\d+)\/(\d+)/);this.mes=o?parseInt(o[1]):null,this.ano=o?parseInt(o[2]):null,this.popularSelectContas()}catch(e){console.error("Erro ao carregar dados:",e),Swal.fire({icon:"error",title:"Erro",text:y(e,"Erro ao carregar dados da fatura.")})}},popularSelectContas(){const e=document.getElementById("contaPagamentoFatura");if(e){if(e.innerHTML="",!Array.isArray(this.contas)||this.contas.length===0){e.innerHTML='<option value="">Nenhuma conta disponível</option>';return}this.contas.forEach(t=>{const a=t.saldoAtual??t.saldo_atual??t.saldo??0,r=d.formatMoney(a),o=t.id===this.contaPadraoId,n=document.createElement("option");n.value=t.id,n.textContent=`${t.nome} - ${r}${o?" (vinculada ao cartão)":""}`,o&&(n.selected=!0),e.appendChild(n)})}},mostrarEscolha(){document.getElementById("pagarFaturaEscolha").style.display="block",document.getElementById("pagarFaturaFormParcial").style.display="none",document.getElementById("pagarFaturaFooter").style.display="none"},mostrarFormularioParcial(){document.getElementById("pagarFaturaEscolha").style.display="none",document.getElementById("pagarFaturaFormParcial").style.display="block",document.getElementById("pagarFaturaFooter").style.display="flex",setTimeout(()=>{const e=document.getElementById("valorPagamentoParcial");e&&(e.focus(),e.select())},100)},async confirmarPagamentoParcial(){const e=document.getElementById("valorPagamentoParcial").value,t=document.getElementById("contaPagamentoFatura").value,a=parseFloat(e.replace(/\./g,"").replace(",","."))||0;if(a<=0){Swal.fire({icon:"warning",title:"Valor inválido",text:"Digite um valor válido para o pagamento.",timer:2e3,showConfirmButton:!1});return}if(a>this.valorTotal){Swal.fire({icon:"warning",title:"Valor inválido",text:`O valor não pode ser maior que ${d.formatMoney(this.valorTotal)}`,timer:2e3,showConfirmButton:!1});return}if(!t){Swal.fire({icon:"warning",title:"Conta não selecionada",text:"Selecione uma conta para débito.",timer:2e3,showConfirmButton:!1});return}if(!this.cartaoId||!this.mes||!this.ano){Swal.fire({icon:"error",title:"Erro",text:"Dados da fatura incompletos. Tente novamente."});return}this.instance.hide(),Swal.fire({title:"Processando pagamento...",html:"Aguarde enquanto processamos o pagamento.",allowOutsideClick:!1,heightAuto:!1,didOpen:()=>Swal.showLoading()});try{const r=await p.API.pagarFaturaParcial(this.cartaoId,this.mes,this.ano,parseInt(t,10),a);if(!r.success)throw new Error(y(r,"Erro ao processar pagamento"));await Swal.fire({icon:"success",title:"Pagamento Realizado!",html:`
                ...
                `,timer:3e3,showConfirmButton:!1}),await p.App.refreshAfterMutation(this.faturaId)}catch(r){console.error("Erro ao pagar fatura:",r),Swal.fire({icon:"error",title:"Erro ao pagar fatura",text:y(r,"Não foi possível processar o pagamento. Tente novamente.")})}}};async function Pe(e){const t=i.faturaAtual;if(!t||!t.cartao||!t.mes_referencia||!t.ano_referencia){Swal.fire({icon:"error",title:"Erro",text:"Dados da fatura incompletos para reverter o pagamento."});return}if((await Swal.fire({title:"Desfazer Pagamento?",html:`
        ...
        `,icon:"warning",showCancelButton:!0,confirmButtonColor:"#f59e0b",cancelButtonColor:"#6b7280",confirmButtonText:'<i data-lucide="undo-2"></i> Sim, reverter',cancelButtonText:"Cancelar",didOpen:()=>{window.lucide&&lucide.createIcons()}})).isConfirmed)try{Swal.fire({title:"Revertendo pagamento...",html:"Aguarde enquanto processamos a reversão.",allowOutsideClick:!1,didOpen:()=>Swal.showLoading()});const r=t.cartao.id,o=t.mes_referencia,n=t.ano_referencia,l=await p.API.desfazerPagamentoFatura(r,o,n);if(l.success)await Swal.fire({icon:"success",title:"Pagamento Revertido!",html:`
                    <p>${l.message||"O pagamento foi revertido com sucesso."}</p>
                    <p style="color: #059669; margin-top: 0.5rem;">
                        <i data-lucide="circle-check"></i> 
                        ${S(l,{})?.itens_revertidos||0} item(s) voltou(aram) para pendente.
                    </p>
                `,timer:3e3,showConfirmButton:!1,didOpen:()=>{window.lucide&&lucide.createIcons()}}),await p.App.refreshAfterMutation(e);else throw new Error(y(l,"Erro ao reverter pagamento"))}catch(r){console.error("Erro ao reverter pagamento:",r),Swal.fire({icon:"error",title:"Erro",text:y(r,"Não foi possível reverter o pagamento.")})}}p.ModalPagarFatura=O;const xe={toggleFaturasHero:"faturasHero",toggleFaturasFiltros:"faturasFilters",toggleFaturasViewToggle:"faturasViewToggle"},Y={toggleFaturasHero:!0,toggleFaturasFiltros:!0,toggleFaturasViewToggle:!0},Fe={...Y,toggleFaturasFiltros:!1,toggleFaturasViewToggle:!1};async function $e(){return me("faturas")}async function Be(e){await ue("faturas",e)}const k=de({storageKey:"lk_faturas_prefs",sectionMap:xe,completeDefaults:Y,essentialDefaults:Fe,loadPreferences:$e,savePreferences:Be,modal:{overlayId:"faturasCustomizeModalOverlay",openButtonId:"btnCustomizeFaturas",closeButtonId:"btnCloseCustomizeFaturas",saveButtonId:"btnSaveCustomizeFaturas",presetEssentialButtonId:"btnPresetEssencialFaturas",presetCompleteButtonId:"btnPresetCompletoFaturas"}});function K(){k.init()}p.Customize={init:K,open:k.open,close:k.close};window.abrirModalPagarFatura=(e,t)=>O.abrir(e,t);window.reverterPagamentoFaturaGlobal=Pe;window.__LK_PARCELAMENTOS_LOADER__||(window.__LK_PARCELAMENTOS_LOADER__=!0,document.addEventListener("DOMContentLoaded",()=>{fe(),document.getElementById("faturaDetalhePage")||K(),J.init(),O.init()}));
