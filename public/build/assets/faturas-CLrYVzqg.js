import{a as N,g as R,j as y,e as g}from"./api-CpqPnVR7.js";import{r as $}from"./ui-H2yoVZe7.js";import{c as q,p as V,f as H}from"./ui-preferences-COf1b1j3.js";function U(e){return{house:"#f97316",utensils:"#ef4444",car:"#3b82f6",lightbulb:"#eab308","heart-pulse":"#ef4444","graduation-cap":"#6366f1",shirt:"#ec4899",clapperboard:"#a855f7","credit-card":"#0ea5e9",smartphone:"#6366f1","shopping-cart":"#f97316",coins:"#eab308",briefcase:"#3b82f6",laptop:"#06b6d4","trending-up":"#22c55e",gift:"#ec4899",banknote:"#22c55e",trophy:"#f59e0b",wallet:"#14b8a6",tag:"#94a3b8","pie-chart":"#8b5cf6","piggy-bank":"#ec4899",plane:"#0ea5e9","gamepad-2":"#a855f7",baby:"#f472b6",dog:"#92400e",wrench:"#64748b",church:"#6366f1",dumbbell:"#ef4444",music:"#a855f7","book-open":"#3b82f6",scissors:"#ec4899","building-2":"#64748b",landmark:"#3b82f6",receipt:"#14b8a6"}[e]||"#f97316"}const b={BASE_URL:(window.BASE_URL||"/").replace(/\/?$/,"/"),ENDPOINTS:{parcelamentos:"api/faturas",categorias:"api/categorias",contas:"api/contas",cartoes:"api/cartoes"},TIMEOUTS:{alert:5e3,successMessage:2e3}},n={};function j(){n.loadingEl=document.getElementById("loadingParcelamentos"),n.containerEl=document.getElementById("parcelamentosContainer"),n.emptyStateEl=document.getElementById("emptyState"),n.filtroStatus=document.getElementById("filtroStatus"),n.filtroCartao=document.getElementById("filtroCartao"),n.filtroAno=document.getElementById("filtroAno"),n.filtroMes=document.getElementById("filtroMes"),n.btnFiltrar=document.getElementById("btnFiltrar"),n.btnLimparFiltros=document.getElementById("btnLimparFiltros"),n.filtersContainer=document.querySelector(".filters-modern"),n.filtersBody=document.getElementById("filtersBody"),n.toggleFilters=document.getElementById("toggleFilters"),n.activeFilters=document.getElementById("activeFilters"),n.modalDetalhes=document.getElementById("modalDetalhesParcelamento"),n.detalhesContent=document.getElementById("detalhesParcelamentoContent")}const l={parcelamentos:[],cartoes:[],faturaAtual:null,sortColumn:"data_compra",sortDirection:"asc",filtros:{status:"",cartao_id:"",ano:new Date().getFullYear(),mes:""},modalDetalhesInstance:null,anosCarregados:!1},m={},c={formatMoney(e){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(e||0)},formatDate(e){return e?new Date(e+"T00:00:00").toLocaleDateString("pt-BR"):""},parseMoney(e){return e&&parseFloat(e.replace(/[^\d,]/g,"").replace(",","."))||0},showAlert(e,a,t="danger"){e&&(e.className=`alert alert-${t}`,e.textContent=a,e.style.display="block",setTimeout(()=>{e.style.display="none"},b.TIMEOUTS.alert))},getCSRFToken(){return R()},escapeHtml(e){if(!e)return"";const a=document.createElement("div");return a.textContent=e,a.innerHTML},buildUrl(e,a={}){const t=e.startsWith("http")?e:b.BASE_URL+e.replace(/^\//,""),o=Object.entries(a).filter(([r,s])=>s!=null&&s!=="").map(([r,s])=>`${r}=${encodeURIComponent(s)}`);return o.length>0?`${t}?${o.join("&")}`:t},async apiRequest(e,a={}){const t=e.startsWith("http")?e:b.BASE_URL+e.replace(/^\//,"");try{return await N(t,{...a,headers:{"X-CSRF-Token":this.getCSRFToken(),...a.headers}})}catch(o){throw console.error("Erro na requisição:",o),o}},debounce(e,a){let t;return function(...r){const s=()=>{clearTimeout(t),e(...r)};clearTimeout(t),t=setTimeout(s,a)}},calcularDiferencaDias(e,a){const t=new Date(e+"T00:00:00"),o=new Date(a+"T00:00:00");return Math.floor((t-o)/(1e3*60*60*24))}},J={async listarParcelamentos(e={}){const a={status:e.status,cartao_id:e.cartao_id,ano:e.ano,mes:e.mes},t=c.buildUrl(b.ENDPOINTS.parcelamentos,a);return await c.apiRequest(t)},async listarCartoes(){return await c.apiRequest(b.ENDPOINTS.cartoes)},async buscarParcelamento(e){const a=parseInt(e,10);if(isNaN(a))throw new Error("ID inválido");return await c.apiRequest(`${b.ENDPOINTS.parcelamentos}/${a}`)},async criarParcelamento(e){return await c.apiRequest(b.ENDPOINTS.parcelamentos,{method:"POST",body:JSON.stringify(e)})},async cancelarParcelamento(e){return await c.apiRequest(`${b.ENDPOINTS.parcelamentos}/${e}`,{method:"DELETE"})},async toggleItemFatura(e,a,t){return await c.apiRequest(`${b.ENDPOINTS.parcelamentos}/${e}/itens/${a}/toggle`,{method:"POST",body:JSON.stringify({pago:t})})},async pagarFaturaCompleta(e,a,t,o=null){const r={mes:a,ano:t};return o&&(r.conta_id=o),await c.apiRequest(`${b.ENDPOINTS.cartoes}/${e}/fatura/pagar`,{method:"POST",body:JSON.stringify(r)})},async listarContas(){return await c.apiRequest(`${b.ENDPOINTS.contas}?with_balances=1`)}};m.API=J;const L=(e,a=0,t=100)=>Math.min(t,Math.max(a,Number(e)||0)),v=(e,a="")=>c.escapeHtml(String(e??a)),G=(e,a=0)=>`${(Number(e)||0).toLocaleString("pt-BR",{minimumFractionDigits:a,maximumFractionDigits:a})}%`,B=(e,a)=>`data-lk-tooltip-title="${v(e)}" data-lk-tooltip="${v(a)}"`,M=/(#[0-9a-fA-F]{3,8}|rgba?\([^)]+\)|hsla?\([^)]+\))/,K={renderParcelamentos(e){if(!Array.isArray(e)||e.length===0){this.showEmpty();return}n.emptyStateEl.style.display="none",n.containerEl.style.display="grid";const a=document.createDocumentFragment();e.forEach(t=>{const o=this.createParcelamentoCard(t);a.appendChild(o)}),n.containerEl.innerHTML="",n.containerEl.appendChild(a),$()},createParcelamentoCard(e){const a=e.progresso||0,t=e.parcelas_pendentes||0,o=e.parcelas_pagas||0,r=o+t,s=this.getDueMeta(e),i=this.getStatusMeta(e.status,a,s),d=document.createElement("div");d.className=`parcelamento-card surface-card surface-card--interactive surface-card--clip status-${e.status}`,d.dataset.id=e.id,d.style.setProperty("--fatura-accent",this.getAccentColorSolid(e.cartao));const f=this.getStatusBadge(e.status,a,s),u=e.mes_referencia||"",h=e.ano_referencia||"";return d.innerHTML=this.createCardHTML({parc:e,statusBadge:f,mes:u,ano:h,itensPendentes:t,itensPagos:o,totalItens:r,progresso:a,dueMeta:s,statusMeta:i}),this.attachCardEventListeners(d,e.id),d},attachCardEventListeners(e,a){const t=e.querySelector('[data-action="view"]');t&&t.addEventListener("click",()=>this.showDetalhes(a))},getAccentColorSolid(e){const t={visa:"#1A1F71",mastercard:"#EB001B",elo:"#FFCB05",amex:"#006FCF",diners:"#0079BE",discover:"#FF6000",hipercard:"#B11116"}[e?.bandeira?.toLowerCase()]||"#3b82f6",o=String(e?.cor_cartao||e?.conta?.instituicao_financeira?.cor_primaria||t).trim();return o?/gradient/i.test(o)?o.match(M)?.[1]||t:/^var\(/i.test(o)||M.test(o)?o:t:t},getBandeiraIcon(e){return{visa:'<svg viewBox="0 0 48 32" width="32" height="22" fill="none"><rect width="48" height="32" rx="4" fill="#1A1F71"/><text x="24" y="20" text-anchor="middle" font-size="12" font-weight="bold" fill="#fff" font-family="sans-serif">VISA</text></svg>',mastercard:'<svg viewBox="0 0 48 32" width="32" height="22" fill="none"><rect width="48" height="32" rx="4" fill="#1A1F71" opacity="0"/><circle cx="19" cy="16" r="10" fill="#EB001B" opacity=".85"/><circle cx="29" cy="16" r="10" fill="#F79E1B" opacity=".85"/></svg>',elo:'<svg viewBox="0 0 48 32" width="32" height="22" fill="none"><rect width="48" height="32" rx="4" fill="#000"/><text x="24" y="20" text-anchor="middle" font-size="13" font-weight="bold" fill="#FFCB05" font-family="sans-serif">elo</text></svg>',amex:'<svg viewBox="0 0 48 32" width="32" height="22" fill="none"><rect width="48" height="32" rx="4" fill="#006FCF"/><text x="24" y="20" text-anchor="middle" font-size="9" font-weight="bold" fill="#fff" font-family="sans-serif">AMEX</text></svg>',hipercard:'<svg viewBox="0 0 48 32" width="32" height="22" fill="none"><rect width="48" height="32" rx="4" fill="#B11116"/><text x="24" y="20" text-anchor="middle" font-size="8" font-weight="bold" fill="#fff" font-family="sans-serif">HIPER</text></svg>',diners:'<svg viewBox="0 0 48 32" width="32" height="22" fill="none"><rect width="48" height="32" rx="4" fill="#0079BE"/><text x="24" y="20" text-anchor="middle" font-size="8" font-weight="bold" fill="#fff" font-family="sans-serif">DINERS</text></svg>'}[e]||'<i data-lucide="credit-card"></i>'},getDueMeta(e){let a=e.data_vencimento;if(!a&&e.cartao?.dia_vencimento&&e.descricao){const f=e.descricao.match(/(\d{1,2})\/(\d{4})/);if(f){const u=f[1].padStart(2,"0"),h=f[2],w=String(e.cartao.dia_vencimento).padStart(2,"0");a=`${h}-${u}-${w}`}}if(!a)return{hasDate:!1,label:"A definir",helper:"Sem data de vencimento informada",detailClass:"",isVencida:!1,isProxima:!1};const t=c.formatDate(a),o=new Date;o.setHours(0,0,0,0);const r=new Date(`${a}T00:00:00`),s=e.status!=="paga"&&e.status!=="concluido"&&e.status!=="cancelado",i=s&&r<o,d=s&&!i&&r-o<=4320*60*1e3;return{hasDate:!0,raw:a,label:t,helper:i?"Vencimento expirado":d?"Vence em breve":"Dentro do prazo",detailClass:i?"is-danger":d?"is-warning":"",isVencida:i,isProxima:d}},getStatusMeta(e,a=null,t=null){const o=L(a);return e==="cancelado"?{badgeClass:"badge-cancelado",progressClass:"is-muted",icon:"ban",label:"Cancelada",shortLabel:"Cancelada",hint:"Sem cobranca ativa",tooltip:"Esta fatura foi cancelada e nao entra mais no acompanhamento ativo."}:o>=100||e==="paga"||e==="concluido"?{badgeClass:"badge-paga",progressClass:"is-safe",icon:"circle-check",label:"Paga",shortLabel:"Liquidada",hint:"Pagamento concluido",tooltip:"O valor desta fatura ja foi quitado integralmente."}:t?.isVencida?{badgeClass:"badge-alerta",progressClass:"is-danger",icon:"triangle-alert",label:"Vencida",shortLabel:"Em atraso",hint:"Regularize esta fatura",tooltip:"A fatura passou do vencimento e merece prioridade para evitar juros."}:t?.isProxima?{badgeClass:"badge-alerta",progressClass:"is-warning",icon:"clock-3",label:"Vence em breve",shortLabel:"Vence logo",hint:"Priorize o pagamento",tooltip:"O vencimento esta proximo. Vale organizar o pagamento desta fatura."}:o>0?{badgeClass:"badge-parcial",progressClass:"is-warning",icon:"loader-2",label:"Pagamento parcial",shortLabel:"Parcial",hint:"Parte do valor ja foi paga",tooltip:"A fatura segue aberta, mas ja possui pagamentos registrados."}:{badgeClass:"badge-pendente",progressClass:"is-safe",icon:"clock-3",label:"Pendente",shortLabel:"No prazo",hint:"Aguardando pagamento",tooltip:"A fatura segue aberta e ainda esta dentro do prazo normal de pagamento."}},getResumoPrincipal(e,a,t,o,r,s){const i=e.total_estornos&&e.total_estornos>0,d=s>0?`${r} de ${s} itens pagos`:"Sem itens consolidados",f=a.hasDate&&a.helper!=="Dentro do prazo"?`<span class="fatura-card-due-tag ${a.detailClass}">${v(a.helper)}</span>`:"";return`
            <div class="fatura-card-main">
                ...
                <div class="fatura-card-due-line ${a.detailClass}">
                    <span class="fatura-card-due-copy">Vencimento ${v(a.label)}</span>
                    ${f}
                </div>
                ${i?`
            ...
            <div class="fatura-card-details">
                <div class="fatura-card-detail ${a.detailClass}" ${B("Vencimento",a.hasDate?`Data prevista para pagamento desta fatura: ${a.label}.`:"A fatura ainda nao possui data de vencimento consolidada.")}>
                ...
                <div class="fatura-card-detail ${t.progressClass}" ${B("Progresso de pagamento",s>0?`${r} de ${s} itens ja foram pagos nesta fatura.`:"Ainda nao existem itens suficientes para calcular o progresso de pagamento.")}>
                    <span class="fatura-card-detail-label">Pagamento</span>
                    <strong class="fatura-card-detail-value">${s>0?`${r}/${s}`:"--"}</strong>
                    <span class="fatura-card-detail-meta">${v(d)}</span>
                </div>
            </div>
        `},getProgressoSection(e,a,t,o,r){const s=L(o),i=s>0?Math.max(s,8):0;return e===0?`
            ...
            <div class="parc-progress-section ${r.progressClass}">
                <div class="parc-progress-header">
                    <span class="parc-progress-text">Pagamento ${G(s)}</span>
                    <span class="parc-progress-percent">${v(r.shortLabel)}</span>
                </div>
                <div class="parc-progress-bar">
        ...
        `},createCardHTML({parc:e,statusBadge:a,mes:t,ano:o,itensPendentes:r,itensPagos:s,totalItens:i,progresso:d,dueMeta:f,statusMeta:u}){const h=this.getResumoPrincipal(e,f,u,r,s,i),w=this.getProgressoSection(i,r,s,d,u),E=e.cartao&&(e.cartao.nome||e.cartao.bandeira)||"Cartao",C=e.cartao?.conta?.instituicao_financeira?.nome||"Sem instituicao",P=e.cartao?.ultimos_digitos?`Final ${e.cartao.ultimos_digitos}`:"",I=this.getAccentColorSolid(e.cartao),p=e.cartao?.bandeira?.toLowerCase()||"outros",x=this.getBandeiraIcon(p),F=t&&o?`${t}/${o}`:"Fatura atual",D=[v(C),P?v(P):""].filter(Boolean).join(" - ");return`
            <div class="fatura-card-shell" style="--fatura-accent:${I};">
                <div class="fatura-card-top">
                    ...
                    <div class="fatura-card-head">
                        <div class="fatura-card-title-wrap">
                            <span class="fatura-card-title">${v(E)}</span>
                            <span class="fatura-card-subtitle">${v(C)}</span>
                        </div>
                        <div class="fatura-card-meta">
                            <span class="fatura-card-period" ${B("Periodo da fatura","Competencia consolidada desta fatura para acompanhar fechamento e vencimento.")}>
                ...
                <div class="fatura-list-info">
                    <span class="list-cartao-nome">${v(E)}</span>
                    <span class="list-periodo">${v(F)}</span>
                    <span class="list-cartao-numero">${D}</span>
                </div>
        ...
        `}},Y={async showDetalhes(e){try{const a=await m.API.buscarParcelamento(e),t=y(a,null);if(!t){l.modalDetalhesInstance&&l.modalDetalhesInstance.hide();return}l.faturaAtual=t;const o=n.modalDetalhes;if(o&&t.cartao){const r=this.getAccentColorSolid(t.cartao),s=o.querySelector(".modal-content");s&&s.style.setProperty("--card-accent",r)}n.detalhesContent.innerHTML=this.renderDetalhes(t),$(),this.attachDetalhesEventListeners(t.id),document.activeElement?.blur(),l.modalDetalhesInstance.show()}catch(a){if(console.error("Erro ao abrir detalhes:",a),a.message&&a.message.includes("404")){l.modalDetalhesInstance&&l.modalDetalhesInstance.hide();return}Swal.fire({icon:"error",title:"Erro",text:g(a,"Não foi possível carregar os detalhes da fatura")})}},attachDetalhesEventListeners(e){n.detalhesContent.querySelectorAll(".th-sortable").forEach(s=>{s.addEventListener("click",()=>{const i=s.dataset.sort;l.sortColumn===i?l.sortDirection=l.sortDirection==="asc"?"desc":"asc":(l.sortColumn=i,l.sortDirection="asc"),l.faturaAtual&&(n.detalhesContent.innerHTML=this.renderDetalhes(l.faturaAtual),$(),this.attachDetalhesEventListeners(e))})}),n.detalhesContent.querySelectorAll(".btn-pagar, .btn-desfazer").forEach(s=>{s.addEventListener("click",async i=>{const d=parseInt(i.currentTarget.dataset.lancamentoId,10),f=i.currentTarget.dataset.pago==="true";await this.toggleParcelaPaga(e,d,!f)})}),n.detalhesContent.querySelectorAll(".btn-editar").forEach(s=>{s.addEventListener("click",async i=>{const d=parseInt(i.currentTarget.dataset.lancamentoId,10),f=i.currentTarget.dataset.descricao||"",u=parseFloat(i.currentTarget.dataset.valor)||0;await this.editarItemFatura(e,d,f,u)})}),n.detalhesContent.querySelectorAll(".btn-excluir").forEach(s=>{s.addEventListener("click",async i=>{const d=parseInt(i.currentTarget.dataset.lancamentoId,10),f=i.currentTarget.dataset.ehParcelado==="true",u=parseInt(i.currentTarget.dataset.totalParcelas)||1;await this.excluirItemFatura(e,d,f,u)})})},renderDetalhes(e){const a=e.progresso||0,{valorPago:t,valorRestante:o}=this.calcularValores(e),r=e.parcelas_pendentes>0&&o>0;return`
        ...
        `,e.parcelas&&e.parcelas.length>0?this.sortParcelas(e.parcelas).forEach((s,i)=>{o+=this.renderParcelaCard(s,i,e.descricao)}):o+=`
                ...
                <div class="parcela-card" id="${u}" style="background: linear-gradient(135deg, rgba(16, 185, 129, 0.15) 0%, rgba(16, 185, 129, 0.05) 100%); border-color: rgba(16, 185, 129, 0.4);">
                    ...
                    <div class="parcela-card-body">
                        <div class="parcela-card-info">
                            ...
                            <span class="parcela-card-value" style="color: #10b981;">${c.escapeHtml(h)}</span>
                        </div>
                        <div class="parcela-card-info">
            ...
            <div class="parcela-card ${d}" id="${u}">
                ...
                <div class="parcela-card-body">
                    <div class="parcela-card-info">
                        <span class="parcela-card-label">Descrição</span>
                        <span class="parcela-card-value">${c.escapeHtml(h)}${e.recorrente?' <span class="badge-recorrente" title="Assinatura recorrente" style="display:inline-flex;align-items:center;background:rgba(230,126,34,0.15);border-radius:6px;padding:1px 6px;margin-left:6px;"><i data-lucide="refresh-cw" style="width:12px;height:12px;color:var(--primary, #e67e22);"></i></span>':""}</span>
                    </div>
                    ${e.data_compra?`
                    <div class="parcela-card-info">
        ...
        `},getDataPagamentoInfo(e){return!e.pago||!e.data_pagamento?"":`<small style="color: #10b981; display: block; margin-top: 3px;">✅ Pago em ${e.data_pagamento}</small>`},renderParcelaButton(e,a){if(a)return`
            ...
            `,icon:"warning",showCancelButton:!0,confirmButtonColor:"#ef4444",cancelButtonColor:"#6b7280",confirmButtonText:`Sim, excluir ${t} parcelas`,cancelButtonText:"Cancelar",heightAuto:!1,customClass:{container:"swal-above-modal"},didOpen:()=>{const r=document.querySelector(".swal2-container");r&&(r.style.zIndex="99999"),$()}})).isConfirmed){Swal.fire({title:"Excluindo parcelamento...",allowOutsideClick:!1,heightAuto:!1,didOpen:()=>{Swal.showLoading();const r=document.querySelector(".swal2-container");r&&(r.style.zIndex="99999")},customClass:{container:"swal-above-modal"}});try{const r=await c.apiRequest(`api/faturas/${e}/itens/${a}/parcelamento`,{method:"DELETE"});await Swal.fire({icon:"success",title:"Parcelamento Excluído!",text:r.message||`${t} parcelas removidas.`,timer:b.TIMEOUTS.successMessage,showConfirmButton:!1,heightAuto:!1,customClass:{container:"swal-above-modal"},didOpen:()=>{const i=document.querySelector(".swal2-container");i&&(i.style.zIndex="99999")}}),await m.App.carregarParcelamentos(),l.parcelamentos.some(i=>i.id===e)?setTimeout(()=>{this.showDetalhes(e)},100):l.modalDetalhesInstance&&l.modalDetalhesInstance.hide()}catch(r){console.error("Erro ao excluir parcelamento:",r),Swal.fire({icon:"error",title:"Erro",text:g(r,"Não foi possível excluir o parcelamento."),heightAuto:!1,customClass:{container:"swal-above-modal"},didOpen:()=>{const s=document.querySelector(".swal2-container");s&&(s.style.zIndex="99999")}})}}},async pagarFaturaCompleta(e,a){try{Swal.fire({title:"Carregando...",html:"Buscando informações da fatura e contas disponíveis.",allowOutsideClick:!1,heightAuto:!1,didOpen:()=>{Swal.showLoading();const p=document.querySelector(".swal2-container");p&&(p.style.zIndex="99999")},customClass:{container:"swal-above-modal"}});const[t,o]=await Promise.all([m.API.buscarParcelamento(e),m.API.listarContas()]),r=y(t,null),s=y(o,[]);if(!r?.cartao)throw new Error("Dados da fatura incompletos");const i=r.cartao.id,d=r.cartao.conta_id||null,u=(r.descricao||"").match(/(\d+)\/(\d+)/),h=u?u[1]:null,w=u?u[2]:null;if(!h||!w)throw new Error("Não foi possível identificar o mês/ano da fatura");let E="";if(Array.isArray(s)&&s.length>0)s.forEach(p=>{const x=p.saldoAtual??p.saldo_atual??p.saldo??0,F=c.formatMoney(x),D=p.id===d,T=x>=a,re=T?"color: #059669;":"color: #dc2626;";E+=`<option value="${p.id}" ${D?"selected":""} ${T?"":'style="color: #dc2626;"'}>
                        ${c.escapeHtml(p.nome)} - ${F}${D?" (vinculada ao cartão)":""}
                    </option>`});else throw new Error("Nenhuma conta disponível para débito");const C=await Swal.fire({title:"Pagar Fatura Completa?",html:`
                ...
                `,icon:"question",showCancelButton:!0,confirmButtonColor:"#10b981",cancelButtonColor:"#6b7280",confirmButtonText:'<i data-lucide="check"></i> Sim, pagar tudo',cancelButtonText:"Cancelar",heightAuto:!1,customClass:{container:"swal-above-modal"},didOpen:()=>{const p=document.querySelector(".swal2-container");p&&(p.style.zIndex="99999"),$()},preConfirm:()=>{const p=document.getElementById("swalContaSelect"),x=p?parseInt(p.value):null;return x?{contaId:x}:(Swal.showValidationMessage("Selecione uma conta para débito"),!1)}});if(!C.isConfirmed)return;const P=C.value.contaId;Swal.fire({title:"Processando pagamento...",html:"Aguarde enquanto processamos o pagamento de todos os itens.",allowOutsideClick:!1,heightAuto:!1,didOpen:()=>{Swal.showLoading();const p=document.querySelector(".swal2-container");p&&(p.style.zIndex="99999")},customClass:{container:"swal-above-modal"}});const I=await m.API.pagarFaturaCompleta(i,parseInt(h),parseInt(w),P);if(!I.success)throw new Error(I.message||"Erro ao processar pagamento");await Swal.fire({icon:"success",title:"Fatura Paga!",html:`
        ...
        `,icon:"warning",showCancelButton:!0,confirmButtonColor:"#f59e0b",cancelButtonColor:"#6b7280",confirmButtonText:'<i data-lucide="undo-2"></i> Sim, reverter',cancelButtonText:"Cancelar",didOpen:()=>{window.lucide&&lucide.createIcons()}})).isConfirmed)try{Swal.fire({title:"Revertendo pagamento...",html:"Aguarde enquanto processamos a reversão.",allowOutsideClick:!1,didOpen:()=>Swal.showLoading()});const o=a.cartao.id,r=a.mes_referencia,s=a.ano_referencia,i=await c.apiRequest(`api/cartoes/${o}/fatura/desfazer-pagamento`,{method:"POST",body:JSON.stringify({mes:r,ano:s})});if(i.success)await Swal.fire({icon:"success",title:"Pagamento Revertido!",html:`
                ...
                `,timer:3e3,showConfirmButton:!1,didOpen:()=>{window.lucide&&lucide.createIcons()}}),l.modalDetalhesInstance&&l.modalDetalhesInstance.hide(),await m.App.carregarParcelamentos();else throw new Error(g(i,"Erro ao reverter pagamento"))}catch(o){console.error("Erro ao reverter pagamento:",o),Swal.fire({icon:"error",title:"Erro",text:g(o,"Não foi possível reverter o pagamento.")})}}async function Q(e){if((await Swal.fire({title:"Excluir Fatura?",html:`
        ...
        `,icon:"warning",showCancelButton:!0,confirmButtonColor:"#ef4444",cancelButtonColor:"#6b7280",confirmButtonText:'<i data-lucide="trash-2"></i> Sim, excluir',cancelButtonText:"Cancelar",didOpen:()=>{window.lucide&&lucide.createIcons()}})).isConfirmed)try{const t=await c.apiRequest(`api/faturas/${e}`,{method:"DELETE"});if(t.success)Swal.fire({icon:"success",title:"Fatura Excluída!",text:"A fatura foi excluída com sucesso.",timer:2e3,showConfirmButton:!1}),l.modalDetalhesInstance&&l.modalDetalhesInstance.hide(),m.App.carregarParcelamentos();else throw new Error(g(t,"Erro ao excluir fatura"))}catch(t){console.error("Erro ao excluir fatura:",t),Swal.fire({icon:"error",title:"Erro",text:g(t,"Não foi possível excluir a fatura.")})}}async function Z(e,a){if((await Swal.fire({title:"Excluir Item?",html:`
            <p>Você está prestes a excluir este item da fatura.</p>
            <p style="color: #ef4444; font-weight: 500;">Esta ação não pode ser desfeita!</p>
        `,icon:"warning",showCancelButton:!0,confirmButtonColor:"#ef4444",cancelButtonColor:"#6b7280",confirmButtonText:'<i data-lucide="trash-2"></i> Sim, excluir',cancelButtonText:"Cancelar",customClass:{container:"swal-above-modal"},didOpen:()=>{window.lucide&&lucide.createIcons()}})).isConfirmed)try{const o=await c.apiRequest(`api/faturas/${e}/itens/${a}`,{method:"DELETE"});if(o.success)Swal.fire({icon:"success",title:"Item Excluído!",text:"O item foi excluído com sucesso.",timer:2e3,showConfirmButton:!1,customClass:{container:"swal-above-modal"}}),m.App.carregarParcelamentos(),l.faturaAtual&&setTimeout(()=>{m.UI.abrirDetalhes(e)},500);else throw new Error(g(o,"Erro ao excluir item"))}catch(o){console.error("Erro ao excluir item:",o),Swal.fire({icon:"error",title:"Erro",text:g(o,"Não foi possível excluir o item."),customClass:{container:"swal-above-modal"}})}}m.ModalPagarFatura=_;const ee={toggleFaturasHero:"faturasHero",toggleFaturasFiltros:"faturasFilters",toggleFaturasViewToggle:"faturasViewToggle"},k={toggleFaturasHero:!0,toggleFaturasFiltros:!0,toggleFaturasViewToggle:!0},ae={...k,toggleFaturasFiltros:!1,toggleFaturasViewToggle:!1};async function te(){return H("faturas")}async function oe(e){await V("faturas",e)}const A=q({storageKey:"lk_faturas_prefs",sectionMap:ee,completeDefaults:k,essentialDefaults:ae,loadPreferences:te,savePreferences:oe,modal:{overlayId:"faturasCustomizeModalOverlay",openButtonId:"btnCustomizeFaturas",closeButtonId:"btnCloseCustomizeFaturas",saveButtonId:"btnSaveCustomizeFaturas",presetEssentialButtonId:"btnPresetEssencialFaturas",presetCompleteButtonId:"btnPresetCompletoFaturas"}});function z(){A.init()}m.Customize={init:z,open:A.open,close:A.close};window.abrirModalPagarFatura=(e,a)=>_.abrir(e,a);window.reverterPagamentoFaturaGlobal=X;window.excluirFaturaGlobal=Q;window.excluirItemFaturaGlobal=Z;window.pagarFaturaCompletaGlobal=(e,a)=>S.pagarFaturaCompleta(e,a);window.FaturasModule={toggleCardDetalhes:e=>S.showDetalhes(e),excluirItemFatura:(...e)=>S.excluirItemFatura(...e),editarItemFatura:(...e)=>S.editarItemFatura(...e),toggleParcelaPaga:(...e)=>S.toggleParcelaPaga(...e)};window.__LK_PARCELAMENTOS_LOADER__||(window.__LK_PARCELAMENTOS_LOADER__=!0,document.addEventListener("DOMContentLoaded",()=>{j(),z(),O.init(),_.init()}));
