import{m as Q,j as B,q as ee,g as K,e as I,d as M,l as T,n as ae,b as te,h as oe,k as P,i as re,c as ne}from"./api-Bz3e_1Ao.js";import{a as se}from"./utils-Bj4jxwhy.js";import{r as S}from"./ui-H2yoVZe7.js";import{g as ie,a as le,h as ce,i as W,j as de,k as me,l as G,m as N,b as ue}from"./faturas-osFPSmt_.js";import{i as pe,j as ge,b as H,r as fe,k as ve}from"./finance-CgaDv1sH.js";import{c as ye,p as he,f as Ce}from"./ui-preferences-CPWe3C-7.js";const J={BASE_URL:Q()},c={cartoes:[],filteredCartoes:[],alertas:[],currentView:"grid",currentFilter:"all",searchTerm:"",lastLoadedAt:null,isLoading:!1,isSaving:!1,previewMeta:null},C={},s={async getCSRFToken(){try{const a=await ee();if(a)return a}catch(a){console.warn("Erro ao buscar token fresco, usando fallback:",a)}const e=K();return e||(console.warn("⚠️ Nenhum token CSRF encontrado"),"")},getBaseUrl(){return J.BASE_URL},formatMoney(e){return se(e)},formatMoneyInput(e){return typeof e=="string"&&e.includes(",")?e:typeof e=="number"?(e/100).toFixed(2).replace(".",",").replace(/\B(?=(\d{3})+(?!\d))/g,"."):new Intl.NumberFormat("pt-BR",{minimumFractionDigits:2,maximumFractionDigits:2}).format(e||0)},parseMoney(e){return typeof e=="number"?e:e&&parseFloat(e.toString().replace(/[R$\s]/g,"").replace(/\./g,"").replace(",","."))||0},escapeHtml(e){const a={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"};return e.replace(/[&<>"']/g,t=>a[t])},debounce(e,a){let t;return function(...r){const n=()=>{clearTimeout(t),e(...r)};clearTimeout(t),t=setTimeout(n,a)}},showToast(e,a){window.Swal?Swal.fire({icon:e,title:e==="success"?"Sucesso!":"Erro!",text:a,timer:3e3,showConfirmButton:!1,toast:!0,position:"top-end"}):alert(a)},async showConfirmDialog(e,a,t="Confirmar"){return typeof Swal<"u"?(await Swal.fire({title:e,text:a,icon:"warning",showCancelButton:!0,confirmButtonColor:"#d33",cancelButtonColor:"#3085d6",confirmButtonText:t,cancelButtonText:"Cancelar",reverseButtons:!0})).isConfirmed:confirm(`${e}
...
`)},setupLimiteMoneyMask(){const e=document.getElementById("limiteTotal");if(!e){console.error("❌ Campo limiteTotal NÃO encontrado!");return}e.addEventListener("input",function(a){let t=a.target.value;t=t.replace(/[^\d]/g,"");const n=((parseInt(t)||0)/100).toFixed(2).replace(".",",").replace(/\B(?=(\d{3})+(?!\d))/g,".");a.target.value=n}),e.value="0,00"}};function be(e){if(typeof e!="string")return e;const a=[J.BASE_URL,oe()].filter(Boolean);for(const t of a)if(e.startsWith(t))return e.slice(t.length);return e}async function w(e,{method:a="GET",data:t=null,headers:o={},timeout:r=15e3}={}){return te(be(e),{method:a,headers:o,body:t},{timeout:r})}function Ee(e){if(c.previewMeta=e?.is_demo?e:null,c.previewMeta){window.LKDemoPreviewBanner?.show(c.previewMeta);return}window.LKDemoPreviewBanner?.hide()}const h={async loadCartoes(){const e=document.getElementById("cartoesGrid"),a=document.getElementById("emptyState"),t=document.getElementById("cartoesContainer");if(!(!e||!a))try{c.isLoading=!0,e.setAttribute("aria-busy","true"),t?.setAttribute("aria-busy","true"),e.innerHTML=`
                <div class="lk-skeleton lk-skeleton--card"></div>
                <div class="lk-skeleton lk-skeleton--card"></div>
                <div class="lk-skeleton lk-skeleton--card"></div>
            `,a.style.display="none";const o=await w(`${H()}?preview=1`),r=M(o,{});Ee(r?.meta),c.cartoes=Array.isArray(r)?r:Array.isArray(r?.cartoes)?r.cartoes:[],c.previewMeta||await h.verificarFaturasPendentes(),c.lastLoadedAt=new Date().toISOString(),C.UI.updateStats(),C.UI.filterCartoes(),c.previewMeta?(c.alertas=[],h.renderAlertas()):await h.carregarAlertas()}catch(o){T("[Cartoes] Erro ao carregar cartões",o,"Erro ao carregar cartões");let r=I(o,"Erro ao carregar cartoes");o.name==="AbortError"||r.includes("demorou")?r="A conexão está lenta. Tente novamente.":navigator.onLine||(r="Sem conexão com a internet"),s.showToast("error",r),e.innerHTML=`
            ...
            `,S()}finally{c.isLoading=!1,e.setAttribute("aria-busy","false"),t?.setAttribute("aria-busy","false")}},async verificarFaturasPendentes(){c.cartoes.forEach(a=>{a.temFaturaPendente=!1});const e=c.cartoes.map(async a=>{try{const t=await w(de(a.id)),o=M(t,{}),r=o?.meses||M(o,[])||[];a.temFaturaPendente=Array.isArray(r)&&r.length>0}catch{a.temFaturaPendente=!1}});await Promise.all(e)},async carregarAlertas(){try{const e=await w(ve(),{timeout:1e4}),a=M(e,{});c.alertas=a?.alertas||[],h.renderAlertas()}catch(e){ae("[Cartoes] Erro ao carregar alertas",e,"Erro ao carregar alertas"),c.alertas=[];const a=document.getElementById("alertasContainer");a&&(a.style.display="none")}},renderAlertas(){const e=document.getElementById("alertasContainer");if(e){if(c.alertas.length===0){e.style.display="none";return}e.style.display="block",e.innerHTML=`
            <div class="alertas-list">
                ${c.alertas.map(a=>h.criarAlertaHTML(a)).join("")}
            </div>
        `,S()}},criarAlertaHTML(e){const a={vencimento_proximo:"calendar-x",limite_baixo:"triangle-alert"},t={critico:"#e74c3c",atencao:"#f39c12"},o=Object.prototype.hasOwnProperty.call(a,e?.tipo)?e.tipo:"limite_baixo",r=Object.prototype.hasOwnProperty.call(t,e?.gravidade)?e.gravidade:"atencao",n=s.escapeHtml(String(e?.nome_cartao||"Cartão")),l=Number(e?.dias_faltando||0),m=Number(e?.percentual_disponivel||0),i=Number(e?.valor_fatura||0),p=Number(e?.limite_disponivel||0);let y="";return o==="vencimento_proximo"?y=`Fatura de <strong>${n}</strong> vence em <strong>${l} dia(s)</strong> - ${s.formatMoney(i)}`:o==="limite_baixo"&&(y=`Limite de <strong>${n}</strong> em <strong>${m.toFixed(1)}%</strong> - ${s.formatMoney(p)} disponível`),`
        ...
        `},dismissAlerta(e){const a=e.closest(".alerta-item");a&&(a.style.animation="slideOut 0.3s ease-out forwards",setTimeout(()=>{a.remove();const t=document.getElementById("alertasContainer");t&&t.querySelectorAll(".alerta-item").length===0&&(t.style.display="none")},300))},async loadContasSelect(){const e=document.getElementById("contaVinculada"),a=document.getElementById("contaVinculadaHelp"),t=document.getElementById("cartaoContaEmptyHint");if(!e){console.error("❌ Select contaVinculada não encontrado!");return}try{const o=`${fe()}?only_active=0&with_balances=1`,r=await w(o),n=M(r,{});let l=[];if(Array.isArray(n)?l=n:Array.isArray(n?.contas)&&(l=n.contas),l.length===0)return e.disabled=!0,e.innerHTML='<option value="">Nenhuma conta disponivel</option>',a&&(a.textContent="Crie uma conta antes de vincular um cartao."),t&&(t.hidden=!1),console.warn("⚠️ Nenhuma conta encontrada"),0;const m=l.map(i=>{const p=i.instituicao_financeira?.nome||i.instituicao?.nome||i.nome||"Sem instituição",y=s.escapeHtml(i.nome||"Conta sem nome"),v=s.escapeHtml(p),b=parseFloat(i.saldoAtual||i.saldo_atual||i.saldo||i.saldo_inicial||0),f=s.formatMoney(b);return`<option value="${i.id}">${y} - ${v} - ${f}</option>`}).join("");return e.disabled=!1,e.innerHTML='<option value="">Selecione a conta</option>'+m,a&&(a.textContent="Conta onde o pagamento da fatura sera debitado."),t&&(t.hidden=!0),l.length}catch(o){return T("[Cartoes] Erro ao carregar contas",o,"Erro ao carregar contas"),e.disabled=!0,e.innerHTML='<option value="">Erro ao carregar contas</option>',a&&(a.textContent="Nao foi possivel carregar as contas agora."),t&&(t.hidden=!1),0}},async saveCartao(){const e=document.getElementById("formCartao");if(!e.checkValidity()){e.reportValidity();return}const a=document.getElementById("cartaoId").value,t=!!a,o=K(),r=document.getElementById("limiteTotal").value,n=s.parseMoney(r),l=document.getElementById("cartaoLembreteAviso")?.value||"",m=document.getElementById("contaVinculada"),i=document.getElementById("cartaoCanalInapp"),p=document.getElementById("cartaoCanalEmail");if(m?.disabled){s.showToast("error","Crie uma conta antes de cadastrar um cartao.");return}if(l&&!i?.checked&&!p?.checked){s.showToast("error","Selecione pelo menos um canal para o lembrete.");return}const y={nome_cartao:document.getElementById("nomeCartao").value.trim(),conta_id:m?.value?parseInt(m.value,10):null,bandeira:document.getElementById("bandeira").value,ultimos_digitos:document.getElementById("ultimosDigitos").value.trim(),limite_total:n,dia_fechamento:document.getElementById("diaFechamento").value||null,dia_vencimento:document.getElementById("diaVencimento").value||null,lembrar_fatura_antes_segundos:l?parseInt(l):null,fatura_canal_inapp:l&&i?.checked?1:0,fatura_canal_email:l&&p?.checked?1:0,csrf_token:o};try{const v=t?ge(a):H(),b=await w(v,{method:t?"PUT":"POST",data:y}),f=M(b,null);f?.gamification?.achievements&&Array.isArray(f.gamification.achievements)&&(typeof window.notifyMultipleAchievements=="function"?window.notifyMultipleAchievements(f.gamification.achievements):console.error("❌ notifyMultipleAchievements não está disponível")),s.showToast("success",t?"Cartão atualizado com sucesso!":"Cartão criado com sucesso!"),C.UI.closeModal(),await h.loadCartoes()}catch(v){T("[Cartoes] Erro ao salvar cartão",v,"Erro ao salvar cartão"),s.showToast("error",I(v,"Erro ao salvar cartao"))}},async editCartao(e){const a=c.cartoes.find(t=>t.id===e);if(a){if(a.is_demo){s.showToast("info","Esse cartao e apenas um exemplo. Crie um cartao real para editar.");return}C.UI.openModal("edit",a)}},async arquivarCartao(e){const a=c.cartoes.find(o=>o.id===e);if(!a)return;if(a.is_demo){s.showToast("info","Esse cartao e apenas um exemplo. Crie um cartao real para arquivar ou editar.");return}if(await s.showConfirmDialog("Arquivar Cartão",`Tem certeza que deseja arquivar o cartão "${a.nome_cartao}"? Você poderá restaurá-lo depois na página de Cartões Arquivados.`,"Arquivar"))try{await w(pe(e),{method:"POST"}),s.showToast("success","Cartão arquivado com sucesso!"),h.loadCartoes()}catch(o){T("[Cartoes] Erro ao arquivar cartão",o,"Erro ao arquivar cartão"),s.showToast("error",I(o,"Erro ao arquivar cartao"))}},async deleteCartao(e){return h.arquivarCartao(e)},async carregarFatura(e,a,t){try{const o=await w(`${W(e)}?mes=${a}&ano=${t}`);return M(o,{itens:[],total:0,pago:0,pendente:0})}catch(o){if(o?.status===404)return{itens:[],total:0,pago:0,pendente:0};throw new Error(I(o,"Erro ao carregar fatura"))}},async carregarParcelamentosResumo(e,a,t){const o=await w(`${G(e)}?mes=${a}&ano=${t}`);return M(o,null)},async carregarHistoricoFaturas(e,a=12){const t=await w(`${me(e)}?limite=${a}`);return M(t,null)},async pagarParcelasIndividuais(e,a){try{const t=Array.from(e).map(n=>parseInt(n.dataset.id)),o=a.cartao_id||a.cartao?.id;if(!o)throw new Error("ID do cartão não encontrado na fatura");const r=await w(ce(o),{method:"POST",data:{parcela_ids:t,mes:a.mes,ano:a.ano}});if(r?.success!==!1){s.showToast("success",r.message||"Parcelas pagas com sucesso!");const n=document.querySelector(".modal-fatura-overlay");n&&C.Fatura.fecharModalFatura(n),await h.loadCartoes()}else throw new Error(r.message||"Erro ao pagar parcelas")}catch(t){s.showToast("error",I(t,"Erro ao processar a operacao do cartao"))}},async desfazerPagamento(e,a,t){if((await Swal.fire({title:"Desfazer pagamento?",html:`
                <p>Esta ação irá:</p>
            ...
            >
                ...
                <div class="card-header">
                    <div class="card-card-badges">
                        ...
                        <span class="card-meta-chip card-meta-chip--status ${e.temFaturaPendente?"is-pending":"is-ok"}" ${L(g,e.temFaturaPendente?"Ha uma fatura aberta para este cartao que merece acompanhamento ou pagamento.":"Sem pendencias abertas para o ciclo atual deste cartao.")}>
                ...
                <div class="card-content">
                    ...
                    <p class="card-institution">${v}</p>
                    <div class="card-subline">
                        <span class="card-last-digits">Final ${F(e.ultimos_digitos,"0000")}</span>
                ...
                <div class="card-actions">
                    ${k(e)?`
                    <span class="card-meta-chip card-meta-chip--brand" ${L("Somente visualizacao","Esse cartao de exemplo nao abre menu nem fatura.")}>
                        <i data-lucide="eye"></i>
                        Visual
                    </span>`:`<button
                        type="button"
...
Esta ação criará um lançamento de despesa na conta vinculada e liberará o limite do cartão.`,"Sim, Pagar"))return;const t=document.querySelector(".btn-pagar-fatura"),o=t?t.innerHTML:"";try{t&&(t.disabled=!0,t.innerHTML='<i data-lucide="loader-2" class="icon-spin"></i> Processando...',S(),t.style.opacity="0.6",t.style.cursor="not-allowed");const r=await re(ue(e.cartao.id),{mes:e.mes,ano:e.ano}),n=M(r,null);n?.gamification?.achievements&&Array.isArray(n.gamification.achievements)&&(typeof window.notifyMultipleAchievements=="function"?window.notifyMultipleAchievements(n.gamification.achievements):console.error("❌ notifyMultipleAchievements não está disponível")),s.showToast("success",`Fatura paga com sucesso! ${n?.itens_pagos??""} parcela(s) quitada(s).`);const l=document.querySelector(".modal-fatura-overlay");l&&u.fecharModalFatura(l),C.API.loadCartoes()}catch(r){console.error("❌ Erro ao pagar fatura:",r),t&&(t.disabled=!1,t.innerHTML=o,t.style.opacity="1",t.style.cursor="pointer"),s.showToast("error",I(r,"Erro ao pagar fatura"))}},criarConteudoModalFaturaPaga(e,a,t,o){const r=o||e.cartao_id||e.cartao?.id,n=(e.itens||[]).filter(i=>i.pago).length,l=e.cartao?.bandeira?s.getBrandIcon(e.cartao.bandeira):null,m=a?.data_pagamento||(e.itens||[]).find(i=>i.pago&&i.data_pagamento)?.data_pagamento||null;return`
        ...
        `},async navegarMes(e,a,t,o){let r=a+o,n=t;r>12?(r=1,n++):r<1&&(r=12,n--);try{const[l,m,i]=await Promise.all([P(W(e),{mes:r,ano:n}).catch(()=>null),P(G(e),{mes:r,ano:n}).catch(()=>null),P(N(e),{mes:r,ano:n}).catch(()=>null)]);if(!l)throw new Error("Erro ao carregar fatura");const p=l.data||l;let y=null,v=null;m&&(y=m.data||m),i&&(v=i.data||i);const b=document.querySelector(".modal-fatura-container");if(b){const f=s.resolverCorCartao(p,e);b.style.setProperty("--card-accent",f);const g=u.criarConteudoModal(p,y,v,e);b.innerHTML=g,S(),b.querySelector(".btn-fechar-fatura")?.addEventListener("click",()=>{const $=document.querySelector(".modal-fatura-overlay");u.fecharModalFatura($)}),b.querySelector(".btn-pagar-fatura")?.addEventListener("click",()=>{u.pagarParcelasSelecionadas(p)});const E=document.querySelector(".modal-fatura-overlay");requestAnimationFrame(()=>{u.setupParcelaSelection(E,p)})}}catch(l){console.error("❌ Erro ao navegar entre meses:",l),s.showToast("error",I(l,"Erro ao carregar fatura"))}},async toggleHistoricoFatura(e){try{const a=document.querySelector(".modal-fatura-container");if(!a)return;if(a.querySelector(".historico-faturas")){const o=new Date,r=o.getMonth()+1,n=o.getFullYear(),[l,m,i]=await Promise.all([C.API.carregarFatura(e,r,n),C.API.carregarParcelamentosResumo(e,r,n).catch(()=>null),P(N(e),{mes:r,ano:n}).then(y=>M(y,null)).catch(()=>null)]),p=u.criarConteudoModal(l,m,i,e);a.innerHTML=p,S(),u.adicionarEventListenersModal(l)}else{const o=await C.API.carregarHistoricoFaturas(e),r=u.criarConteudoHistorico(o,e);a.innerHTML=r,S(),u.adicionarEventListenersModal(null)}}catch(a){console.error("❌ Erro ao alternar histórico:",a),s.showToast("error","Erro ao carregar histórico")}},criarConteudoHistorico(e,a){return`
            <div class="modal-fatura-header">
