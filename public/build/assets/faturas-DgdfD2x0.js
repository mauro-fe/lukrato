import{a as N,g as R,j as E,e as g}from"./api-CpqPnVR7.js";import{r as $}from"./ui-H2yoVZe7.js";import{c as q,p as V,f as H}from"./ui-preferences-COf1b1j3.js";function U(e){return{house:"#f97316",utensils:"#ef4444",car:"#3b82f6",lightbulb:"#eab308","heart-pulse":"#ef4444","graduation-cap":"#6366f1",shirt:"#ec4899",clapperboard:"#a855f7","credit-card":"#0ea5e9",smartphone:"#6366f1","shopping-cart":"#f97316",coins:"#eab308",briefcase:"#3b82f6",laptop:"#06b6d4","trending-up":"#22c55e",gift:"#ec4899",banknote:"#22c55e",trophy:"#f59e0b",wallet:"#14b8a6",tag:"#94a3b8","pie-chart":"#8b5cf6","piggy-bank":"#ec4899",plane:"#0ea5e9","gamepad-2":"#a855f7",baby:"#f472b6",dog:"#92400e",wrench:"#64748b",church:"#6366f1",dumbbell:"#ef4444",music:"#a855f7","book-open":"#3b82f6",scissors:"#ec4899","building-2":"#64748b",landmark:"#3b82f6",receipt:"#14b8a6"}[e]||"#f97316"}const b={BASE_URL:(window.BASE_URL||"/").replace(/\/?$/,"/"),ENDPOINTS:{parcelamentos:"api/faturas",categorias:"api/categorias",contas:"api/contas",cartoes:"api/cartoes"},TIMEOUTS:{alert:5e3,successMessage:2e3}},n={};function j(){n.loadingEl=document.getElementById("loadingParcelamentos"),n.containerEl=document.getElementById("parcelamentosContainer"),n.emptyStateEl=document.getElementById("emptyState"),n.filtroStatus=document.getElementById("filtroStatus"),n.filtroCartao=document.getElementById("filtroCartao"),n.filtroAno=document.getElementById("filtroAno"),n.filtroMes=document.getElementById("filtroMes"),n.btnFiltrar=document.getElementById("btnFiltrar"),n.btnLimparFiltros=document.getElementById("btnLimparFiltros"),n.filtersContainer=document.querySelector(".filters-modern"),n.filtersBody=document.getElementById("filtersBody"),n.toggleFilters=document.getElementById("toggleFilters"),n.activeFilters=document.getElementById("activeFilters"),n.modalDetalhes=document.getElementById("modalDetalhesParcelamento"),n.detalhesContent=document.getElementById("detalhesParcelamentoContent")}const l={parcelamentos:[],cartoes:[],faturaAtual:null,sortColumn:"data_compra",sortDirection:"asc",filtros:{status:"",cartao_id:"",ano:new Date().getFullYear(),mes:""},modalDetalhesInstance:null,anosCarregados:!1},m={},c={formatMoney(e){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(e||0)},formatDate(e){return e?new Date(e+"T00:00:00").toLocaleDateString("pt-BR"):""},parseMoney(e){return e&&parseFloat(e.replace(/[^\d,]/g,"").replace(",","."))||0},showAlert(e,a,t="danger"){e&&(e.className=`alert alert-${t}`,e.textContent=a,e.style.display="block",setTimeout(()=>{e.style.display="none"},b.TIMEOUTS.alert))},getCSRFToken(){return R()},escapeHtml(e){if(!e)return"";const a=document.createElement("div");return a.textContent=e,a.innerHTML},buildUrl(e,a={}){const t=e.startsWith("http")?e:b.BASE_URL+e.replace(/^\//,""),o=Object.entries(a).filter(([r,s])=>s!=null&&s!=="").map(([r,s])=>`${r}=${encodeURIComponent(s)}`);return o.length>0?`${t}?${o.join("&")}`:t},async apiRequest(e,a={}){const t=e.startsWith("http")?e:b.BASE_URL+e.replace(/^\//,"");try{return await N(t,{...a,headers:{"X-CSRF-Token":this.getCSRFToken(),...a.headers}})}catch(o){throw console.error("Erro na requisição:",o),o}},debounce(e,a){let t;return function(...r){const s=()=>{clearTimeout(t),e(...r)};clearTimeout(t),t=setTimeout(s,a)}},calcularDiferencaDias(e,a){const t=new Date(e+"T00:00:00"),o=new Date(a+"T00:00:00");return Math.floor((t-o)/(1e3*60*60*24))}},J={async listarParcelamentos(e={}){const a={status:e.status,cartao_id:e.cartao_id,ano:e.ano,mes:e.mes},t=c.buildUrl(b.ENDPOINTS.parcelamentos,a);return await c.apiRequest(t)},async listarCartoes(){return await c.apiRequest(b.ENDPOINTS.cartoes)},async buscarParcelamento(e){const a=parseInt(e,10);if(isNaN(a))throw new Error("ID inválido");return await c.apiRequest(`${b.ENDPOINTS.parcelamentos}/${a}`)},async criarParcelamento(e){return await c.apiRequest(b.ENDPOINTS.parcelamentos,{method:"POST",body:JSON.stringify(e)})},async cancelarParcelamento(e){return await c.apiRequest(`${b.ENDPOINTS.parcelamentos}/${e}`,{method:"DELETE"})},async toggleItemFatura(e,a,t){return await c.apiRequest(`${b.ENDPOINTS.parcelamentos}/${e}/itens/${a}/toggle`,{method:"POST",body:JSON.stringify({pago:t})})},async pagarFaturaCompleta(e,a,t,o=null){const r={mes:a,ano:t};return o&&(r.conta_id=o),await c.apiRequest(`${b.ENDPOINTS.cartoes}/${e}/fatura/pagar`,{method:"POST",body:JSON.stringify(r)})},async listarContas(){return await c.apiRequest(`${b.ENDPOINTS.contas}?with_balances=1`)}};m.API=J;const L=(e,a=0,t=100)=>Math.min(t,Math.max(a,Number(e)||0)),v=(e,a="")=>c.escapeHtml(String(e??a)),G=(e,a=0)=>`${(Number(e)||0).toLocaleString("pt-BR",{minimumFractionDigits:a,maximumFractionDigits:a})}%`,B=(e,a)=>`data-lk-tooltip-title="${v(e)}" data-lk-tooltip="${v(a)}"`,M=/(#[0-9a-fA-F]{3,8}|rgba?\([^)]+\)|hsla?\([^)]+\))/,K={renderParcelamentos(e){if(!Array.isArray(e)||e.length===0){this.showEmpty();return}n.emptyStateEl.style.display="none",n.containerEl.style.display="grid";const a=document.createDocumentFragment();e.forEach(t=>{const o=this.createParcelamentoCard(t);a.appendChild(o)}),n.containerEl.innerHTML="",n.containerEl.appendChild(a),$()},createParcelamentoCard(e){const a=e.progresso||0,t=e.parcelas_pendentes||0,o=e.parcelas_pagas||0,r=o+t,s=this.getDueMeta(e),i=this.getStatusMeta(e.status,a,s),d=document.createElement("div");d.className=`parcelamento-card surface-card surface-card--interactive surface-card--clip status-${e.status}`,d.dataset.id=e.id,d.style.setProperty("--fatura-accent",this.getAccentColorSolid(e.cartao));const f=this.getStatusBadge(e.status,a,s),u=e.mes_referencia||"",h=e.ano_referencia||"";return d.innerHTML=this.createCardHTML({parc:e,statusBadge:f,mes:u,ano:h,itensPendentes:t,itensPagos:o,totalItens:r,progresso:a,dueMeta:s,statusMeta:i}),this.attachCardEventListeners(d,e.id),d},attachCardEventListeners(e,a){const t=e.querySelector('[data-action="view"]');t&&t.addEventListener("click",()=>this.showDetalhes(a))},getAccentColorSolid(e){const t={visa:"#1A1F71",mastercard:"#EB001B",elo:"#FFCB05",amex:"#006FCF",diners:"#0079BE",discover:"#FF6000",hipercard:"#B11116"}[e?.bandeira?.toLowerCase()]||"#3b82f6",o=String(e?.cor_cartao||e?.conta?.instituicao_financeira?.cor_primaria||t).trim();return o?/gradient/i.test(o)?o.match(M)?.[1]||t:/^var\(/i.test(o)||M.test(o)?o:t:t},getBandeiraIcon(e){return{visa:'<svg viewBox="0 0 48 32" width="32" height="22" fill="none"><rect width="48" height="32" rx="4" fill="#1A1F71"/><text x="24" y="20" text-anchor="middle" font-size="12" font-weight="bold" fill="#fff" font-family="sans-serif">VISA</text></svg>',mastercard:'<svg viewBox="0 0 48 32" width="32" height="22" fill="none"><rect width="48" height="32" rx="4" fill="#1A1F71" opacity="0"/><circle cx="19" cy="16" r="10" fill="#EB001B" opacity=".85"/><circle cx="29" cy="16" r="10" fill="#F79E1B" opacity=".85"/></svg>',elo:'<svg viewBox="0 0 48 32" width="32" height="22" fill="none"><rect width="48" height="32" rx="4" fill="#000"/><text x="24" y="20" text-anchor="middle" font-size="13" font-weight="bold" fill="#FFCB05" font-family="sans-serif">elo</text></svg>',amex:'<svg viewBox="0 0 48 32" width="32" height="22" fill="none"><rect width="48" height="32" rx="4" fill="#006FCF"/><text x="24" y="20" text-anchor="middle" font-size="9" font-weight="bold" fill="#fff" font-family="sans-serif">AMEX</text></svg>',hipercard:'<svg viewBox="0 0 48 32" width="32" height="22" fill="none"><rect width="48" height="32" rx="4" fill="#B11116"/><text x="24" y="20" text-anchor="middle" font-size="8" font-weight="bold" fill="#fff" font-family="sans-serif">HIPER</text></svg>',diners:'<svg viewBox="0 0 48 32" width="32" height="22" fill="none"><rect width="48" height="32" rx="4" fill="#0079BE"/><text x="24" y="20" text-anchor="middle" font-size="8" font-weight="bold" fill="#fff" font-family="sans-serif">DINERS</text></svg>'}[e]||'<i data-lucide="credit-card"></i>'},getDueMeta(e){let a=e.data_vencimento;if(!a&&e.cartao?.dia_vencimento&&e.descricao){const f=e.descricao.match(/(\d{1,2})\/(\d{4})/);if(f){const u=f[1].padStart(2,"0"),h=f[2],w=String(e.cartao.dia_vencimento).padStart(2,"0");a=`${h}-${u}-${w}`}}if(!a)return{hasDate:!1,label:"A definir",helper:"Sem data de vencimento informada",detailClass:"",isVencida:!1,isProxima:!1};const t=c.formatDate(a),o=new Date;o.setHours(0,0,0,0);const r=new Date(`${a}T00:00:00`),s=e.status!=="paga"&&e.status!=="concluido"&&e.status!=="cancelado",i=s&&r<o,d=s&&!i&&r-o<=4320*60*1e3;return{hasDate:!0,raw:a,label:t,helper:i?"Vencimento expirado":d?"Vence em breve":"Dentro do prazo",detailClass:i?"is-danger":d?"is-warning":"",isVencida:i,isProxima:d}},getStatusMeta(e,a=null,t=null){const o=L(a);return e==="cancelado"?{badgeClass:"badge-cancelado",progressClass:"is-muted",icon:"ban",label:"Cancelada",shortLabel:"Cancelada",hint:"Sem cobranca ativa",tooltip:"Esta fatura foi cancelada e nao entra mais no acompanhamento ativo."}:o>=100||e==="paga"||e==="concluido"?{badgeClass:"badge-paga",progressClass:"is-safe",icon:"circle-check",label:"Paga",shortLabel:"Liquidada",hint:"Pagamento concluido",tooltip:"O valor desta fatura ja foi quitado integralmente."}:t?.isVencida?{badgeClass:"badge-alerta",progressClass:"is-danger",icon:"triangle-alert",label:"Vencida",shortLabel:"Em atraso",hint:"Regularize esta fatura",tooltip:"A fatura passou do vencimento e merece prioridade para evitar juros."}:t?.isProxima?{badgeClass:"badge-alerta",progressClass:"is-warning",icon:"clock-3",label:"Vence em breve",shortLabel:"Vence logo",hint:"Priorize o pagamento",tooltip:"O vencimento esta proximo. Vale organizar o pagamento desta fatura."}:o>0?{badgeClass:"badge-parcial",progressClass:"is-warning",icon:"loader-2",label:"Pagamento parcial",shortLabel:"Parcial",hint:"Parte do valor ja foi paga",tooltip:"A fatura segue aberta, mas ja possui pagamentos registrados."}:{badgeClass:"badge-pendente",progressClass:"is-safe",icon:"clock-3",label:"Pendente",shortLabel:"No prazo",hint:"Aguardando pagamento",tooltip:"A fatura segue aberta e ainda esta dentro do prazo normal de pagamento."}},getResumoPrincipal(e,a,t,o,r,s){const i=e.total_estornos&&e.total_estornos>0,d=s>0?`${r} de ${s} itens pagos`:"Sem itens consolidados",f=a.hasDate&&a.helper!=="Dentro do prazo"?`<span class="fatura-card-due-tag ${a.detailClass}">${v(a.helper)}</span>`:"";return`
        ...
        `},createCardHTML({parc:e,statusBadge:a,mes:t,ano:o,itensPendentes:r,itensPagos:s,totalItens:i,progresso:d,dueMeta:f,statusMeta:u}){const h=this.getResumoPrincipal(e,f,u,r,s,i),w=this.getProgressoSection(i,r,s,d,u),C=e.cartao&&(e.cartao.nome||e.cartao.bandeira)||"Cartao",x=e.cartao?.conta?.instituicao_financeira?.nome||"Sem instituicao",P=e.cartao?.ultimos_digitos?`Final ${e.cartao.ultimos_digitos}`:"",S=this.getAccentColorSolid(e.cartao),p=e.cartao?.bandeira?.toLowerCase()||"outros",I=this.getBandeiraIcon(p),F=t&&o?`${t}/${o}`:"Fatura atual",D=[v(x),P?v(P):""].filter(Boolean).join(" - ");return`
                ...
                <div class="fatura-card-top">
                    ...
                    <div class="fatura-card-head">
                        <div class="fatura-card-title-wrap">
                            ...
                            <span class="fatura-card-subtitle">${v(x)}</span>
                        </div>
        ...
        `,icon:"warning",showCancelButton:!0,confirmButtonColor:"#ef4444",cancelButtonColor:"#6b7280",confirmButtonText:'<i data-lucide="trash-2"></i> Sim, excluir',cancelButtonText:"Cancelar",didOpen:()=>{window.lucide&&lucide.createIcons()}})).isConfirmed)try{const t=await c.apiRequest(`api/faturas/${e}`,{method:"DELETE"});if(t.success)Swal.fire({icon:"success",title:"Fatura Excluída!",text:"A fatura foi excluída com sucesso.",timer:2e3,showConfirmButton:!1}),l.modalDetalhesInstance&&l.modalDetalhesInstance.hide(),m.App.carregarParcelamentos();else throw new Error(g(t,"Erro ao excluir fatura"))}catch(t){console.error("Erro ao excluir fatura:",t),Swal.fire({icon:"error",title:"Erro",text:g(t,"Não foi possível excluir a fatura.")})}}async function X(e,a){if((await Swal.fire({title:"Excluir Item?",html:`
            <p>Você está prestes a excluir este item da fatura.</p>
            <p style="color: #ef4444; font-weight: 500;">Esta ação não pode ser desfeita!</p>
        `,icon:"warning",showCancelButton:!0,confirmButtonColor:"#ef4444",cancelButtonColor:"#6b7280",confirmButtonText:'<i data-lucide="trash-2"></i> Sim, excluir',cancelButtonText:"Cancelar",customClass:{container:"swal-above-modal"},didOpen:()=>{window.lucide&&lucide.createIcons()}})).isConfirmed)try{const o=await c.apiRequest(`api/faturas/${e}/itens/${a}`,{method:"DELETE"});if(o.success)Swal.fire({icon:"success",title:"Item Excluído!",text:"O item foi excluído com sucesso.",timer:2e3,showConfirmButton:!1,customClass:{container:"swal-above-modal"}}),m.App.carregarParcelamentos(),l.faturaAtual&&setTimeout(()=>{m.UI.abrirDetalhes(e)},500);else throw new Error(g(o,"Erro ao excluir item"))}catch(o){console.error("Erro ao excluir item:",o),Swal.fire({icon:"error",title:"Erro",text:g(o,"Não foi possível excluir o item."),customClass:{container:"swal-above-modal"}})}}m.ModalPagarFatura=_;const Q={toggleFaturasHero:"faturasHero",toggleFaturasFiltros:"faturasFilters",toggleFaturasViewToggle:"faturasViewToggle"},k={toggleFaturasHero:!0,toggleFaturasFiltros:!0,toggleFaturasViewToggle:!0},Z={...k,toggleFaturasFiltros:!1,toggleFaturasViewToggle:!1};async function ee(){return H("faturas")}async function ae(e){await V("faturas",e)}const A=q({storageKey:"lk_faturas_prefs",sectionMap:Q,completeDefaults:k,essentialDefaults:Z,loadPreferences:ee,savePreferences:ae,modal:{overlayId:"faturasCustomizeModalOverlay",openButtonId:"btnCustomizeFaturas",closeButtonId:"btnCloseCustomizeFaturas",saveButtonId:"btnSaveCustomizeFaturas",presetEssentialButtonId:"btnPresetEssencialFaturas",presetCompleteButtonId:"btnPresetCompletoFaturas"}});function z(){A.init()}m.Customize={init:z,open:A.open,close:A.close};window.abrirModalPagarFatura=(e,a)=>_.abrir(e,a);window.reverterPagamentoFaturaGlobal=Y;window.excluirFaturaGlobal=W;window.excluirItemFaturaGlobal=X;window.pagarFaturaCompletaGlobal=(e,a)=>y.pagarFaturaCompleta(e,a);window.FaturasModule={toggleCardDetalhes:e=>y.showDetalhes(e),excluirItemFatura:(...e)=>y.excluirItemFatura(...e),editarItemFatura:(...e)=>y.editarItemFatura(...e),toggleParcelaPaga:(...e)=>y.toggleParcelaPaga(...e)};window.__LK_PARCELAMENTOS_LOADER__||(window.__LK_PARCELAMENTOS_LOADER__=!0,document.addEventListener("DOMContentLoaded",()=>{j(),z(),O.init(),_.init()}));
