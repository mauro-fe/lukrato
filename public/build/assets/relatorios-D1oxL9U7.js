import{a as Se}from"./utils-Bj4jxwhy.js";import{c as xe,p as Ae,f as _e}from"./ui-preferences-COf1b1j3.js";import{d as k,e as pe}from"./api-CpqPnVR7.js";const z="Relatórios são exclusivos do plano Pro.",u={BASE_URL:window.LK?.getBase?.()||"/",CHART_COLORS:["#E67E22","#2C3E50","#2ECC71","#F39C12","#9B59B6","#1ABC9C","#E74C3C","#3498DB"],FETCH_TIMEOUT:3e4,VIEWS:{CATEGORY:"category",BALANCE:"balance",COMPARISON:"comparison",ACCOUNTS:"accounts",CARDS:"cards",EVOLUTION:"evolution",ANNUAL_SUMMARY:"annual_summary",ANNUAL_CATEGORY:"annual_category"}},$e=new Set([u.VIEWS.ANNUAL_SUMMARY,u.VIEWS.ANNUAL_CATEGORY]),q={[u.VIEWS.CATEGORY]:[{value:"despesas_por_categoria",label:"Despesas por categoria"},{value:"receitas_por_categoria",label:"Receitas por categoria"}],[u.VIEWS.ANNUAL_CATEGORY]:[{value:"despesas_anuais_por_categoria",label:"Despesas anuais por categoria"},{value:"receitas_anuais_por_categoria",label:"Receitas anuais por categoria"}]},M={ACTIVE_SECTION:"rel_active_section",ACTIVE_VIEW:"rel_active_view",CATEGORY_TYPE:"rel_category_type",ANNUAL_CATEGORY_TYPE:"rel_annual_category_type"},re={overview:{kicker:"Painel consolidado",title:"Leia seu mes com contexto",description:"Veja seu pulso financeiro, identifique sinais importantes e acompanhe a evolucao do periodo em um resumo rapido."},relatorios:{kicker:"Relatorio ativo",title:"Transforme lancamentos em decisao",description:"Explore seus numeros por categoria, conta, cartao e evolucao para descobrir onde agir."},insights:{kicker:"Leitura automatica",title:"Insights que ajudam a agir",description:"Receba sinais claros sobre gastos, saldo, concentracoes e oportunidades sem precisar interpretar tudo manualmente."},comparativos:{kicker:"Comparacao temporal",title:"Compare e ajuste sua rota",description:"Entenda o que melhorou, piorou ou estagnou em relacao ao mes e ao ano anteriores."}},ne={[u.VIEWS.CATEGORY]:{title:"Categorias do periodo",description:"Encontre rapidamente onde seu dinheiro esta concentrado por categoria."},[u.VIEWS.BALANCE]:{title:"Saldo diario",description:"Acompanhe como seu caixa evolui ao longo do periodo."},[u.VIEWS.COMPARISON]:{title:"Receitas x despesas",description:"Compare entradas e saidas para entender pressao ou folga no caixa."},[u.VIEWS.ACCOUNTS]:{title:"Desempenho por conta",description:"Descubra quais contas concentram mais entradas e saidas."},[u.VIEWS.CARDS]:{title:"Saude dos cartoes",description:"Monitore faturas, uso de limite e sinais de atencao nos cartoes."},[u.VIEWS.EVOLUTION]:{title:"Evolucao em 12 meses",description:"Observe tendencia, sazonalidade e ritmo financeiro ao longo do ultimo ano."},[u.VIEWS.ANNUAL_SUMMARY]:{title:"Resumo anual",description:"Compare mes a mes como receitas, despesas e saldo se comportaram no ano."},[u.VIEWS.ANNUAL_CATEGORY]:{title:"Categorias do ano",description:"Veja quais categorias dominaram seu ano e onde houve maior concentracao."}};function me(){const e=new Date;return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}`}const b=e=>String(e??"").replace(/[&<>"']/g,function(a){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[a]??a});function Te(e,a="#cccccc"){return/^#[0-9A-Fa-f]{6}$/.test(e)?e:a}const n={activeSection:"overview",currentView:u.VIEWS.CATEGORY,categoryType:"despesas_por_categoria",annualCategoryType:"despesas_anuais_por_categoria",currentMonth:me(),currentAccount:null,chart:null,accounts:[],accessRestricted:!1,lastReportError:null,activeDrilldown:null,reportDetails:null},A={getCurrentMonth:me,formatCurrency(e){return Se(e)},formatMonthLabel(e){const[a,t]=e.split("-");return new Date(a,t-1).toLocaleDateString("pt-BR",{month:"long",year:"numeric"})},addMonths(e,a){const[t,s]=e.split("-").map(Number),o=new Date(t,s-1+a);return`${o.getFullYear()}-${String(o.getMonth()+1).padStart(2,"0")}`},hexToRgba(e,a=.25){const t=parseInt(e.slice(1,3),16),s=parseInt(e.slice(3,5),16),o=parseInt(e.slice(5,7),16);return`rgba(${t}, ${s}, ${o}, ${a})`},generateShades(e,a){const t=parseInt(e.slice(1,3),16),s=parseInt(e.slice(3,5),16),o=parseInt(e.slice(5,7),16),r=[];for(let l=0;l<a;l++){const i=.35-l/Math.max(a-1,1)*.7,c=d=>Math.min(255,Math.max(0,Math.round(d+(i>0?(255-d)*i:d*i)))),p=c(t),h=c(s),m=c(o);r.push(`#${p.toString(16).padStart(2,"0")}${h.toString(16).padStart(2,"0")}${m.toString(16).padStart(2,"0")}`)}return r},isYearlyView(e=n.currentView){return $e.has(e)},extractFilename(e){if(!e)return null;const a=/filename\*=UTF-8''([^;]+)/i.exec(e);if(a)try{return decodeURIComponent(a[1])}catch{return a[1]}const t=/filename="?([^";]+)"?/i.exec(e);return t?t[1]:null},getCssVar(e,a=""){try{return(getComputedStyle(document.documentElement).getPropertyValue(e)||"").trim()||a}catch{return a}},isLightTheme(){try{return(document.documentElement?.getAttribute("data-theme")||"dark")==="light"}catch{return!1}},getReportType(){return{[u.VIEWS.CATEGORY]:n.categoryType,[u.VIEWS.ANNUAL_CATEGORY]:n.annualCategoryType,[u.VIEWS.BALANCE]:"saldo_mensal",[u.VIEWS.COMPARISON]:"receitas_despesas_diario",[u.VIEWS.ACCOUNTS]:"receitas_despesas_por_conta",[u.VIEWS.CARDS]:"cartoes_credito",[u.VIEWS.EVOLUTION]:"evolucao_12m",[u.VIEWS.ANNUAL_SUMMARY]:"resumo_anual"}[n.currentView]??n.categoryType},getActiveCategoryType(){return n.currentView===u.VIEWS.ANNUAL_CATEGORY?n.annualCategoryType:n.categoryType}},I={},T=e=>A.formatCurrency(e),F=e=>String(e??"").replace(/[&<>"']/g,a=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[a]||a);function H(){const e=(document.documentElement.getAttribute("data-theme")||"").toLowerCase()==="light"||A.isLightTheme?.();return{isLight:e,mode:e?"light":"dark",textColor:e?"#2c3e50":"#ffffff",textMuted:e?"#6c757d":"rgba(255, 255, 255, 0.7)",gridColor:e?"rgba(0, 0, 0, 0.08)":"rgba(255, 255, 255, 0.05)",surfaceColor:getComputedStyle(document.documentElement).getPropertyValue("--color-surface").trim()}}function K(e=[]){return e.map(a=>{const t=Number(a);return Number.isFinite(t)?t:0})}function ie(e,a=380){const t=e?.closest(".chart-container")||e?.parentElement,s=t?getComputedStyle(t):null,o=s?Number.parseFloat(s.height):Number.NaN,r=s?Number.parseFloat(s.minHeight):Number.NaN,l=t?.getBoundingClientRect?.().height??Number.NaN,i=s?(Number.parseFloat(s.paddingTop)||0)+(Number.parseFloat(s.paddingBottom)||0):0,c=window.innerWidth<768?320:a,p=[o,l,r,c].find(h=>Number.isFinite(h)&&h>0)??c;return Math.max(260,Math.round(p-i))}const y={_currentEntries:null,destroy(){n.chart&&(Array.isArray(n.chart)?n.chart.forEach(e=>e?.destroy()):n.chart.destroy(),n.chart=null),y._drilldownChart&&(y._drilldownChart.destroy(),y._drilldownChart=null),n.activeDrilldown=null,n.reportDetails=null},setupDefaults(){const e=getComputedStyle(document.documentElement).getPropertyValue("--color-text").trim();window.Apex=window.Apex||{},window.Apex.chart={foreColor:e,fontFamily:"Inter, Arial, sans-serif"},window.Apex.grid={borderColor:"rgba(255, 255, 255, 0.1)"}},renderPie(e){const{labels:a=[],values:t=[],details:s=null,cat_ids:o=null}=e;if(!a.length||!t.some(w=>w>0))return I.UI.showEmptyState();let r=a.map((w,E)=>({label:w,value:Number(t[E])||0,color:u.CHART_COLORS[E%u.CHART_COLORS.length],catId:o?o[E]??null:null})).filter(w=>w.value>0).sort((w,E)=>E.value-w.value);!o&&s&&(r=r.map(w=>{const E=s.find(L=>L.label===w.label);return{...w,catId:E?.cat_id??null}}));const l=window.innerWidth<768;let i=r;if(l&&r.length>5){const w=r.slice(0,5),L=r.slice(5).reduce((V,j)=>V+j.value,0);i=[...w,{label:"Outros",value:L,color:"#95a5a6",isOthers:!0}]}const c=!l&&i.length>2,p=c?Math.ceil(i.length/2):i.length,h=c?[i.slice(0,p),i.slice(p)].filter(w=>w.length):[i],m=`
        ...
        `;I.UI.setContent(m),y.destroy(),n.reportDetails=s,n.activeDrilldown=null,y._currentEntries=i;const d=A.getActiveCategoryType(),C={receitas_por_categoria:"Receitas por Categoria",despesas_por_categoria:"Despesas por Categoria",receitas_anuais_por_categoria:"Receitas anuais por Categoria",despesas_anuais_por_categoria:"Despesas anuais por Categoria"}[d]||"Distribuição por Categoria",f=H();let R=0;n.chart=h.map((w,E)=>{const L=document.getElementById(`chart${E}`);if(!L)return null;const V=w.reduce((x,U)=>x+U.value,0),j=R;R+=w.length;const ae=new ApexCharts(L,{chart:{type:"donut",height:"100%",background:"transparent",fontFamily:"Inter, Arial, sans-serif",events:{dataPointSelection:(x,U,se)=>{const oe=j+se.dataPointIndex,G=i[oe];!G||G.isOthers||y.handlePieClick(G,oe,se.dataPointIndex,E)},dataPointMouseEnter:x=>{x.target&&(x.target.style.cursor="pointer")},dataPointMouseLeave:x=>{x.target&&(x.target.style.cursor="default")}}},series:w.map(x=>x.value),labels:w.map(x=>x.label),colors:w.map(x=>x.color),stroke:{width:2,colors:[f.surfaceColor]},plotOptions:{pie:{donut:{size:"60%"},expandOnClick:!0}},legend:{show:!l,position:"bottom",labels:{colors:f.textColor},markers:{shape:"circle"}},title:{text:h.length>1?`${C} - Parte ${E+1}`:C,align:"center",style:{fontSize:"14px",fontWeight:"bold",color:f.textColor}},tooltip:{theme:f.mode,y:{formatter:x=>{const U=V>0?(x/V*100).toFixed(1):"0";return`${T(x)} (${U}%)`}}},dataLabels:{enabled:!1},theme:{mode:f.mode}});return ae.render(),ae}),l&&y.renderMobileCategoryList(i)},renderMobileCategoryList(e){const a=document.getElementById("categoryListMobile");if(!a)return;const t=e.reduce((r,l)=>r+l.value,0),s=!!n.reportDetails&&window.IS_PRO,o=e.map((r,l)=>{const i=(r.value/t*100).toFixed(1),c=s&&r.catId!=null?n.reportDetails.find(d=>d.cat_id===r.catId):null,p=c&&c.subcategories&&c.subcategories.filter(d=>d.id!==0).length>0,h=p?'<i data-lucide="chevron-down" class="category-chevron"></i>':"";let m="";if(p){const d=A.generateShades(r.color,c.subcategories.length);m=`
                    <div class="category-subcats-panel" id="mobileSubcatPanel-${l}" aria-hidden="true">
                        ${c.subcategories.map((g,C)=>{const f=c.total>0?(g.total/c.total*100).toFixed(1):"0.0";return`
                                <div class="drilldown-item drilldown-item-mobile">
                                    <div class="drilldown-indicator" style="background-color: ${d[C]}"></div>
        ...
        `,t.setAttribute("aria-hidden","false"),requestAnimationFrame(()=>{t.style.maxHeight=t.scrollHeight+"px"}),document.getElementById("drilldownCloseBtn")?.addEventListener("click",()=>{y.closeDrilldown()}),c||y._renderDrilldownMiniChart(r,l),window.lucide&&lucide.createIcons()},_renderDrilldownMiniChart(e,a){const t=document.getElementById("drilldownMiniChart");if(!t)return;y._drilldownChart&&(y._drilldownChart.destroy(),y._drilldownChart=null);const s=H(),o=e.reduce((r,l)=>r+l.total,0);y._drilldownChart=new ApexCharts(t,{chart:{type:"donut",height:"100%",background:"transparent",fontFamily:"Inter, Arial, sans-serif"},series:e.map(r=>r.total),labels:e.map(r=>r.label),colors:a,stroke:{width:2,colors:[s.surfaceColor]},plotOptions:{pie:{donut:{size:"55%"}}},legend:{show:!1},tooltip:{theme:s.mode,y:{formatter:r=>{const l=o>0?(r/o*100).toFixed(1):"0";return`${T(r)} (${l}%)`}}},dataLabels:{enabled:!1},theme:{mode:s.mode}}),y._drilldownChart.render()},_drilldownChart:null,renderLine(e){const{labels:a=[],values:t=[]}={...e,values:K(e?.values)};if(!a.length)return I.UI.showEmptyState();I.UI.setContent(`
            <div class="chart-container chart-container-line">
                <div class="chart-wrapper chart-wrapper-line">
                    <div id="chart0"></div>
                </div>
            </div>
        `),y.destroy();const s=getComputedStyle(document.documentElement).getPropertyValue("--color-primary").trim(),o=H(),r=document.getElementById("chart0"),l=ie(r,420),i=new ApexCharts(r,{chart:{type:"area",height:l,toolbar:{show:!1},background:"transparent",fontFamily:"Inter, Arial, sans-serif",parentHeightOffset:0,redrawOnParentResize:!0,redrawOnWindowResize:!0},series:[{name:"Saldo Diário",data:t.map(Number)}],xaxis:{categories:a,labels:{style:{fontSize:"11px"}},axisBorder:{show:!1},axisTicks:{show:!1}},yaxis:{labels:{style:{colors:o.isLight?"#000":"#fff",fontSize:"11px"},formatter:c=>T(c)}},colors:[s],stroke:{curve:"smooth",width:2.5},fill:{type:"gradient",gradient:{shadeIntensity:1,opacityFrom:.4,opacityTo:.05,stops:[0,100]}},markers:{size:4,hover:{size:6}},grid:{borderColor:o.gridColor,strokeDashArray:4},tooltip:{theme:o.mode,y:{formatter:c=>T(c)}},legend:{position:"bottom",labels:{colors:o.textColor}},title:{text:"Evolução do Saldo Mensal",align:"center",style:{fontSize:"16px",fontWeight:"bold",color:o.textColor}},dataLabels:{enabled:!1},theme:{mode:o.mode}});i.render(),n.chart=i},renderBar(e){const{labels:a=[],receitas:t=[],despesas:s=[]}={...e,receitas:K(e?.receitas),despesas:K(e?.despesas)};if(!a.length)return I.UI.showEmptyState();I.UI.setContent(`
            <div class="chart-container chart-container-bar">
                <div class="chart-wrapper chart-wrapper-bar">
                    <div id="chart0"></div>
                </div>
            </div>
        `),y.destroy();const o=A.getCssVar("--color-success","#2ecc71"),r=A.getCssVar("--color-danger","#e74c3c"),l=H(),i=document.getElementById("chart0"),c=ie(i,420),p=n.currentView===u.VIEWS.ACCOUNTS?"Receitas x Despesas por Conta":n.currentView===u.VIEWS.ANNUAL_SUMMARY?"Resumo Anual por Mês":"Receitas x Despesas",h=new ApexCharts(i,{chart:{type:"bar",height:c,toolbar:{show:!1},background:"transparent",fontFamily:"Inter, Arial, sans-serif",parentHeightOffset:0,redrawOnParentResize:!0,redrawOnWindowResize:!0},series:[{name:"Receitas",data:t.map(Number)},{name:"Despesas",data:s.map(Number)}],xaxis:{categories:a,labels:{style:{colors:l.textMuted,fontSize:"11px"}},axisBorder:{show:!1},axisTicks:{show:!1}},yaxis:{labels:{style:{colors:l.isLight?"#000":"#fff",fontSize:"11px"},formatter:m=>T(m)}},colors:[o,r],plotOptions:{bar:{borderRadius:6,columnWidth:"55%"}},grid:{borderColor:l.gridColor,strokeDashArray:4,xaxis:{lines:{show:!1}}},tooltip:{theme:l.mode,shared:!0,intersect:!1,y:{formatter:m=>T(m)}},legend:{position:"bottom",labels:{colors:l.textColor},markers:{shape:"circle"}},title:{text:p,align:"center",style:{fontSize:"16px",fontWeight:"bold",color:l.textColor}},dataLabels:{enabled:!1},theme:{mode:l.mode}});h.render(),n.chart=h}};I.ChartManager=y;const Ie={toggleRelQuickStats:"relQuickStats",toggleRelOverviewCharts:"relOverviewChartsRow",toggleRelControls:"relControlsRow"},he={toggleRelQuickStats:!0,toggleRelOverviewCharts:!0,toggleRelControls:!0},Le={...he,toggleRelQuickStats:!1,toggleRelControls:!1};async function Me(){return _e("relatorios")}async function Re(e){await Ae("relatorios",e)}const ke=xe({storageKey:"lk_relatorios_prefs",sectionMap:Ie,completeDefaults:he,essentialDefaults:Le,loadPreferences:Me,savePreferences:Re,modal:{overlayId:"relatoriosCustomizeModalOverlay",openButtonId:"btnCustomizeRelatorios",closeButtonId:"btnCloseCustomizeRelatorios",saveButtonId:"btnSaveCustomizeRelatorios",presetEssentialButtonId:"btnPresetEssencialRelatorios",presetCompleteButtonId:"btnPresetCompletoRelatorios"}});function Oe(){ke.init()}const v=e=>A.formatCurrency(e),ge=e=>A.formatMonthLabel(e),D=e=>A.isYearlyView(e),Be=()=>A.getReportType(),ve=()=>A.getActiveCategoryType();function Q(e=n.currentAccount){return e?n.accounts.find(a=>String(a.id)===String(e))?.name||`Conta #${e}`:null}function Z(){return D()?`Ano ${n.currentMonth.split("-")[0]}`:ge(n.currentMonth)}function ce(){const e=ve();return(q[n.currentView]||[]).find(t=>t.value===e)?.label||null}function Pe(e=n.activeSection){return e==="relatorios"||e==="comparativos"}function Ne(e=n.activeSection){return re[e]||re.overview}function J(e=n.currentView){return ne[e]||ne[u.VIEWS.CATEGORY]}function fe(){try{localStorage.setItem(M.ACTIVE_VIEW,n.currentView),localStorage.setItem(M.CATEGORY_TYPE,n.categoryType),localStorage.setItem(M.ANNUAL_CATEGORY_TYPE,n.annualCategoryType)}catch{}}function te(){typeof window.openBillingModal=="function"?window.openBillingModal():location.href=`${u.BASE_URL}billing`}async function be(e){const a=e||z;window.PlanLimits?.promptUpgrade?await window.PlanLimits.promptUpgrade({context:"relatorios",message:a}):window.LKFeedback?.upgradePrompt?await window.LKFeedback.upgradePrompt({context:"relatorios",message:a}):window.Swal?.fire?(await Swal.fire({title:"Recurso exclusivo",text:a,icon:"info",showCancelButton:!0,confirmButtonText:"Assinar plano Pro",cancelButtonText:"Agora não",reverseButtons:!0,focusConfirm:!0})).isConfirmed&&te():confirm(`${a}

Deseja ir para a página de planos agora?`)&&te()}async function O(e){if(!e)return!1;const a=Number(e.status||e?.data?.status||0);if(a===401){const t=encodeURIComponent(location.pathname+location.search);return location.href=`${u.BASE_URL}login?return=${t}`,!0}if(a===403){let t=z;if(e?.data?.message)t=e.data.message;else if(typeof e?.clone=="function")try{const s=await e.clone().json();s?.message&&(t=s.message)}catch{}return n.accessRestricted||(n.accessRestricted=!0,await be(t)),S.showPaywall(t),!0}return!1}function De(e){typeof Swal<"u"&&Swal.fire({toast:!0,position:"top-end",icon:"error",title:e,showConfirmButton:!1,timer:4e3,timerProgressBar:!0})}const $={async fetchReportData(){n.lastReportError=null;const e=new AbortController,a=setTimeout(()=>e.abort(),u.FETCH_TIMEOUT);try{const t=await k(`${u.BASE_URL}api/reports`,{type:A.getReportType(),year:n.currentMonth.split("-")[0],month:n.currentMonth.split("-")[1],account_id:n.currentAccount||void 0});return clearTimeout(a),n.accessRestricted=!1,n.lastReportError=null,t.data||t}catch(t){return clearTimeout(a),await O(t)||(n.lastReportError=t.name==="AbortError"?"A requisição demorou demais. Tente novamente em instantes.":"Não foi possível carregar o relatório agora. Verifique a conexão e tente novamente.",console.error("Error fetching report data:",t),De(pe(t,"Erro ao carregar relatório. Verifique sua conexão."))),null}},async fetchReportDataForType(e,a={}){const t=new URLSearchParams({type:e,year:n.currentMonth.split("-")[0],month:n.currentMonth.split("-")[1]}),s=Object.prototype.hasOwnProperty.call(a,"accountId")?a.accountId:n.currentAccount;s&&t.set("account_id",s);try{const o=await k(`${u.BASE_URL}api/reports`,Object.fromEntries(t.entries()));return o.data||o}catch{return null}},async fetchAccounts(){try{const e=await k(`${u.BASE_URL}api/contas`);n.accessRestricted=!1;const a=e.data||e.items||e||[];return(Array.isArray(a)?a:[]).map(t=>({id:Number(t.id),name:t.nome||t.apelido||t.instituicao||`Conta #${t.id}`}))}catch(e){return await O(e)?[]:(console.error("Error fetching accounts:",e),[])}},async fetchSummaryStats(){const[e,a]=n.currentMonth.split("-"),t=new AbortController,s=setTimeout(()=>t.abort(),u.FETCH_TIMEOUT);try{const o=await k(`${u.BASE_URL}api/reports/summary`,{year:e,month:a});return clearTimeout(s),o.data||o}catch(o){return clearTimeout(s),await O(o)?{totalReceitas:0,totalDespesas:0,saldo:0,totalCartoes:0}:(console.error("Error fetching summary stats:",o),{totalReceitas:0,totalDespesas:0,saldo:0,totalCartoes:0})}},async fetchInsights(){const[e,a]=n.currentMonth.split("-"),t=new AbortController,s=setTimeout(()=>t.abort(),u.FETCH_TIMEOUT);try{const o=await k(`${u.BASE_URL}api/reports/insights`,{year:e,month:a});return clearTimeout(s),o.data||o}catch(o){return clearTimeout(s),await O(o)?{insights:[]}:(console.error("Error fetching insights:",o),{insights:[]})}},async fetchInsightsTeaser(){const[e,a]=n.currentMonth.split("-"),t=new AbortController,s=setTimeout(()=>t.abort(),u.FETCH_TIMEOUT);try{const o=await k(`${u.BASE_URL}api/reports/insights-teaser`,{year:e,month:a});return clearTimeout(s),o.data||o}catch(o){return clearTimeout(s),console.error("Error fetching insights teaser:",o),{insights:[],totalCount:0,isTeaser:!0}}},async fetchComparatives(){const[e,a]=n.currentMonth.split("-"),t=new URLSearchParams({year:e,month:a});n.currentAccount&&t.set("account_id",n.currentAccount);const s=new AbortController,o=setTimeout(()=>s.abort(),u.FETCH_TIMEOUT);try{const r=await k(`${u.BASE_URL}api/reports/comparatives`,Object.fromEntries(t.entries()));return clearTimeout(o),r.data||r}catch(r){return clearTimeout(o),await O(r)||console.error("Error fetching comparatives:",r),null}}};I.API=$;const S={setContent(e){const a=document.getElementById("reportArea");a&&(a.innerHTML=e,a.setAttribute("aria-busy","false"),window.lucide&&lucide.createIcons())},showLoading(){const e=document.getElementById("reportArea");e&&(e.setAttribute("aria-busy","true"),e.innerHTML=`
                <div class="lk-loading-state">
                    <i data-lucide="loader-2"></i>
                    <p>Carregando relatório...</p>
                </div>
            `,window.lucide&&lucide.createIcons())},showEmptyState(){const e=Q(),a=J(),t=Z(),s=e?`Nenhum dado foi encontrado para ${e} em ${t}.`:`Não há lançamentos suficientes para montar este recorte em ${t}.`;S.setContent(`
        ...
        `)},showPaywall(e=z){const a=document.getElementById("reportArea");if(!a)return;const t=b(e||z);a.setAttribute("aria-busy","false"),a.innerHTML=`
        ...
        `,window.lucide&&lucide.createIcons();const s=a.querySelector('[data-action="go-pro"]');s&&s.addEventListener("click",te)},updateMonthLabel(){const e=document.getElementById("monthLabel");e&&(e.textContent=D()?n.currentMonth.split("-")[0]:ge(n.currentMonth))},updatePageContext(){const e=document.getElementById("reportsContextKicker"),a=document.getElementById("reportsContextTitle"),t=document.getElementById("reportsContextDescription"),s=document.getElementById("reportsContextChips"),o=document.getElementById("reportsContextActions");if(!e||!a||!t||!s||!o)return;const r=Ne(),l=J(),i=Z(),c=Q(),p=Pe(),h=ce(),m=!window.IS_PRO&&n.activeSection==="insights";e.textContent=r.kicker,a.textContent=n.activeSection==="relatorios"?l.title:r.title,t.textContent=n.activeSection==="relatorios"?l.description:r.description;const d=[`<span class="context-chip surface-chip"><i data-lucide="calendar-range"></i><span>${b(i)}</span></span>`];n.activeSection==="relatorios"&&h&&d.push(`<span class="context-chip surface-chip surface-chip--highlight context-chip-highlight"><i data-lucide="filter"></i><span>${b(h)}</span></span>`),c&&p?d.push(`<span class="context-chip surface-chip surface-chip--highlight context-chip-highlight"><i data-lucide="landmark"></i><span>${b(c)}</span></span>`):c&&!p?d.push(`<span class="context-chip surface-chip"><i data-lucide="bookmark"></i><span>Filtro salvo: ${b(c)}</span></span>`):d.push('<span class="context-chip surface-chip"><i data-lucide="layers"></i><span>Consolidado</span></span>'),m&&d.push('<span class="context-chip surface-chip surface-chip--pro context-chip-pro"><i data-lucide="crown"></i><span>Preview PRO</span></span>'),s.innerHTML=d.join(""),o.innerHTML=c?`
        ...
        `:"",window.lucide&&lucide.createIcons()},updateReportFilterSummary(){const e=document.getElementById("reportFilterSummary"),a=document.getElementById("reportScopeNote");if(!e||!a)return;const t=[`<span class="report-filter-chip surface-chip"><i data-lucide="calendar-range"></i><span>${b(Z())}</span></span>`,`<span class="report-filter-chip surface-chip"><i data-lucide="bar-chart-3"></i><span>${b(J().title)}</span></span>`],s=ce();s&&t.push(`<span class="report-filter-chip surface-chip"><i data-lucide="filter"></i><span>${b(s)}</span></span>`),n.currentAccount?t.push(`<span class="report-filter-chip surface-chip surface-chip--highlight report-filter-chip-highlight"><i data-lucide="landmark"></i><span>${b(Q())}</span></span>`):t.push('<span class="report-filter-chip surface-chip"><i data-lucide="layers"></i><span>Todas as contas</span></span>'),e.innerHTML=t.join(""),a.classList.remove("hidden"),a.innerHTML=n.currentAccount?'<i data-lucide="info"></i><span>O resumo do topo continua consolidado. O filtro por conta afeta este gráfico e a aba Comparativos.</span>':'<i data-lucide="info"></i><span>Use o filtro de conta para analisar um recorte específico sem perder o consolidado do topo.</span>',window.lucide&&lucide.createIcons()},updateControls(){const e=document.getElementById("typeSelectWrapper"),a=[u.VIEWS.CATEGORY,u.VIEWS.ANNUAL_CATEGORY].includes(n.currentView);e&&(e.classList.toggle("hidden",!a),a&&S.syncTypeSelect());const t=document.getElementById("accountSelectWrapper");t&&t.classList.remove("hidden")},syncTypeSelect(){const e=document.getElementById("reportType");if(!e)return;const a=q[n.currentView];if(!a)return;(e.options.length!==a.length||a.some((s,o)=>e.options[o]?.value!==s.value))&&(e.innerHTML=a.map(s=>`<option value="${s.value}">${s.label}</option>`).join("")),e.value=ve()},setActiveTab(e){document.querySelectorAll(".tab-btn").forEach(a=>{const t=a.dataset.view===e;a.classList.toggle("active",t),a.setAttribute("aria-selected",t)})}};I.UI=S;const Ve=()=>$.fetchReportData(),Ue=()=>S.showLoading(),X=()=>S.showEmptyState(),Fe=e=>S.showErrorState(e),He=()=>S.updateMonthLabel(),B=()=>S.updatePageContext(),P=()=>S.updateReportFilterSummary(),We=()=>S.updateControls(),Ye=e=>S.setActiveTab(e),ze=e=>y.renderPie(e),qe=e=>y.renderLine(e),je=e=>y.renderBar(e);async function _(){B(),P(),Ue(),Ke();const e=await Ve();if(!n.accessRestricted){if(n.lastReportError)return Fe(n.lastReportError);if(n.currentView===u.VIEWS.CARDS){if(!e||!Array.isArray(e.cards))return X();at(e);return}if(!e||!e.labels||e.labels.length===0)return X();switch(n.currentView){case u.VIEWS.CATEGORY:case u.VIEWS.ANNUAL_CATEGORY:ze(e);break;case u.VIEWS.BALANCE:case u.VIEWS.EVOLUTION:qe(e);break;case u.VIEWS.COMPARISON:case u.VIEWS.ACCOUNTS:case u.VIEWS.ANNUAL_SUMMARY:je(e);break;default:X()}Ge(e)}}function W(e,a,t,s=!1){const o=document.getElementById(e);if(!o)return;if(!t||t===0){o.innerHTML="",o.className="stat-trend";return}const r=(a-t)/Math.abs(t)*100,l=Math.abs(r).toFixed(1);if(Math.abs(r)<.5)o.className="stat-trend trend-neutral",o.textContent="— Sem alteração";else{const i=r>0,c=s?!i:i;o.className=`stat-trend ${c?"trend-positive":"trend-negative"}`;const p=i?"↑":"↓";o.textContent=`${p} ${l}% vs mês anterior`}}function Ge(e){const a=document.querySelector(".chart-insight-line");if(a&&a.remove(),!e)return;let t="";switch(n.currentView){case u.VIEWS.CATEGORY:case u.VIEWS.ANNUAL_CATEGORY:{if(!e.labels||!e.values||e.values.length===0)break;const l=e.values.reduce((i,c)=>i+Number(c),0);if(l>0){const i=e.values.reduce((p,h,m,d)=>Number(h)>Number(d[p])?m:p,0),c=(Number(e.values[i])/l*100).toFixed(0);t=`${e.labels[i]} lidera com ${c}% dos gastos (${v(e.values[i])})`}break}case u.VIEWS.BALANCE:{if(!e.labels||!e.values||e.values.length===0)break;const l=e.values.map(Number),i=Math.min(...l),c=l.indexOf(i);t=`Menor saldo: ${v(i)} em ${e.labels[c]}`;break}case u.VIEWS.COMPARISON:{if(!e.receitas||!e.despesas)break;const l=e.receitas.map(Number),i=e.despesas.map(Number);t=`Em ${l.filter((p,h)=>p>(i[h]||0)).length} de ${l.length} dias, receitas superaram despesas`;break}case u.VIEWS.ACCOUNTS:{if(!e.labels||!e.despesas||e.despesas.length===0)break;const l=e.despesas.map(Number),i=l.reduce((c,p,h,m)=>p>m[c]?h:c,0);t=`Maior gasto: ${e.labels[i]} com ${v(l[i])} em despesas`;break}case u.VIEWS.EVOLUTION:{if(!e.values||e.values.length<2)break;const l=e.values.map(Number),i=l[0],c=l[l.length-1];t=`Evolução nos últimos 12 meses: ${c>i?"tendência de alta":c<i?"tendência de queda":"estável"}`;break}case u.VIEWS.ANNUAL_SUMMARY:{if(!e.labels||!e.receitas||e.receitas.length===0)break;const l=e.receitas.map(Number),i=e.despesas.map(Number),c=l.map((m,d)=>m-(i[d]||0)),p=c.reduce((m,d,g,C)=>d>C[m]?g:m,0),h=c.reduce((m,d,g,C)=>d<C[m]?g:m,0);t=`Melhor mês: ${e.labels[p]}. Pior mês: ${e.labels[h]}`;break}}if(!t)return;const o=document.getElementById("reportArea");if(!o)return;const r=document.createElement("div");r.className="chart-insight-line",r.innerHTML=`<i data-lucide="sparkles"></i> <span>${b(t)}</span>`,o.appendChild(r),window.lucide&&lucide.createIcons()}async function Ke(){const e=await $.fetchSummaryStats(),a=document.getElementById("totalReceitas"),t=document.getElementById("totalDespesas"),s=document.getElementById("saldoMes"),o=document.getElementById("totalCartoes");if(a&&(a.textContent=v(e.totalReceitas||0)),t&&(t.textContent=v(e.totalDespesas||0)),s){const c=e.saldo||0;s.textContent=v(c),s.style.color=c>=0?"var(--color-success)":"var(--color-danger)"}o&&(o.textContent=v(e.totalCartoes||0)),W("trendReceitas",e.totalReceitas,e.prevReceitas,!1),W("trendDespesas",e.totalDespesas,e.prevDespesas,!0),W("trendSaldo",e.saldo,e.prevSaldo,!1),W("trendCartoes",e.totalCartoes,e.prevCartoes,!0);const r=document.getElementById("section-overview");r&&r.classList.contains("active")&&await ye();const l=document.getElementById("section-insights");l&&l.classList.contains("active")&&await we();const i=document.getElementById("section-comparativos");i&&i.classList.contains("active")&&await Ce()}async function we(){const e=document.getElementById("insightsContainer");if(!e)return;let a;if(window.IS_PRO?a=await $.fetchInsights():a=await $.fetchInsightsTeaser(),!a||!a.insights||a.insights.length===0){e.innerHTML='<p class="empty-message">Nenhum insight disponível no momento</p>';return}const t={"arrow-trend-up":"trending-up","arrow-trend-down":"trending-down","arrow-up":"arrow-up","arrow-down":"arrow-down","chart-line":"line-chart","chart-pie":"pie-chart","exclamation-triangle":"triangle-alert","exclamation-circle":"circle-alert","check-circle":"circle-check","info-circle":"info",lightbulb:"lightbulb",star:"star",bolt:"zap",wallet:"wallet","credit-card":"credit-card","calendar-check":"calendar-check",calendar:"calendar",crown:"crown",trophy:"trophy",leaf:"leaf","shield-alt":"shield","money-bill-wave":"banknote","trending-up":"trending-up","trending-down":"trending-down","shield-alert":"shield-alert",gauge:"gauge",target:"target",clock:"clock",receipt:"receipt",calculator:"calculator",layers:"layers","calendar-clock":"calendar-clock","pie-chart":"pie-chart","calendar-range":"calendar-range","list-plus":"list-plus","list-minus":"list-minus","file-text":"file-text","piggy-bank":"piggy-bank",banknote:"banknote"},s=a.insights.map(o=>{const r=t[o.icon]||o.icon;return`
        <div class="insight-card insight-${o.type} surface-card surface-card--interactive">
    ...
    `}).join("");if(e.innerHTML=s,!window.IS_PRO&&a.isTeaser){const o=Math.max(0,(a.totalCount||0)-a.insights.length),r=o>0?`Desbloqueie mais ${o} insights com PRO`:"Desbloqueie todos os insights com PRO";e.insertAdjacentHTML("beforeend",`
        ...
        `;o.totalCartoes>0&&(m+=` Faturas de cartões somam <strong>${v(o.totalCartoes)}</strong>.`),m+="</p>",e.innerHTML=m}if(a)if(r?.insights?.length>0){const c={"arrow-trend-up":"trending-up","arrow-trend-down":"trending-down","exclamation-triangle":"triangle-alert","check-circle":"circle-check","shield-alert":"shield-alert",gauge:"gauge",target:"target",receipt:"receipt",calculator:"calculator",layers:"layers","piggy-bank":"piggy-bank","pie-chart":"pie-chart","calendar-range":"calendar-range","calendar-clock":"calendar-clock","credit-card":"credit-card","trending-up":"trending-up","trending-down":"trending-down","list-plus":"list-plus","list-minus":"list-minus",banknote:"banknote",clock:"clock"};a.innerHTML=r.insights.map(p=>{const h=c[p.icon]||p.icon;return`
                <div class="insight-card insight-${p.type} surface-card surface-card--interactive">
                    <div class="insight-icon"><i data-lucide="${h}"></i></div>
                    <div class="insight-content">
                        <h4>${b(p.title)}</h4>
                        <p>${b(p.message)}</p>
                    </div>
                </div>`}).join("")}else a.innerHTML='<p class="empty-message">Nenhum insight disponível no momento</p>';if(t&&l?.labels?.length>0){t.innerHTML="";const c=5;let p=l.labels.slice(0,c),h=l.values.slice(0,c).map(Number);if(l.labels.length>c){const d=l.values.slice(c).reduce((g,C)=>g+Number(C),0);p.push("Outros"),h.push(d)}const m=new ApexCharts(t,{chart:{type:"donut",height:220,background:"transparent"},series:h,labels:p,colors:["#E67E22","#2C3E50","#2ECC71","#F39C12","#9B59B6","#1ABC9C"],legend:{position:"bottom",fontSize:"11px",labels:{colors:"var(--color-text-muted)"}},dataLabels:{enabled:!1},plotOptions:{pie:{donut:{size:"60%"}}},stroke:{show:!1},tooltip:{y:{formatter:d=>v(d)}}});m.render(),Y.push(m)}else t&&(t.innerHTML='<p class="empty-message" style="padding:var(--spacing-6)">Sem dados de categorias</p>');if(s&&i?.labels?.length>0){s.innerHTML="";const c=(i.receitas||[]).map(Number),p=(i.despesas||[]).map(Number),h=[],m=[],d=[],g=7;for(let f=0;f<i.labels.length;f+=g){const R=Math.floor(f/g)+1;h.push(`Sem ${R}`),m.push(c.slice(f,f+g).reduce((w,E)=>w+E,0)),d.push(p.slice(f,f+g).reduce((w,E)=>w+E,0))}const C=new ApexCharts(s,{chart:{type:"bar",height:220,background:"transparent",toolbar:{show:!1}},series:[{name:"Receitas",data:m},{name:"Despesas",data:d}],colors:["#2ECC71","#E74C3C"],xaxis:{categories:h,labels:{style:{colors:"var(--color-text-muted)",fontSize:"11px"}},axisBorder:{show:!1},axisTicks:{show:!1}},yaxis:{labels:{style:{fontSize:"10px"},formatter:f=>v(f)}},plotOptions:{bar:{columnWidth:"60%",borderRadius:4}},dataLabels:{enabled:!1},legend:{position:"bottom",fontSize:"11px",labels:{colors:"var(--color-text-muted)"}},grid:{borderColor:"rgba(255,255,255,0.05)"},tooltip:{shared:!0,intersect:!1,y:{formatter:f=>v(f)}}});C.render(),Y.push(C)}else s&&(s.innerHTML='<p class="empty-message" style="padding:var(--spacing-6)">Sem dados de movimentação</p>');window.lucide&&lucide.createIcons()}async function Ce(){const e=document.getElementById("comparativesContainer");if(!e)return;const a=await $.fetchComparatives();if(!a){e.innerHTML='<p class="empty-message">Dados de comparação não disponíveis</p>';return}const t=le("Comparativo Mensal",a.monthly,"mês anterior"),s=le("Comparativo Anual",a.yearly,"ano anterior"),o=Qe(a.categories||[]),r=Ze(a.evolucao||[]),l=Xe(a.mediaDiaria),i=et(a.taxaEconomia),c=tt(a.formasPagamento||[]);e.innerHTML=`<div class="comp-top-row">${t}${s}</div><div class="comp-duo-grid">${l}${i}</div>`+o+r+c,window.lucide&&lucide.createIcons(),Je(a.evolucao||[])}function Qe(e){return!e||e.length===0?"":`
    ...
    `}function Ze(e){return!e||e.length===0?"":`
        <div class="comparative-card comp-full-width surface-card surface-card--interactive">
            <div class="comparative-header">
    ...
    `}function et(e){if(!e)return"";const a=e.atual>=0,t=e.diferenca>0?"trend-positive":e.diferenca<0?"trend-negative":"trend-neutral",s=e.diferenca>0?"arrow-up":e.diferenca<0?"arrow-down":"equal";return`
        <div class="comparative-card comp-mini-card surface-card surface-card--interactive">
    ...
    `}function tt(e){if(!e||e.length===0)return"";const a={Pix:"zap","Cartão de Crédito":"credit-card","Cartão de Débito":"credit-card",Dinheiro:"banknote",Boleto:"file-text",Depósito:"landmark",Transferência:"arrow-right-left",Estorno:"undo-2"},t=e.reduce((o,r)=>o+r.atual,0);return`
        <div class="comparative-card comp-full-width surface-card surface-card--interactive">
            <div class="comparative-header">
    ...
    `}function at(e){const a=document.getElementById("reportArea");if(!a)return;const t=e.resumo_consolidado&&e.cards&&e.cards.length>0?`
    ...
    `,window.lucide&&lucide.createIcons()}async function st(){if(!window.IS_PRO)return be("Exportação de relatórios é exclusiva do plano PRO.");const e=Be()||"despesas_por_categoria",{value:a}=await Swal.fire({title:"Exportar Relatório",html:`
        ...
        `);try{const o=a.type,r=a.format,l=new URLSearchParams({type:o,format:r,year:n.currentMonth.split("-")[0],month:n.currentMonth.split("-")[1]});n.currentAccount&&l.set("account_id",n.currentAccount);const i=await fetch(`${u.BASE_URL}api/reports/export?${l}`,{credentials:"include"});if(await O(i))return;if(!i.ok){let g="Erro ao exportar relatório.";try{const C=await i.json();C?.message?g=C.message:C?.errors&&(g=Object.values(C.errors).flat().join(", "))}catch{}throw new Error(g)}const c=await i.blob(),p=i.headers.get("Content-Disposition"),h=A.extractFilename(p)||(r==="excel"?"relatorio.xlsx":"relatorio.pdf"),m=URL.createObjectURL(c),d=document.createElement("a");d.href=m,d.download=h,document.body.appendChild(d),d.click(),d.remove(),URL.revokeObjectURL(m),typeof Swal<"u"&&Swal.fire({toast:!0,position:"top-end",icon:"success",title:"Relatório exportado!",text:h,showConfirmButton:!1,timer:3e3,timerProgressBar:!0})}catch(o){console.error("Export error:",o);const r=pe(o,"Erro ao exportar relatório. Tente novamente.");typeof Swal<"u"?Swal.fire({toast:!0,position:"top-end",icon:"error",title:"Erro ao exportar",text:r,showConfirmButton:!1,timer:3e3}):alert(r)}finally{t&&(t.disabled=!1,t.innerHTML=s)}}async function ot(e){e==="overview"?await ye():e==="relatorios"?await _():e==="insights"?await we():e==="comparativos"&&await Ce()}function Ee(){const e=D();if(window.LukratoHeader?.setPickerMode?.(e?"year":"month"),e){const a=window.LukratoHeader?.getYear?.();if(a){const[,t="01"]=n.currentMonth.split("-"),s=String(t).padStart(2,"0");n.currentMonth=`${a}-${s}`}}}function de(e){n.currentView=e,Ye(e),We(),B(),P(),Ee(),fe(),_()}function ue(e){n.currentView===u.VIEWS.ANNUAL_CATEGORY?n.annualCategoryType=e:n.categoryType=e,B(),P(),fe(),_()}function ee(e){n.currentAccount=e||null,B(),P(),_()}function rt(e){!e?.detail?.month||D()||n.currentMonth!==e.detail.month&&(n.currentMonth=e.detail.month,He(),B(),P(),_())}function nt(e){if(!D()||!e?.detail?.year)return;const[,a="01"]=n.currentMonth.split("-"),t=String(a).padStart(2,"0"),s=`${e.detail.year}-${t}`;n.currentMonth!==s&&(n.currentMonth=s,B(),P(),_())}if(!window.__LK_REPORTS_LOADED__){let e=function(){try{const t=localStorage.getItem(M.ACTIVE_VIEW);t&&Object.values(u.VIEWS).includes(t)&&(n.currentView=t);const s=localStorage.getItem(M.CATEGORY_TYPE);s&&q[u.VIEWS.CATEGORY]?.some(r=>r.value===s)&&(n.categoryType=s);const o=localStorage.getItem(M.ANNUAL_CATEGORY_TYPE);o&&q[u.VIEWS.ANNUAL_CATEGORY]?.some(r=>r.value===o)&&(n.annualCategoryType=o)}catch{}};window.__LK_REPORTS_LOADED__=!0;async function a(){Oe(),y.setupDefaults(),n.accounts=await $.fetchAccounts();const t=document.getElementById("accountFilter");t&&n.accounts.forEach(d=>{const g=document.createElement("option");g.value=d.id,g.textContent=d.name,t.appendChild(g)}),e(),document.querySelectorAll(".tab-btn").forEach(d=>{d.addEventListener("click",()=>de(d.dataset.view))});const s=d=>{n.activeSection=d,document.querySelectorAll(".rel-section-tab").forEach(f=>{f.classList.remove("active"),f.setAttribute("aria-selected","false")}),document.querySelectorAll(".rel-section-panel").forEach(f=>f.classList.remove("active"));const g=document.querySelector(`.rel-section-tab[data-section="${d}"]`);g&&(g.classList.add("active"),g.setAttribute("aria-selected","true"));const C=document.getElementById("section-"+d);C&&C.classList.add("active"),localStorage.setItem(M.ACTIVE_SECTION,d),S.updatePageContext(),ot(d),window.lucide&&window.lucide.createIcons()},o=["comparativos"];document.querySelectorAll(".rel-section-tab").forEach(d=>{d.addEventListener("click",()=>{const g=d.dataset.section;if(!window.IS_PRO&&o.includes(g)){window.PlanLimits?.promptUpgrade?window.PlanLimits.promptUpgrade({context:"relatorios",message:"Esta funcionalidade é exclusiva do plano Pro."}).catch(()=>{}):window.LKFeedback?.upgradePrompt?window.LKFeedback.upgradePrompt({context:"relatorios",message:"Esta funcionalidade é exclusiva do plano Pro."}).catch(()=>{}):Swal.fire({icon:"info",title:"Recurso Premium",html:"Esta funcionalidade é exclusiva do <b>plano Pro</b>.<br>Faça upgrade para desbloquear!",confirmButtonText:'<i class="lucide-crown" style="margin-right:6px"></i> Fazer Upgrade',showCancelButton:!0,cancelButtonText:"Agora não",confirmButtonColor:"#f59e0b",cancelButtonColor:"#64748b"}).then(C=>{C.isConfirmed&&(window.location.href=(window.BASE_URL||"/")+"billing")});return}s(g)})}),S.setActiveTab(n.currentView),S.updateControls(),S.updatePageContext();const r=localStorage.getItem(M.ACTIVE_SECTION);r&&document.getElementById("section-"+r)?!window.IS_PRO&&o.includes(r)?s("overview"):s(r):s("overview");const l=document.getElementById("reportType");l&&l.addEventListener("change",d=>ue(d.target.value)),t&&t.addEventListener("change",d=>ee(d.target.value));const i=document.getElementById("btnLimparFiltrosRel"),c=document.getElementById("clearFiltersWrapper"),p=()=>{if(!c)return;const d=l&&l.selectedIndex>0,g=t&&t.value!=="";c.style.display=d||g?"flex":"none"};l&&l.addEventListener("change",p),t&&t.addEventListener("change",p),i&&i.addEventListener("click",()=>{l&&(l.selectedIndex=0,ue(l.value)),t&&(t.value="",ee("")),p()}),p(),document.addEventListener("lukrato:theme-changed",()=>{y.setupDefaults(),_()});const h=window.LukratoHeader?.getMonth?.();h&&(n.currentMonth=h),document.addEventListener("lukrato:month-changed",rt),document.addEventListener("lukrato:year-changed",nt);const m=document.getElementById("exportBtn");m&&m.addEventListener("click",st),document.addEventListener("click",d=>{if(d.target.closest('[data-action="retry-report"]')){d.preventDefault(),_();return}if(d.target.closest('[data-action="clear-report-account"]')){d.preventDefault(),t&&(t.value=""),ee(""),p();return}const f=d.target.closest('[data-action="open-card-detail"]');if(!f)return;d.stopPropagation();const R=parseInt(f.dataset.cardId,10),w=f.dataset.cardNome||"",E=f.dataset.cardCor||"#E67E22",L=f.dataset.cardMonth||n.currentMonth;R&&(window.LK_CardDetail?.open?window.LK_CardDetail.open(R,w,E,L):(console.error("[Relatórios] LK_CardDetail module not loaded"),typeof Swal<"u"&&Swal.fire({toast:!0,position:"top-end",icon:"error",title:"Módulo de detalhes não carregado",text:"Recarregue a página.",showConfirmButton:!1,timer:3e3})))}),Ee(),S.updateMonthLabel(),S.updateControls(),_()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",a):a(),window.ReportsAPI={setMonth:t=>{/^\d{4}-\d{2}$/.test(t)&&(n.currentMonth=t,S.updateMonthLabel(),_())},setView:t=>{Object.values(u.VIEWS).includes(t)&&de(t)},refresh:()=>_(),getState:()=>({...n})}}
