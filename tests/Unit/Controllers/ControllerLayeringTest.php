...
class ControllerLayeringTest extends TestCase
{
    ...
    public function testModernizedConstructorsDoNotUseInlineInstantiationDefaults(): void
    {
        $files = [
            ...
            'Application/Controllers/Api/Admin/FeedbackAdminController.php',
            ...
            'Application/Controllers/Api/Categoria/CategoriaController.php',
            'Application/Controllers/Api/Categoria/SubcategoriaController.php',
            'Application/Controllers/Api/Cartao/CartoesController.php',
            'Application/Controllers/Api/Configuracoes/PreferenciaUsuarioController.php',
            'Application/Controllers/Api/Conta/ContasController.php',
            'Application/Controllers/Api/Dashboard/Concerns/HandlesDashboardRead.php',
            'Application/Controllers/Api/Feedback/FeedbackController.php',
            'Application/Controllers/Api/Fatura/FaturasController.php',
            'Application/Controllers/Api/Gamification/GamificationController.php',
            ...
            'Application/Controllers/Api/Fatura/ParcelamentosController.php',
            ...
            'Application/Controllers/Api/Notification/NotificationController.php',
            'Application/Controllers/Api/Perfil/PerfilController.php',
            'Application/Controllers/Api/Plan/PlanController.php',
            'Application/Controllers/Api/Referral/ReferralController.php',
            'Application/Controllers/Api/User/ContactController.php',
            'Application/Controllers/Api/User/SupportController.php',
            'Application/Controllers/Api/Lancamentos/CancelarRecorrenciaController.php',
            'Application/Controllers/Api/Lancamentos/DestroyController.php',
            'Application/Controllers/Api/Lancamentos/ExportController.php',
            'Application/Controllers/Api/Lancamentos/FaturaDetalhesController.php',
            'Application/Controllers/Api/Lancamentos/IndexController.php',
            'Application/Controllers/Api/Lancamentos/MarcarPagoController.php',
            'Application/Controllers/Api/Lancamentos/StoreController.php',
            ...
            'Application/Controllers/Api/Lancamentos/UsageController.php',
            ...
            'Application/Controllers/Site/AprendaController.php',
            ...
            'Application/Services/AI/AIService.php',
            'Application/Services/AI/UserAiWorkflowService.php',
            'Application/Services/AI/ChannelConversationService.php',
            'Application/Services/AI/SystemContextService.php',
            'Application/Services/AI/IntentRouter.php',
            'Application/Services/AI/Handlers/CategorizationHandler.php',
            'Application/Services/AI/Handlers/ConfirmationHandler.php',
            'Application/Services/AI/Handlers/EntityCreationHandler.php',
            'Application/Services/AI/Handlers/FinancialAnalysisHandler.php',
            'Application/Services/AI/Handlers/TransactionExtractorHandler.php',
            'Application/Services/AI/Providers/OpenAIProvider.php',
            'Application/Services/AI/WhatsApp/WhatsAppWebhookWorkflowService.php',
            'Application/Services/AI/Telegram/TelegramWebhookWorkflowService.php',
            'Application/Services/AI/Security/AIRateLimiter.php',
