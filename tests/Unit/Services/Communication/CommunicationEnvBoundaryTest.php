...
class CommunicationEnvBoundaryTest extends TestCase
{
    public function testCommunicationServicesDoNotReadEnvironmentDirectly(): void
    {
        $workspaceRoot = dirname(__DIR__, 4);
        $servicesPath = $workspaceRoot . '/Application/Services/Communication';
        $violations = [];
        ...
        $this->assertSame(
            [],
            $violations,
            'Communication services devem acessar ambiente apenas pela configuracao de runtime.'
        );
    }
}
