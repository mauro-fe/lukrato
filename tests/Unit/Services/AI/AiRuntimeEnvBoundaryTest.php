...
class AiRuntimeEnvBoundaryTest extends TestCase
{
    public function testAiServicesDoNotReadEnvironmentDirectly(): void
    {
        $workspaceRoot = dirname(__DIR__, 4);
        $servicesPath = $workspaceRoot . '/Application/Services/AI';
        $violations = [];
        ...
        $this->assertSame(
            [],
            $violations,
            'AI services devem acessar ambiente apenas pela configuracao de runtime.'
        );
    }
}
