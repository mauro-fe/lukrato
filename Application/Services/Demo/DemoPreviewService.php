...
class DemoPreviewService
{
    ...
    public function dashboardOverview(string $month, int $limit, array $planSummary): array
    {
        ...
        return [
            ...
            'despesas_por_categoria' => [
                ...
                ['categoria' => 'Alimentacao', 'icone' => 'utensils', 'valor' => 860.00],
                ['categoria' => 'Lazer', 'icone' => 'clapperboard', 'valor' => 620.00],
                ['categoria' => 'Transporte', 'icone' => 'car', 'valor' => 540.00],
                ['categoria' => 'Saude', 'icone' => 'heart-pulse', 'valor' => 330.00],
            ...
            'health_score_insights' => [
                [
                    ...
                    'message' => 'O resultado do mes esta positivo e abre espaco para acelerar metas.',
                    'impact' => '+8 pontos',
                ...
                [
                    'type' => 'consistency',
                    'priority' => 'medium',
                    'title' => 'Seu historico ja mostra consistencia',
                    'message' => 'Manter registros recorrentes ajuda a prever o fim do mes com mais clareza.',
                    'impact' => '+5 pontos',
                ...
                [
                    ...
                    'priority' => 'medium',
                    'title' => 'As categorias estao dando contexto bom aos gastos',
                    'message' => 'Separar alimentacao, moradia e lazer facilita decidir onde cortar.',
                    'impact' => '+4 pontos',
                    'action' => ['url' => 'categorias'],
                ],
            ],
            'greeting_insight' => [
                'message' => 'Seu resultado melhorou e o mes esta com folga para decidir o proximo passo.',
                'icon' => 'sparkles',
                'color' => '#10b981',
            ],
            'plan' => $planSummary,
    ...
    private function buildBudgetInsights(int $mes, int $ano): array
    {
        return [
            [
                ...
                'cor' => '#f59e0b',
                'titulo' => 'Transporte esta em 90%',
                'mensagem' => 'Restam R$ 60,00 para fechar o mes dentro do limite.',
            ],
            [
                'tipo' => 'perigo',
                'icone' => 'circle-alert',
                'cor' => '#ef4444',
                'titulo' => 'Lazer estourou o orcamento',
                'mensagem' => 'Excedido em R$ 120,00 no mes de referencia.',
            ],
            [
                'tipo' => 'positivo',
                'icone' => 'circle-check',
                'cor' => '#10b981',
                'titulo' => 'Alimentacao segue sob controle',
                'mensagem' => 'O uso ficou abaixo de 75% com margem para o restante do mes.',
            ],
        ];
    }
    ...
    private function buildMonthlyTransactions(string $month): array
    {
        $transactions = [
            ...
            $this->transaction(-502, $month, 29, 'receita', 1100.00, 'Freelance do mes', 'Trabalho extra', 'briefcase', 'Conta principal'),
            $this->transaction(-503, $month, 28, 'despesa', 330.00, 'Farmacia e consulta', 'Saude', 'heart-pulse', 'Conta principal'),
