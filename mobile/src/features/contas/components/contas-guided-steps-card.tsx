...
import { ContaGuidedStep } from '@/src/features/contas/types';
import { AppCard } from '@/src/shared/ui/app-card';
import { tokens } from '@/src/theme/tokens';

type ContasGuidedStepsCardProps = {
  steps: ContaGuidedStep[];
};

export function ContasGuidedStepsCard({ steps }: ContasGuidedStepsCardProps) {
  return (
    <AppCard>
      <Text style={styles.title}>Se o usuario estiver perdido, o caminho comeca aqui</Text>
