...
import { PerfilGuidedStep } from '@/src/features/perfil/types';
import { AppCard } from '@/src/shared/ui/app-card';
import { tokens } from '@/src/theme/tokens';

type PerfilGuidedStepsCardProps = {
  steps: PerfilGuidedStep[];
};

export function PerfilGuidedStepsCard({ steps }: PerfilGuidedStepsCardProps) {
  return (
    <AppCard>
      <Text style={styles.title}>Se o usuario se perder, a ordem e esta</Text>
