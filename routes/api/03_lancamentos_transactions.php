...
Router::add('GET',  '/api/importacoes/page-init', 'Api\\Importacoes\\PageInitController@__invoke', ['auth']);
Router::add('GET',  '/api/importacoes/configuracoes/page-init', 'Api\\Importacoes\\ConfiguracoesPageInitController@__invoke', ['auth']);
...
Router::add('GET',  '/api/importacoes/historico/page-init', 'Api\\Importacoes\\HistoricoPageInitController@__invoke', ['auth']);
